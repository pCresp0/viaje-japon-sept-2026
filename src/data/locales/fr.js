...
export default {
  ...
  pendingItems: [
    { title: "Réserver le Shinkansen Nozomi Jour 1 (Shinagawa → Kyoto)", detail: "Jour 1 (7 sept) : À acheter à l'avance des semaines plus tôt sur l'application/site SmartEX (https://smart-ex.jp/reservation/reserve_smart/sp/) de Shinagawa à Kyoto (~90 €). Pour 5 personnes avec grandes valises, OBLIGATOIRE de cocher 'Seat with an oversized baggage area' et de choisir les sièges E (fenêtre droite) pour voir le mont Fuji ~40 min après le départ.", deadline: "Des semaines avant le voyage" },
    { title: "Acheter le Narita Express - N'EX (Aéroport Narita → Shinagawa)", detail: "Jour 1 (7 sept) : Ne PAS acheter à l'avance. Selon l'heure d'atterrissage (12h55) et les douanes, achetez directement à l'arrivée au sous-sol B1 de Narita aux guichets/bornes rouges JR pour le prochain train vers Shinagawa (~19 €, départs toutes les 30 min, 1h 10m direct).", deadline: "À l'atterrissage à Narita (Étage B1)" },
    { title: "Réserver le Shinkansen Nozomi Jour 9 (Nagoya → Tokyo)", detail: "Jour 9 (15 sept) : train à grande vitesse Nozomi de Nagoya à Tokyo (~50 €, 1h 40m). Réserver sur SmartEX avec Oversized Baggage.", deadline: "Des semaines avant le voyage" },
