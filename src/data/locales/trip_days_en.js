export const days = [
  ...
  },
  {
    ...
    summary: "Early morning for the world's best fresh sushi, stroll through Ginza and its elegant architecture. The afternoon culminates in Roppongi, going up to the Mori Tower viewpoint.",
    history: "Ginza means 'silver seat', the original site of the government mint in the Edo period. After a fire in the late 19th century, it was rebuilt with Western architecture, a showcase of Japan's modernization.",
    schedule: [
      { text: "Premium sushi breakfast at the Toyosu wholesale market (successor to Tsukiji)." },
      { text: "Tokyo Station, Imperial Palace plaza, and Shiodome skyscrapers." },
      { text: "Stroll through the modern architecture of Ginza." },
      { text: "Sunset at the Tokyo City View observation deck in Mori Tower (Roppongi), views of the Tokyo Tower." },
    ],
    money: "Approx. €40 (meals)",
  },
  {
  ...
  {
    title: "Wildcard Day for Fuji",
    cities: "Tokyo or Fuji",
    summary: "Day marked as a wildcard for the Mount Fuji excursion with Ken Kaneshima (Excursiones Fujiyama). Pending reservation. The idea is to block several days and decide the night before based on the weather. If the weather was better on days 10-12, the visit will have been done and this day is used to cover the displaced Tokyo route.",
    history: "Mount Fuji (3,776m) is Japan's highest peak, a sacred stratovolcano that has inspired Shinto art for centuries. Seeing its clear peak is considered a powerful symbol of good fortune.",
    schedule: [
      { text: "Full day Fuji Tour with Ken Kaneshima (+81 90-5863-1635 · excursionesfujiyama.com): Chureito Pagoda, Shiraito Falls, Aokigahara... If already done another day: free time in Shibuya / Shimokitazawa or packing shopping." },
    ],
    money: "Fuji excursion (extra) / approx. €40",
  },
  {
    title: "Return Home",
    cities: "Tokyo, Narita",
