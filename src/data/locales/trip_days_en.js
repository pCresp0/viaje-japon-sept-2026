export const days = [
  {
    ...
    "summary": "Early departure from Madrid on a direct flight with Qatar Airways. Long transatlantic journey with a layover in Doha. We will arrive in Narita on Monday afternoon, local time.",
  ...
  },
  {
    ...
    "schedule": [
      {
        "text": "**Practical tips:**\n\n**Usual breakfast:** approx. 07:00–09:00.\n**Lunch:** approx. 11:30–14:00.\n**Dinner:** approx. 17:30–21:00.\n\nMany small restaurants close between lunch and dinner.\n\nOn days with a very early departure, buy breakfast the night before at a konbini. On excursions with tight schedules, carry an emergency onigiri/sandwich. Konbini (7-Eleven, Lawson, FamilyMart) are a practical, cheap option for onigiri, sandwiches, bentos, fruit, yogurt, karaage and drinks. They're also open 24/7, so you can go buy breakfast whenever you want without worry.\n\nA simple ramen/udon/donburi meal can cost approximately **¥500–1,500 (~3–9€)**.\n\nNo need to book normally for ramen, udon, donburi, fast Japanese food, casual izakaya or food stalls. Only book special/popular restaurants when we really want to eat there.\n\nAt markets and street food areas, respect local rules about where to eat. In Japan it's not common to eat while walking through shopping streets; at Nishiki Market it's explicitly discouraged."
      },
      {
        "text": "🛬 Landing at Narita (NRT).\n\nYou need to go through immigration, checked baggage claim, customs, and exit to the airport's public area.\nRemember to have the Visit Japan Web QR code ready for all 5 travelers to speed things up.\n\n💡 Tip: The real time it takes to leave the airport can vary a lot depending on immigration, baggage and customs. That's why we haven't bought the Narita Express in advance."
      },
      {
        "text": "🚂 NARITA EXPRESS (N'EX) — ⏳ PENDING / BUY AT NARITA\n\n🎫 **SUICA:** ❌ NO for payment (requires an express ticket)\n📅 **RESERVATION:** 🔴 NEEDED\n🛒 **PURCHASE:** BUY THERE. At the machines or JR ticket counters at Narita Airport itself. Do NOT buy in advance.\n\nRoute: Narita Airport → Shinagawa\n(The ~14:45 time is just a rough target).\n\nAfter clearing customs, follow the JR / Narita Express signs. Buy the ticket at the JR machines or a JR office/counter at the airport.\n\n⚠️ **IMPORTANT:**\n- It is NOT the metro. It's a long-distance JR train.\n- You board it at the airport's JR station.\n- The ticket has NOT been bought yet.\n- We don't want to lock in a specific train before flying, since the flight could be delayed.\n- We'll buy it AT NARITA AIRPORT ITSELF once we have a realistic time estimate.\n- This route needs an N'EX ticket. Don't use Smart EX.\n- We're 5 people: buy all 5 tickets together and ask for seats together if possible.\n\nNote: If the flight is delayed, we don't lose any N'EX ticket since we haven't bought it yet. We'll simply buy the next N'EX that gets us to Shinagawa on time."
      },
      {
        "text": "🚄 **SHINKANSEN NOZOMI 53 (SHINAGAWA → KYOTO)**\n\nDirect bullet train to Kyoto Station (17:19 → 19:23 · 2h 04min). Tickets bought and seats assigned on Smart EX for all 5 travelers. Expand the card below to check seats and individual QR tickets."
      },
      {
        "text": "Traveling with large checked suitcases, but not especially huge. Booking oversized luggage space is only needed if a piece exceeds 160 cm in height + width + depth combined. (Example: 75 + 50 + 30 = 155 cm → not oversized). No need to book oversized space for a normal suitcase under 160 cm."
      },
      {
        "text": "🚅 Arrival in Kyoto (JR Kyoto Station). We exit through the Hachijo East Exit (八条東口). From there it's just a 5-minute walk to our hotel."
      },
      {
        "text": "🏨 **CHECK-IN: HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\n✅ Hotel already paid (669.86€ via Booking).\n\nArrival at the hotel, check-in process for the group's rooms, drop off luggage, freshen up and settle in calmly after the international flight and the day's trains.\n\n♨️ The hotel has a large onsen (public bath), separated by gender, open from 15:00 to 01:00 and from 6:00 to 10:00 — perfect for relaxing after the trip."
      },
      {
        "text": "🍣 **DINNER: KAITEN-SUSHI UOGASHI**\n\nRecommended restaurant at **AEON MALL KYOTO** — Sakura Building, 4F (https://maps.app.goo.gl/ByDBQB6zaVZ3dj2E6). About a 5–7 min walk from the hotel and station.\n\n**Kaiten-zushi** (conveyor belt sushi). Approx. price: **¥2,000–3,000/person (~12–19€)**.\n\nHours: 11:00–22:00 (last order approx. 21:30). No reservation needed.\n\n**What to try:** assorted sushi; fresh fish pieces; nigiri; daily specials; a hot side dish."
      },
      {
        "text": "🏨 **BACK TO THE HOTEL: HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\nBack to the hotel after dinner to rest (1st night in Kyoto at Hotel Keihan Kyoto Hachijoguchi)."
      },
      {
        "text": "🍙 **BUYING BREAKFAST AT A KONBINI (NEAR THE HOTEL)**\n\nBefore going to bed, buy Day 2's breakfast (early start to Fushimi Inari) at a nearby konbini (7-Eleven / Lawson / FamilyMart). Open 24h: you can go at 22:00 or later without any problem."
      }
    ],
    "money": "Approx. €40 (meals) + transport"
  },
  {
    "title": "Fushimi Inari + Nara: Great Buddha, Deer and Pontocho",
    "cities": "Kyoto, Nara",
    "summary": "We'll start very early at the iconic Fushimi Inari to walk through its red torii gates while avoiding crowds. Then, a train to Nara to visit the imposing Great Buddha of Tōdai-ji, eat gyumabushi near the park, and stroll among the famous deer. The day ends back in Kyoto with a walk and dinner in the traditional alleys of Pontocho and Gion.",
    "history": "Fushimi Inari is dedicated to Inari, the Shinto deity of rice, a fundamental element for Japan's ancient economy. Nara was Japan's first permanent capital in the 8th century and is the cradle of Buddhism in the country.",
    "schedule": [
      {
        "text": "Wake up. 🍙 Takeaway breakfast bought the night before. Eat before reaching the shrine or during the journey."
      },
      {
      ...
      {
        "text": "Fushimi Inari Shrine. 💡 Tip: arriving early is especially recommended to avoid the biggest crowds. You don't need to climb all the way to the top of Mount Inari; if time or tiredness is an issue, do a partial climb and turn back. Pablo won't have any trouble climbing, that's what the gym is for."
      },
      {
      ...
      {
        "text": "🚶 Walk to the restaurant **Gyumabushi Miyama 牛まぶし三山** (11 Kasuganocho, Nara), very close to Tōdai-ji — that's why it makes sense to eat right after the Great Buddha."
      },
      {
        "text": "🍚 **LUNCH: Gyumabushi Miyama 牛まぶし三山** (https://maps.app.goo.gl/NjR7MNt97GDZszJm6?g_st=iw)\n\nThe restaurant planned for today — its specialty is gyumabushi. It doesn't take reservations and there may be a queue or it may run out, so it's worth arriving relatively early."
      },
      {
        "text": "🦌 Nara Park and the deer. If we buy shika senbei for the deer, hand over the crackers and show empty hands once they're gone: some deer can get quite pushy if they think we still have food. A relaxed stroll, no need to cover the whole park."
      },
      {
        "text": "⛩️ Nigatsu-dō — **OPTIONAL.** Only if we're doing well on time and energy: a brief visit, mainly for the temple and the views. If we're running late or tired, skip it and start heading back to JR Nara earlier."
      },
      {
        "text": "Heading back from Nara toward JR Nara. No additional visits on this stretch: the goal is to be at JR Nara approximately between 15:40 and 16:00. Depending on where we are, by bus or on foot — no fixed time set in advance."
      },
      {
        "text": "🚆 JR Nara → Kyoto.\n\n🎫 **SUICA:** ✅ YES; tap the card directly at the gates.\n\nTake the next convenient service to Kyoto, no fixed time. No reservation needed. If a convenient Miyakoji Rapid comes up, use it since it cuts travel time. Goal: arrive in Kyoto approximately between 16:45 and 17:00, depending on the service."
      },
      {
        "text": "🏨 Back to Hotel Keihan Kyoto Hachijoguchi and rest — shower and relax before heading out again. Important block: don't fill it with new sightseeing or activities."
      },
      {
        "text": "Head out toward Pontocho/Gion."
      },
      {
        "text": "🍜 **PONTOCHO + GION + DINNER**\n\nA stroll through Pontocho, then toward the Gion/Shirakawa area, and dinner in the area (traditional alleys along the Kamo River). Pontocho and Gion aren't two separate visits with rigid schedules; they're part of the same evening experience. Dinner options: yakitori, ramen, izakaya, okonomiyaki or gyukatsu (e.g. GYUKATSU Kyoto Katsugyu Pontocho Honten, open until 22:30, approx. ¥2,000–6,000 (~12–37€) — one option, not the mandatory dinner). After dinner, a relaxed night stroll if we feel like it."
      },
      {
        "text": "🏨 **BACK TO THE HOTEL: HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\nHeading back from Gion/Pontocho to our hotel in Kyoto to rest (2nd night here).\n\n**How to get back:**\n- 🚇 Metro/Bus: City bus or metro from Shijo/Gion to Kyoto Station (~10–15 min, 🎫 **SUICA:** ✅ YES).\n- 🚶 On foot: approx. 25–30 min walking across the Kamo River."
      },
      {
        "text": "None of today's trains or transport need to be booked in advance. They're all regional/local services paid on the spot with Suica. The restaurant Gyumabushi Miyama doesn't take reservations either."
      }
    ],
    "money": "Approx. 40€ (meals)"
  },
  {
    "title": "North Higashiyama Route and Geishas",
    "cities": "Kyoto",
    "summary": "We'll explore the eastern part of the city, starting at the Silver Pavilion and walking down the Philosopher's Path along the canal. We'll eat at Nishiki Market and spend the afternoon thoroughly exploring the historic geisha districts.",
    "history": "The Silver Pavilion (Ginkakuji) represents the refined Higashiyama culture of the Muromachi period, centered on wabi-sabi aesthetics. The hanamachi (geisha districts) flourished during the Edo period as high-level performing arts centers.",
    "schedule": [
      {
        "time": "07:00",
        "text": "Wake up."
      ...
      {
        "time": "07:15",
        "text": "🍙 Leave the hotel toward the nearest konbini (Lawson or 7-Eleven, whichever is closer)."
      },
      {
        "time": "07:15–07:45",
        "text": "🍙 Konbini breakfast. Between choosing, buying and eating without rushing, this takes a while — count on until about 07:45 before heading to the bus stop."
      },
      {
        "time": "07:45–08:30",
      ...
      {
        "time": "08:30–10:00",
        "text": "🩶 Ginkaku-ji (Silver Pavilion). Official hours in September: 08:30–17:00. Visit: Silver Pavilion, Gardens, Pond, elevated garden path. No reservation needed."
      },
      {
        "time": "10:00–11:00",
        "text": "🚶 Philosopher's Path. Leave Ginkaku-ji and walk south along the canal. It's a mostly pedestrian stretch."
      },
      {
        "time": "11:00–13:15",
        "text": "⛩️ Eikando + Nanzen-ji. First Eikando, then Nanzen-ji. Eikando: admission approximately ¥1,000 (~6€). In regular season open 09:00–17:00. No reservation needed. Bring a bag for your shoes. Nanzen-ji: open 08:40–17:00 in September. No reservation needed. If you want to enter the Hojo Garden or climb the Sanmon, pay admission there.\n\n⚠️ **IMPORTANT:**\nNanzen-ji and Eikando are very close and this order keeps the route logically heading south."
      },
      {
        "time": "13:15–13:45",
        "text": "🚇 Nanzen-ji → central Kyoto. Walk about 10 min to Keage Station. Take the Kyoto Subway Tozai Line: Keage → Karasuma Oike.\n\n🎫 **SUICA:** ✅ YES; tap the card directly at the gates.\n\nFrom Karasuma Oike:\n\nwalk toward Nishiki Market, about 15 min; or continue with whichever subway combination is most convenient. No reservation. Pay with Suica."
      },
      {
        "time": "13:45–16:00",
        "text": "🍣 Nishiki Market. Lunch and a walk through the market. Tip: don't try to cover every single stall. Pick a few products/dishes and eat right in front of the stand.\n\n⚠️ **IMPORTANT:**\nDon't do 'tabearuki' (eating while walking). The market itself asks visitors to avoid this. Nishiki doesn't have a single closing time: each shop has its own hours. Many shops run roughly between 09:00/10:00 and 17:00/18:00. 🍣 Eat here mainly by trying different specialties, not necessarily as one formal meal. What to look for: dashimaki tamago; yuba; tofu; tsukemono; fu; matcha; prepared fish/seafood. DON'T eat while walking. Buy → step aside → eat in front of the stall or inside the shop.\n⚠️ IMPORTANT: Today is Wednesday, September 9th. Nishiki Market doesn't close as a whole market, but many individual shops close on Wednesdays. So don't rely solely on Nishiki for food. If too many stalls are closed, look for food around Shijo/Teramachi/Kawaramachi, keeping the same overall route."
      },
      {
        "time": "16:00–17:30",
        "text": "🏮 Pontocho → Miyagawacho. Walking route. No transport needed."
      },
      {
        "time": "17:30–19:00",
        "text": "🏮 Gion. Route: Hanamikoji, the Ichiriki area, Shirakawa, Tatsumi Jinja. Stroll and dinner around Gion/Pontocho. Hopefully Randy makes us his famous, spectacular lasagna today. Randy will love how quiet and calm people are here."
      },
      {
        "time": "~21:30",
        "text": "🏨 **BACK TO THE HOTEL: HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\nHeading back after dinner in Gion/Pontocho to our hotel in Kyoto to rest (3rd night at Hotel Keihan Kyoto Hachijoguchi)."
      },
      {
        "time": "🎫 RESERVATIONS",
        "text": "No transport needs to be booked in advance. Don't book: Bus, Metro, tickets for Ginkaku-ji, Eikando, Nanzen-ji, Nishiki Market. All transport can be paid on the spot with Suica."
      }
    ],
    "money": "Approx. 40€ (meals)"
  },
  {
    ...
    "summary": "We'll explore the northwest starting at the shining Golden Pavilion and the Kinukake no Michi path. At midday, a tram takes us to Arashiyama, prioritizing the upper historic area before heading down through the famous bamboo forest. Sergio, don't take bamboo home for your plants in Aluche. Juancar is surely already hunting for historical errors in the pamphlet.",
    ...
    "schedule": [
      ...
      {
        "time": "10:15–11:00",
        "text": "🏯 Ryoan-ji. From Kinkaku-ji, walk along Kinukake no Michi. Approximate distance:\n\n1.5 km / 20 min. Ryoan-ji is open in September 08:00–17:00. Admission: approx. ¥600 (~4€). No reservation needed. Especially worth seeing: the rock garden; the Hojo; the garden."
      },
      {
        "time": "11:00–12:15",
        "text": "🏯 Ninna-ji. Continue walking from Ryoan-ji to Ninna-ji. Approximate distance: 10–15 min. Ninna-ji is open in September 09:00–17:00. Access to special areas may have an extra cost. No reservation needed."
      },
      {
        "time": "12:15–12:40",
        "text": "🚋 Ninna-ji → Arashiyama. Walk to Omuro-Ninnaji Station. Take the Randen Kitano Line toward Katabiranotsuji. At Katabiranotsuji transfer to the Randen Arashiyama Line toward Arashiyama. Get off at Arashiyama Station. Approximate total duration: 20–25 min.\n\n⚠️ **IMPORTANT:**\nRanden is NOT a JR train. It doesn't require a Japan Rail Pass. Current Randen fare: ¥250 (~1.5€) per adult per ride. Can be paid with Suica. Don't tap Suica when boarding. Pay when alighting/at the station as applicable. No reservation."
      },
      {
        "time": "12:40–13:20",
        "text": "🍜 Quick lunch in Arashiyama. Keep it quick so as not to compromise the Otagi part.\n⚠️ Don't push lunch too late. In Arashiyama many restaurants have last orders around 14:00 and some close the kitchen in the afternoon. What to eat: udon; soba; tempura; donburi; curry; onigiri/bento if we're in a hurry. If we're running short on time, buy onigiri/sandwich/bento in the Arashiyama area and keep going. Better this than losing time waiting for a table."
      },
      {
        "time": "13:20–13:50",
        "text": "🚌 Arashiyama → Otagi Nenbutsu-ji.\n\n⚠️ **IMPORTANT:**\nDon't walk the whole climb up from Arashiyama. Otagi's own website recommends arriving by taxi or bus and doing the walk downhill afterward. Recommended option: Kyoto Bus No. 94 toward Kiyotaki. Board at a stop in the Arashiyama area and get off at Otagidera-mae. Approximate duration: 20–25 min.\n\n**Alternative:** taxi from the Arashiyama area. The taxi is more expensive but can save time if we're short on it. Don't book the bus."
      },
      {
        "time": "13:50–14:45",
        "text": "🏯 Otagi Nenbutsu-ji.\n\n⚠️ **IMPORTANT:**\nThis is now visited on Thursday, September 10th. Hours: 09:00–16:00. It's closed on Wednesdays and Saturdays, so the day change solves that problem. Admission: ¥1,000 (~6€). No reservation needed. Especially worth seeing: the roughly 1,200 rakan statues."
      },
      {
        "time": "14:45–15:30",
      ...
      {
        "time": "🎫 RESERVATIONS",
        "text": "Don't book any transport for today. Don't book: Metro, Bus 204/205, Randen, Kyoto Bus No. 94, JR Saga-Arashiyama → Kyoto. Also no need to book: Kinkaku-ji, Ryoan-ji, Ninna-ji, Otagi Nenbutsu-ji. Buy tickets directly at each site. JAPAN RAIL PASS: We don't have a Japan Rail Pass. Do NOT change the itinerary for this reason. Today's transport can be used and paid for individually. Suica: Kyoto Subway, Kyoto City Bus, Randen, Kyoto Bus, local JR."
      }
    ],
    "money": "Approx. 40€ (meals)"
  },
  {
    ...
    "schedule": [
      {
        "text": "Wake up. 🍳 Breakfast at the hotel at 07:00. Kiyomizu-dera opens very early, so you shouldn't delay departure.\n\n⚠️ **IMPORTANT TODAY'S REMINDER:** During the day today (when passing through Kyoto Station at midday or returning from Osaka), we must **pick up the physical tickets** for tomorrow's Thunderbird train to Kanazawa at the green 5489 ticket machines using the physical Mastercard (ending in 8625)."
      },
      {
      ...
      {
        "text": "🌃 DOTONBORI.\n\nThe neon-lit district of giant signs along the canal, in the heart of Namba. The canal was dug in 1615 and the area was Osaka's theater district for centuries (kabuki and bunraku); today it's the mecca of street food and night strolling, with the Glico running-man sign as its most photographed icon.\n\nNight walk and street food. Prioritize: Dotonbori, Glico, Ebisu Bridge, Hozenji Yokocho.\n\n💡 Tips: No need to book for street food in Dotonbori; pick stalls/restaurants on the spot. Dotonbori is especially worth it after dark, so arriving around 18:40 is a good time.\n\n🍜 What to try here: 1. Takoyaki 🐙 (Share a portion. Option: Takoyaki Wanaka Dotonbori. Approx. budget: ¥500–1,000 (~3–6€)). 2. Okonomiyaki (Share or order one per person depending on hunger. Option: CHIBO Dotonbori. Approx. budget: ¥2,000–3,000 per person (~12–19€)). 3. Hozenji Yokocho (Good alternative to get off the more touristy stretch of Dotonbori. Look for a small izakaya or local restaurant).\n⚠️ Don't automatically walk into the restaurant with the biggest sign in Dotonbori. The main area is very touristy and some places charge more for location. Between roughly 18:00 and 22:00 Dotonbori gets very crowded. Keep the group of 5 together and have a clear meeting point."
      },
      {
        "text": "🏮 SHINSEKAI.\n\nIf there's time and energy left after Dotonbori: a retro district built in 1912, inspired by Paris to the north and Coney Island to the south, crowned by the Tsūtenkaku tower (which imitated the Eiffel Tower). It contrasts with the more polished, touristy Dotonbori — here the vibe is more old-school, with faded signs and the feel of a more neighborhood-y Osaka.\n\n🍢 What to try here: Kushikatsu — breaded, deep-fried skewers, one of the area's historic specialties. Try a few different kinds. Strict rule: you can't dip the same skewer twice in the shared sauce, it's posted in every shop.\n\n💴 Osaka food budget (Dotonbori + Shinsekai combined): for a simple food-crawl night, budget approximately ¥2,500–4,000 per person (~15–25€) if we combine takoyaki + okonomiyaki/kushikatsu + a drink, though it depends on how much we eat."
      },
      {
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "🏯 NAGAMACHI SAMURAI DISTRICT. Neighborhood where samurai of the Maeda clan lived, with streets and earthen walls original to the Edo era.\n\n📍 What to see here:\n• The earthen walls (dorobei), with their winter straw thatching\n• The Nomura-ke samurai house: the Jyōdan-no-ma room and its painted doors\n• The Nomura-ke garden, Kobori Enshū style\n• The narrow canals running through the whole neighborhood\n\nThe neighborhood is residential and can be explored for free on foot. If we want to enter a residence, prioritize Nomura-ke: Open 08:30–17:30 in September. Admission ¥550 (~3.5€). No reservation needed. The interior garden is especially interesting.\n\n💡 We visit now, in daylight, because it's a quiet residential neighborhood with no particular nightlife, and Nomura-ke closes at 17:30."
      },
      {
        "text": "🚶 To Higashi Chaya (or Loop Bus if you'd rather not walk)."
      },
      {
        "text": "🏮 HIGASHI CHAYA DISTRICT. The largest and best preserved of Kanazawa's three teahouse districts, established in 1820.\n\n📍 What to see here:\n• The main street, with two-story ochaya and wooden lattice facades\n• Shima: an old teahouse turned museum\n• Kaikaro: an active ochaya with a hall decorated in gold leaf\n• Gold leaf shops and local crafts\n\nStroll through the historic streets and teahouses. Optional: SHIMA — old teahouse, open 09:30–17:30 in September. Admission: ¥500 (~3€) + optional surcharge for tea/sweets. If you want to go into SHIMA, do it before 17:15 (there may not be time today — check on arrival). Food option: matcha + wagashi; matcha ice cream; gold-leaf ice cream.\n\n💡 We visit now, at dusk: many shops close around 17:00-18:00 and the district empties of tourists, leaving a much more authentic atmosphere as the gas lamps come on."
      },
      {
  ...
  {
    "title": "Shirakawa-go and Takayama",
    "cities": "Shirakawa-go, Takayama",
    "summary": "Morning bus to the isolated traditional village of Shirakawa-go. In the afternoon, head to picturesque Takayama to walk its old town and enjoy a premium dinner.",
    ...
    "schedule": [
      {
        "time": "07:30",
        "text": "🍙 Wake up + quick breakfast to go. Hotel Resol Trinity Kanazawa does NOT include breakfast in our booking. Although the hotel offers breakfast from 07:00, it's more practical this morning to buy the night before at a konbini: onigiri, sandwich, fruit, coffee/drink. Don't rely on the hotel breakfast because we need to catch the 08:40 bus. Also prepare water to take."
      },
      {
        "time": "08:40",
        "text": "🚌 Nohi Bus Kanazawa → Shirakawa-go.\n\n📍 **WHERE TO BOARD:** Kanazawa Station, WEST Exit (West Exit / Kanazawa-ko guchi), Bus Terminal #4 -- confirmed directly on the official 12GO/Nohi Bus ticket (see PDF below), so there's no doubt about it.\n\n🎫 **SUICA:** ❌ NO\n📅 **RESERVATION:** ✅ ALREADY BOUGHT\n🛒 **PURCHASE:** Use the confirmed 12GO / Hokutetsu reservation.\n\nDeparture: 08:40. Reservation: 12GO31991741. Booking ID M26125669. 5 confirmed seats (1-2D, 3ABCD). Approx. duration: 1h25. Estimated arrival: 10:05. Reservation required for this service. Not JR. Does not use the Japan Rail Pass. Don't use Suica: we use the bus reservation/ticket. ⚠️ **YOU MUST bring the PRINTED paper voucher** -- the driver must keep the physical paper, showing it on your phone or a screenshot is not accepted. 💡 Tip: Arrive at the stop with plenty of time. Delays of 2h or more possible due to traffic, snow, or highway closures in season.\n\n🎧 **Podcast for the ride:** [Takayama and Shirakawa-go: the heart of the Alps](https://podcasts.apple.com/es/podcast/jap%C3%B3n-a-fondo/id1545542012?i=1000527462410) (*Japón a fondo* · Japonismo). To listen to the story of the gassho-zukuri houses, isolated life in the snow, and Takayama's traditional craftsmanship."
      },
      {
        "time": "10:05",
      ...
      {
        "time": "14:05–15:00",
        "text": "🏨 Arrival in Takayama. From Takayama Bus Terminal to Hotel Wood Takayama: approximately 12 minutes on foot. The hotel is practically next to the historic center, so we do NOT need a taxi or public transport.\n\n🗺️ Full Takayama route: https://maps.app.goo.gl/VsKEtfcaxV6jcSmS9?g_st=ic\n\nDrop off luggage, check in (official at 15:00), and a moment to rest before heading out again.\n\n✅ Hotel already paid (274.98€ via Booking)."
      },
      {
        "time": "15:00–15:30",
        "text": "⛩️ **HIDA KOKUBUNJI.** An 8th-century temple with a 3-story pagoda and a 1,200-year-old ginkgo tree. Don't leave it for later due to closing time."
      },
      {
        "time": "15:40–16:20",
        "text": "🏛️ **TAKAYAMA JINYA** (高山陣屋). The only Edo-period government building preserved intact in Japan. The indoor visit usually takes about 30 minutes; try to get in before 16:00 (closes at 17:00, last entry 16:30, admission ¥430)."
      },
      {
        "time": "16:20–17:30",
        "text": "🍶 **SANMACHI SUJI + NAKABASHI BRIDGE.** The three historic streets (Ichinomachi, Ninomachi, Sannomachi): sake shops with tastings (¥100/cup), woodcraft, sarubobo. Also cross **Nakabashi Bridge**, the iconic red bridge."
      },
      {
        "time": "17:30–19:00",
        "text": "🚶 Free time to keep strolling through the old town on the way to the dinner restaurant. 🍡 Optional snack without filling up: Hida beef sushi, mitarashi dango, or sarubobo ice cream."
      },
      {
        "time": "19:00",
        "text": "🥩 **Premium Hida beef dinner in Takayama** (straight from the street, without going to the hotel first).\n\n**What to order:** *rosu* (sirloin) for shabu-shabu or grilled, or *hire* (fillet) if you're after the most tender cut. **Hoba miso** (grilled beef on a magnolia leaf with local miso) is the local specialty -- order it no matter what. One or two pieces of **Hida beef nigiri-zushi** as a starter, paired with a local Hida **sake**."
      },
      {
        "time": "~21:00",
        "text": "🌙 **EVENING STROLL THROUGH SANMACHI SUJI.** After dinner, before heading back to the hotel: the old town streets are packed with tourists during the day, but at night they become almost empty and very quiet -- a good time to stroll unhurried and see the wooden facades in a different light, without the shops or the crowds."
      },
      {
        "time": "~21:30",
        "text": "🏨 **BACK TO THE HOTEL: HOTEL WOOD TAKAYAMA** (https://www.google.com/maps/search/?api=1&query=Hotel+Wood+Takayama)\n\nRest and **onsen** (separated by gender, open 15:00 to 00:00 and 6:00 to 9:00, with a free complimentary ice cream on the way out) -- 1st and only night in Takayama at Hotel Wood Takayama."
      },
      {
        "time": "🎫 BOOKINGS",
        "text": "ALREADY BOOKED: Kanazawa → Shirakawa-go (08:40, 5 seats) and Shirakawa-go → Takayama (13:15, 5 seats). We do NOT need a Japan Rail Pass, trains, or Suica for these buses."
      },
      {
        "time": "🚍 TRANSPORT SUMMARY",
        "text": "Kanazawa → Shirakawa-go: Nohi Bus booked, 08:40 → 10:05 (3 h 10 min visit in Shirakawa-go).\nShirakawa-go: All on foot.\nShirakawa-go → Takayama: Nohi Bus booked, 13:15 → 14:05.\nTakayama Bus Terminal → Hotel Wood: approx. 12 min on foot.\nHotel → Sanmachi: right next door.\nWe don't need a Japan Rail Pass or trains today."
      },
      {
        "time": "🍽️ FOOD TIPS",
        "text": "⚠️ In Shirakawa-go, eat around 12:00 at Tanaka-ya so as not to risk the 13:15 bus.\n⚠️ In Takayama shops close around 17:00, but dinner restaurants open later. Dinner at 19:00 is doable. 🥩 Takayama is ideal for trying Hida beef -- order hoba miso and Hida beef nigiri-zushi."
      }
    ],
    "money": "Approx. €40 + premium wagyu dinner"
  },
  {
  ...
  {
    "title": "Transfer to Tokyo",
    "cities": "Tokyo (Asakusa)",
    "summary": "We'll leave the Alps to travel by bullet train to Tokyo, where we'll reunite with our large luggage. A quiet afternoon to settle into the Asakusa hotel and rest from the day of trains, with a simple dinner nearby.",
    "history": "Edo (ancient Tokyo) transformed from a fishing village into Japan's political center in 1603. Asakusa, where we're staying, was the city's popular entertainment district for centuries, centered around Sensō-ji temple.",
    "schedule": [
      {
        "text": "🍙 07:00 — BREAKFAST\nMagome Chaya does NOT offer breakfast as of 2026.\n\n⚠️ **There's no konbini in Magome** (it's a deliberately preserved village with no modern chains, not even visible vending machines on the main street) -- so there's nowhere to buy anything here early this morning, nor last night once the local shops closed.\n\n✅ **WE'LL HAVE BREAKFAST IN NAKATSUGAWA**, during the bus-to-train transfer. The 08:15 bus arrives in Nakatsugawa around 08:40, and the Shinano doesn't leave until 09:57 -- over an hour in a real city, with a train station, where it's quite likely you'll find a konbini (7-Eleven/Lawson/FamilyMart) near the station to have a relaxed breakfast, after picking up the JR-WEST tickets."
      },
      {
        "text": "🚌 08:15 — LOCAL BUS MAGOME → NAKATSUGAWA\n\n🎫 **SUICA:** ❌ NO (cash only)\n📅 **RESERVATION:** ❌ NO\n🛒 **PURCHASE:** Take a numbered ticket boarding through the back door, pay cash to the driver when getting off.\n\nDeparture: Magome — 08:15\nArrival: Nakatsugawa Station — 08:40\nDuration: approx. 25 min.\nType: local bus.\nReservation: CANNOT be reserved.\nJapan Rail Pass: NOT included.\nPayment: buy/pay locally following the operator's instructions.\nEstimated price: ¥800/person (~€5).\n\n⚠️ **IMPORTANT:**\nSeptember 15, 2026 is a Tuesday, so the weekday schedule applies.\nArrive at the bus stop a few minutes early.\nThis bus is necessary to connect Magome with the JR rail network."
      },
      {
        "text": "🎫 **08:40 — COLLECT PHYSICAL JR-WEST TICKETS (CRITICAL)**\n\nArrive at Nakatsugawa Station (~08:40). Shinano 4 departs at **09:57** → ~**77 minutes** buffer.\n\n🟢 Reservation is **ALREADY PAID** (No. **42093**). This is NOT buying a ticket: it is **collecting the physical tickets**.\n\n⚠️ **REQUIRED before boarding:**\n- Use a machine or ticket office **OUTSIDE the ticket gates** (a machine inside the gates won't work).\n- Bring the **physical** Mastercard ending in **8625** (virtual cards not accepted).\n- Have Reservation No. **42093** and Receipt ID **AEE6606M** ready.\n- The reservation's 4-digit PIN.\n- Don't go through the gates until you have the tickets, if needed for access.\n\n💡 **In advance (if possible):** try to collect earlier at a JR-WEST station with a machine/counter outside the gates (e.g. Kyoto). If that wasn't done: **PLAN B / MANDATORY at Nakatsugawa**.\n\n☕ With the remaining time: restroom, coffee/light breakfast, water/snacks, and locate the Shinano 4 platform without rushing."
      },
      {
        "text": "🚆 **SHINANO 4 — NAKATSUGAWA → NAGOYA**\n\n🟢 **BOOKED & CONFIRMED** (JR-WEST Online Train Reservation)\n\nDep: Nakatsugawa **09:57** → Arr: Nagoya **10:53** (56 min).\nCar **4** · Ordinary / Reserved / Non-Smoking.\nSeats: **11-D · 12-C · 12-D · 13-C · 13-D** (already assigned).\n5 adults · Total **¥14,350 (~€77.84)** (¥2,870/pax · ~€15.57).\nReservation **#42093** · Receipt **AEE6606M**.\n\n🎫 **PHYSICAL TICKETS:** still to collect (see 08:40). Board only with tickets in hand.\n\nExpand the card below to see the confirmation, seats and pickup checklist."
      },
      {
      ...
      {
        "text": "🍜 **DINNER: ASAKUSA MONJA MONRO** (friend of Thibaut's). Monjayaki and teppanyaki cooked in front of you by the staff -- house specialty with seafood from the Tsukiji/Toyosu markets. Very well rated (top 5 in Asakusa reviews). There may be a bit of a wait, but it's worth it. A few minutes from the hotel."
      },
      {
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "Ueno Park and Ameyoko street market, great for cheap tea and sweets. Nice green area to stroll calmly after the early start.\n\n🦪 **SNACKING AT AMEYOKO** (friend of Thibaut's): the market stalls are also well known for grilled seafood -- grilled oysters and eel, among other things. If you haven't tried eel (unagi) yet, this is a good chance.\n\n🎮 **YAMASHIROYA** (friend of Thibaut's): a 6-floor store of anime/video game figures, toys and merchandise, just 1 minute on foot from Ueno Station. Confirmed that prices tend to be cheaper than in Akihabara, and it's noticeably less crowded."
      },
      {
  ...
  },
  {
    ...
    "summary": "Day of collecting and video games: Mega Pokémon Center in Ikebukuro (with its life-size Mewtwo, Charizard and Lucario statues) and Nintendo Store Tokyo. Afterward, Nakano Broadway and Akihabara, with plenty of time in the latter. Closing out the afternoon with the already-purchased entry to the Tokyo Skytree observation deck.",
    ...
    "schedule": [
      ...
      {
        "time": "09:20",
        "text": "Leave the hotel toward Ikebukuro (first stop of the day)."
      },
      {
        "time": "10:00–11:00",
      ...
      {
        "time": "13:45–15:45",
        "text": "🎮 **Akihabara (2 hours).** Route to follow, in this order:\n\n• **Akihabara Station:** starting point, exit toward Electric Town.\n• **Radio Kaikan:** historic 10-floor building right at the station exit, packed with dozens of figure, card and collectible shops stacked on top of each other.\n• **Chuo-dori:** Akihabara's main street, with the big neon signs (closed to traffic on Sunday afternoons; today is Saturday, so it may not apply).\n• **Animate:** Japan's biggest manga/anime store chain, with official merchandise for practically any series.\n• **Super Potato:** a temple to retro gaming, with NES, SNES and Game Boy in a setting straight out of the 90s.\n• **Mandarake:** a big secondhand chain for manga, figures and collectibles from every era.\n• **Arcade Hey / Taito:** classic Japanese arcades, for UFO catcher, rhythm, or fighting games.\n• **Kanda Myojin:** a Shinto shrine over 1,000 years old, curiously popular among otaku for blessing tech products and anime characters."
      },
      {
        "time": "15:45–16:15",
      ...
      {
        "time": "~18:45",
        "text": "🚶 Back toward the hotel area (the Skytree is just ~15-20 min on foot from Asakusa)."
      },
      {
        "time": "19:00–20:30",
  ...
  },
  {
    "title": "Return Home",
    "cities": "Tokyo, Narita",
    "summary": "Last hours in Japan: last-minute shopping at local pharmacies or a farewell walk near the hotel. Train to Narita with plenty of time to check in.",
