export const days = [
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "Arrival in Shirakawa-go at 10:05. We have approximately 3 h 10 min in Shirakawa-go (from 10:05 arrival until 13:15 bus departure to Takayama). From Shirakawa-go Bus Terminal begins the walking tour of Ogimachi. The historic center is a few minutes from the terminal."
      },
      {
      ...
      {
        "text": "🚌 Nohi Bus Shirakawa-go → Takayama. Departure: 13:15. Reservation: 12GO31992254. 5 seats confirmed. Approximate duration: 50 min. Expected arrival at Takayama Bus Terminal: 14:05. Mandatory reservation. Not JR. Does not require Japan Rail Pass. Do not use IC card: use the bus reservation/ticket."
      },
      {
