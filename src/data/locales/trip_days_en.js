export const days = [
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "🧳 SEND LUGGAGE TO TSUMAGO -- ⚠️ It's NOT a locker where you pick up in the same place: it's a real transport service between the two tourist offices (Magome and Tsumago). You drop your bags at the Magome office, the service itself transports them by van during the day, and you pick them up at the Tsumago office in the afternoon -- you never carry them during the hike.\n\nDrop-off hours in Magome: 08:30–11:30. Pickup in Tsumago: from 13:00 onward (usually until 17:00). Seasonal service, running from March 20 to November 30, so it operates normally in September.\n\n💰 **Price: not confirmed with certainty.** Sources disagree between ¥500 and ¥1,000 per bag -- confirm the exact price when dropping it off at the Magome counter, and bring enough cash for either figure.\n\n⚠️ **IMPORTANT:**\nWe arrive at 10:45, there's time to drop it off before 11:30. During the hike, carry only a small backpack with water, ID, phone, battery, and money. Do NOT bring large suitcases on the trail (it has stones and uneven ground)."
      },
      {
