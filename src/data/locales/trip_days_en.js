export const days = [
  ...
  {
    "title": "Transit to Tokyo and Akihabara",
    ...
    "schedule": [
      ...
      {
        "text": "Short rest to settle in: unpack a little and shower after the whole day of trains (bus + Shinano + Shinkansen since early morning). Keep it to no more than an hour -- there's still afternoon ahead."
      },
      {
        "text": "🌉 **WALK TO TOKYO SKYTREE, ALONG THE SUMIDA RIVER.** A very simple and pretty walking route (~15-20 min) from the hotel: crossing the iconic red Azumabashi Bridge next to the Asahi Beer building (with its curious golden sculpture, nicknamed \"the golden turd\" by locals themselves), then following the Sumida River promenade to the base of the tower.\n\n🗼 The Skytree (634 m) is Japan's tallest tower. No need to go up today -- it's enough to see it up close and stroll through **Tokyo Solamachi**, the mall at its base (300 shops, good spots for a snack or coffee). If the group feels up for it after a day of trains, going up to the observation deck can be considered (expect a queue), but there's no need to force it today.\n\n💡 Walk back to the hotel along the same riverside route, with plenty of time before the 19:30 dinner."
      },
      {
