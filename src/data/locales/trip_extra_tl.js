    ...
    options: [
      {
        ...
        note: "Babayaran sa hotel ang tourist tax bawat tao/gabi. Hindi kasama ang mga pagkain.",
      },
    ],
  },
  {
...
export const transports = [
  ...
  { name: "JR Shinano Limited Express", from: "Nakatsugawa", to: "Nagoya", type: "Express JR Line", note: "~50 min. Pagdating sa Nagoya ~10:30 may 30 min buffer para sa Shinkansen" },
  { name: "Shinkansen Nozomi", from: "Nagoya", to: "Tokyo", type: "JR Line (Bullet Train)", note: "Umaalis bawat 10-15 min — walang panganib na maiwanan. Pagdating sa Tokyo ~12:40" },
