export const days = [
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "🏘️ Pagdating sa Tsumago bandang 14:15. Maikling lakad sa nayon -- walang kailangang alagaan na bagahe dito, dahil naiwan ito sa Magome Chaya."
      },
      {
        "text": "🚍 BUS TSUMAGO → MAGOME (Magome Line, local). Alis sa Tsumago: 14:22. Pagdating sa Magome: 14:50. Tagal: 28 min.\n\n🎫 **SUICA:** ❌ HINDI\n📅 **RESERBASYON:** ❌ HINDI\n🛒 **PAMBILI:** Cash payment sa driver o tiket sa opisina ng Tsumago. Presyo: ¥1,000/tao (~6€). Hindi kailangan ng JR Pass. Hindi kailangang mag-reserve.\n\n⚠️ **MAHALAGA:** Kailangan ng bus na ito para makabalik sa Magome para matulog."
      },
      {
        "text": "📍 Pagbabalik sa Magome ng 14:50. Nasa atin na ang mga bagahe."
      },
      {
        "text": "Relax na paglalakad sa Magome-juku, sa mga tradisyunal na bahay at makasaysayang kalye nito. Ang bahaging ito ay para sa: opisyal na check-in (nandoon na ang bagahe mula umaga), pagpapahinga, pagligo at pagtangkilik sa nayon.\n\n🚶 **Paano makarating sa Magome Chaya:** ang minshuku ay nasa mismong pangunahing kalye ng nayon (ang batong pababa ng Nakasendo), napakalapit sa hintuan ng local bus — mga dalawang minuto lang na paakyat na lakad. Sarado sa sasakyan ang makasaysayang kalye, kaya lahat ng huling bahagi ng biyahe ay lakad, walang kailangang taxi o ibang transportasyon.\n\n⚠️ **BAYAD SA TULUYAN:** Ang hotel na Magome Chaya ay HINDI pa bayad. **Kailangang bayaran ito doon sa hotel nang CASH (~178.98€ / ~¥32,000 grupo · ~35.80€/tao)**, kaya kailangang **kumuha ng cash** bago pumunta (sa 7-Eleven / konbini ATM).\n\n⚠️ **MAHALAGA:**\nMaraming tindahan at restaurant ang nagsasara nang maaga. Huwag ipagpaliban ang pamimili o pagkain sa huling minuto."
      },
      {
