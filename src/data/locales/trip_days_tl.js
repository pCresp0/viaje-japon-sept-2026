export const days = [
  ...
  },
  {
    ...
    "schedule": [
      {
        "text": "**Praktikal na tips:**\n\n**Karaniwang almusal:** mga 07:00–09:00.\n**Tanghalian:** mga 11:30–14:00.\n**Hapunan:** mga 17:30–21:00.\n\nMaraming maliliit na restaurant ang nagsasara sa pagitan ng tanghalian at hapunan.\n\nSa mga araw na napakaagang alis, bumili ng almusal sa gabi bago sa konbini. Sa mga excursion na masikip ang oras, magdala ng emergency na onigiri/sandwich. Ang mga konbini (7-Eleven, Lawson, FamilyMart) ay praktikal at murang opsyon para sa onigiri, sandwich, bento, prutas, yogurt, karaage, at inumin. Bukod dito, bukas ang mga konbini 24 oras, 7 araw sa isang linggo, kaya puwede kang bumili ng almusal anumang oras nang walang alalahanin.\n\nAng simpleng pagkain ng ramen/udon/donburi ay maaaring magkahalaga ng mga **¥500–1,500 (~3–9€)**.\n\nHindi na kailangang mag-book normally para sa ramen, udon, donburi, mabilisang Japanese food, casual na izakaya, o mga food stall. Mag-book lang ng special/sikat na restaurant kapag talagang gusto nating kumain doon.\n\nSa mga palengke at street food area, igalang ang lokal na patakaran tungkol sa kung saan kakain. Sa Japan, hindi karaniwan ang kumain habang naglalakad sa mga shopping street; sa Nishiki Market, hayagang hindi ito inirerekomenda."
      },
      {
        "text": "🛬 Paglapag sa Narita (NRT).\n\nKailangang dumaan sa immigration, pagkuha ng naka-check-in na bagahe, customs, at paglabas papuntang public area ng airport.\nTandaang ihanda ang Visit Japan Web QR code ng 5 manlalakbay para mapabilis ang proseso.\n\n💡 Tip: Ang tunay na oras ng paglabas sa airport ay maaaring magbago-bago nang malaki depende sa immigration, bagahe, at customs. Kaya hindi pa natin binili nang maaga ang Narita Express."
      },
      {
        "text": "🚂 NARITA EXPRESS (N'EX) — ⏳ NAKABINBIN / BIBILHIN SA NARITA\n\n🎫 **SUICA:** ❌ HINDI puwede ibayad (kailangan ng express ticket)\n📅 **RESERBASYON:** 🔴 KAILANGAN\n🛒 **PAMBILI:** BILHIN DOON. Sa mga makina o JR ticket counter mismo sa Narita Airport. HUWAG bumili nang maaga.\n\nRuta: Narita Airport → Shinagawa\n(Ang oras na ~14:45 ay tinatayang target lang).\n\nPagkatapos ng customs, sundin ang mga signage ng JR / Narita Express. Bilhin ang tiket sa mga makina ng JR o sa opisina/counter ng JR sa airport.\n\n⚠️ **MAHALAGA:**\n- HINDI ito metro. Long-distance na tren ito ng JR.\n- Sasakyan ito sa JR station ng airport.\n- HINDI pa binibili ang tiket.\n- Ayaw nating mag-fix ng partikular na tren bago lumipad, dahil baka ma-delay ang flight.\n- Bibilhin natin ito SA MISMONG NARITA AIRPORT kapag mayroon na tayong makatotohanang tantiya ng oras.\n- Para sa rutang ito kailangan ng N'EX ticket. Huwag gamitin ang Smart EX.\n- 5 kami: bilhin ang 5 tiket nang magkakasama at humingi ng magkakatabing upuan kung puwede.\n\nPaalala: Kung na-delay ang flight, hindi tayo mawawalan ng anumang N'EX ticket dahil hindi pa natin ito binibili. Bibilhin na lang natin ang susunod na N'EX na makakarating sa Shinagawa sa oras."
      },
      {
        "text": "🚄 **SHINKANSEN NOZOMI 53 (SHINAGAWA → KYOTO)**\n\nDiretsong bullet train papuntang Kyoto Station (17:19 → 19:23 · 2h 04min). Nabili na ang mga tiket at naka-assign na ang upuan sa Smart EX para sa 5 manlalakbay. I-expand ang card sa ibaba para tingnan ang mga upuan at indibidwal na QR ticket."
      },
      {
        "text": "Naglalakbay tayo may dalang malalaking naka-check-in na maleta, pero hindi naman sobrang laki. Kailangan lang mag-book ng oversized luggage space kung ang isang piraso ay lumampas sa 160 cm kapag pinagsama ang taas + lapad + lalim. (Halimbawa: 75 + 50 + 30 = 155 cm → hindi oversized). Hindi na kailangang mag-book ng oversized space para sa normal na maleta na hindi lumalampas sa 160 cm."
      },
      {
        "text": "🚅 Pagdating sa Kyoto (JR Kyoto Station). Lalabas tayo sa Hachijo East Exit (八条東口). Mula doon, 5 minutong lakad lang papunta sa ating hotel."
      },
      {
        "text": "🏨 **CHECK-IN: HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\n✅ Bayad na ang hotel (669.86€ sa pamamagitan ng Booking).\n\nPagdating sa hotel, proseso ng check-in para sa mga kwarto ng grupo, iwan ang bagahe, magfreshen up at mag-relax nang tahimik pagkatapos ng international flight at mga tren ngayong araw.\n\n♨️ May malaking onsen (public bath) ang hotel, hiwalay para sa lalaki't babae, bukas mula 15:00 hanggang 01:00 at 6:00 hanggang 10:00 — perpekto para magpahinga pagkatapos ng biyahe."
      },
      {
        "text": "🍣 **HAPUNAN: KAITEN-SUSHI UOGASHI**\n\nInirerekomendang restaurant sa **AEON MALL KYOTO** — Sakura Building, 4F (https://maps.app.goo.gl/ByDBQB6zaVZ3dj2E6). Mga 5–7 minutong lakad mula sa hotel at istasyon.\n\n**Kaiten-zushi** (sushi sa conveyor belt). Tinatayang presyo: **¥2,000–3,000/tao (~12–19€)**.\n\nOras: 11:00–22:00 (huling order mga 21:30). Hindi na kailangang mag-reserve.\n\n**Ano ang subukan:** iba't ibang sushi; sariwang isda; nigiri; special ng araw; isang mainit na side dish."
      },
      {
        "text": "🏨 **BALIK SA HOTEL: HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\nBalik sa hotel pagkatapos ng hapunan para magpahinga (1st gabi sa Kyoto sa Hotel Keihan Kyoto Hachijoguchi)."
      },
      {
        "text": "🍙 **PAGBILI NG ALMUSAL SA KONBINI (MALAPIT SA HOTEL)**\n\nBago matulog, bumili sa malapit na konbini (7-Eleven / Lawson / FamilyMart) ng almusal para sa Araw 2 (maagang byahe papuntang Fushimi Inari). Bukas 24h: puwede kang pumunta ng 22:00 o mas huli pa nang walang problema."
      }
    ],
  ...
  },
  {
    ...
    "schedule": [
      {
        "text": "Gumising. 🍳 Almusal sa hotel ng 07:00. Masyadong maagang nagbubukas ang Kiyomizu-dera kaya hindi dapat ma-late ang pag-alis.\n\n⚠️ **MAHALAGANG PAALALA NGAYONG ARAW:** Sa araw na ito (pagdaan sa Kyoto Station sa tanghali o pagbalik mula Osaka), kailangan nating **kunin ang mga pisikal na tiket** para sa Thunderbird train bukas papuntang Kanazawa sa berdeng 5489 ticket machines gamit ang pisikal na Mastercard (nagtatapos sa 8625)."
      },
      {
      ...
      {
        "text": "🌃 DOTONBORI.\n\nAng lugar ng neon lights at malalaking signage sa tabi ng kanal, sa puso ng Namba. Hinukay ang kanal noong 1615 at naging theater district ng Osaka ang lugar sa loob ng daan-daang taon (kabuki at bunraku); ngayon ito ang mecca ng street food at panggabing lakad, may Glico running-man sign bilang pinaka-litratuhang icon nito.\n\nPanggabing lakad at street food. Unahin: Dotonbori, Glico, Ebisu Bridge, Hozenji Yokocho.\n\n💡 Tips: Hindi na kailangan mag-book para sa street food sa Dotonbori; pumili na lang ng puwesto/restaurant sa mismong oras. Mas maganda ang Dotonbori pagkatapos magdilim, kaya mainam dumating mga 18:40.\n\n🍜 Ano ang subukan dito: 1. Takoyaki 🐙 (Ibahagi ang isang order. Opsyon: Takoyaki Wanaka Dotonbori. Tinatayang badyet: ¥500–1,000 (~3–6€)). 2. Okonomiyaki (Ibahagi o umorder ng isa bawat tao depende sa gutom. Opsyon: CHIBO Dotonbori. Tinatayang badyet: ¥2,000–3,000 bawat tao (~12–19€)). 3. Hozenji Yokocho (Magandang alternatibo para makaiwas sa mas turistang bahagi ng Dotonbori. Maghanap ng maliit na izakaya o lokal na restaurant).\n⚠️ Huwag basta pumasok sa restaurant na may pinakamalaking signage sa Dotonbori. Napaka-turista ng pangunahing lugar at may mga tindahang mas mahal dahil sa lokasyon nila. Sa pagitan ng mga 18:00 at 22:00, sobrang dami ng tao sa Dotonbori. Panatilihing magkakasama ang grupo ng 5 at magkaroon ng malinaw na meeting point."
      },
      {
        "text": "🏮 SHINSEKAI.\n\nKung may oras at lakas pa pagkatapos ng Dotonbori: retro na distrito na itinayo noong 1912, inspirasyon ang Paris sa hilaga at Coney Island sa timog, na pinuputungan ng Tsūtenkaku tower (na ginaya ang Eiffel Tower). Naiiba ito sa mas makinis at turistang Dotonbori — mas old-school dito ang vibe, may mga signage na kupas na at pakiramdam ng mas lokal na Osaka.\n\n🍢 Ano ang subukan dito: Kushikatsu — breaded at pritong skewer, isa sa makasaysayang specialty ng lugar. Subukan ang iba't ibang klase. Mahigpit na patakaran: hindi puwedeng i-dip nang dalawang beses ang parehong skewer sa shared sauce, nakasulat ito sa lahat ng tindahan.\n\n💴 Badyet sa pagkain sa Osaka (Dotonbori + Shinsekai sama-sama): para sa simpleng food-crawl na gabi, maglaan ng mga ¥2,500–4,000 bawat tao (~15–25€) kung pagsasamahin ang takoyaki + okonomiyaki/kushikatsu + inumin, depende na rin sa dami ng kakainin."
      },
      {
        "text": "🚆 OSAKA → KYOTO. Bumalik sa Kyoto sakay ng JR. Walang reserbasyon. Gumamit ng IC card o single ticket."
      },
      {
        "text": "🏨 **BALIK SA HOTEL: HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\nPagkatapos ng tren mula Osaka, bumalik sa hotel para magpahinga (ika-5 at huling gabi sa Kyoto). Bukas: padala ng maleta sa Tokyo at Thunderbird papuntang Kanazawa.\n\n**Mula Kyoto Station:** ~5 min lakad sa Hachijo East Exit (八条東口)."
      },
      {
  ...
  },
  {
    ...
    "schedule": [
      {
        "time": "07:30",
        "text": "🍙 Gising na at mabilisang almusal na dadalhin. Ang Hotel Resol Trinity Kanazawa ay HINDI kasama ang almusal sa reserbasyon natin. Bagama't nag-aalok ang hotel ng almusal mula 07:00, mas praktikal ngayong umaga na bumili sa gabi bago sa konbini: onigiri, sandwich, prutas, kape/inumin. Huwag umasa sa almusal ng hotel dahil kailangan nating sumakay sa bus ng 08:40. Ihanda rin ang tubig na dadalhin."
      },
      {
        "time": "08:40",
        "text": "🚌 Nohi Bus Kanazawa → Shirakawa-go.\n\n📍 **SAAN SASAKAY:** Kanazawa Station, WEST Exit (West Exit / Kanazawa-ko guchi), Bus Terminal nº4 -- nakumpirma mismo sa opisyal na 12GO/Nohi Bus na tiket (tingnan ang PDF sa ibaba), kaya walang duda dito.\n\n🎫 **SUICA:** ❌ HINDI\n📅 **RESERBASYON:** ✅ NABILI NA\n🛒 **PAMBILI:** Gamitin ang nakumpirmang reserbasyon ng 12GO / Hokutetsu.\n\nAlis: 08:40. Reserbasyon: 12GO31991741. Booking ID M26125669. 5 nakumpirmang upuan (1-2D, 3ABCD). Tinatayang tagal: 1h25. Inaasahang pagdating: 10:05. Kailangan ng reserbasyon para sa serbisyong ito. Hindi JR. Hindi gumagamit ng Japan Rail Pass. Huwag gumamit ng Suica: gamitin ang reserbasyon/tiket ng bus. ⚠️ **KAILANGAN dalhin ang NAKA-PRINT na voucher sa papel** -- kailangang tanggapin ng driver ang pisikal na papel, hindi tinatanggap ang pagpapakita sa cellphone o screenshot. 💡 Tip: Dumating sa hintuan nang may sapat na oras. Posibleng ma-delay ng 2 oras o higit pa dahil sa trapiko, niyebe, o pagsara ng highway sa panahon ng taglamig.\n\n🎧 **Podcast para sa biyahe:** [Takayama at Shirakawa-go: ang puso ng Alps](https://podcasts.apple.com/es/podcast/jap%C3%B3n-a-fondo/id1545542012?i=1000527462410) (*Japón a fondo* · Japonismo). Para mapakinggan ang kwento ng mga gassho-zukuri house, ang tahimik na buhay sa niyebe, at ang tradisyunal na craftsmanship ng Takayama."
      },
      {
        "time": "10:05",
        "text": "Pagdating sa Shirakawa-go. May mga 3 oras 10 minuto tayo (hanggang sa alis ng bus papuntang Takayama ng 13:15).\n\n🗺️ Kumpletong ruta ng Shirakawa-go: https://maps.app.goo.gl/mBcF6hHWpwwC5HxeA?g_st=iw\n\n🔒 **LOCKER PARA SA MGA BACKPACK:** May coin lockers ang mismong Shirakawa-go Terminal (18 sa kabuuan) sa likod/tabi ng pangunahing gusali — maliit/katamtaman ¥500, malaki ¥1,000, oras 08:00–17:00. Kung puno lahat, puwedeng humingi sa information counter na mag-alaga ng bagahe nang manual."
      },
      {
        "time": "10:05–11:55",
        "text": "🌉 Tawirin ang **Deai Bridge** (ang iconic na pasukan ng nayon) at umakyat papuntang **Shiroyama Viewpoint** (15-20 min, banayad na asphalt slope; alternatibo shuttle ¥200-300). Umakyat na ngayon, pagdating agad, dahil sa mga 11:30 medyo masisikip na ang nayon.\n\nBumaba at maglakad-lakad sa **Ogimachi**: mga kanal, palayan, tradisyunal na kalye. Tapusin sa pagbisita sa **Wada House** (ang tanging bahay na bisitahin, ang pinakamalaki at pinakamahusay na napreserba, ¥400, hindi na kailangang mag-reserve, 09:00–17:00, 3-4 minuto mula sa terminal)."
      },
      {
        "time": "12:00–13:15",
      ...
      {
        "time": "🎫 RESERBASYON",
        "text": "NABILI NA: Kanazawa → Shirakawa-go (08:40, 5 upuan) at Shirakawa-go → Takayama (13:15, 5 upuan). HINDI natin kailangan ng Japan Rail Pass, tren, o Suica para sa mga bus na ito."
      },
      {
        "time": "🚍 BUOD NG TRANSPORTASYON",
        "text": "Kanazawa → Shirakawa-go: Nabook na Nohi Bus, 08:40 → 10:05 (3 oras 10 minutong pagbisita sa Shirakawa-go).\nShirakawa-go: Lahat lakad.\nShirakawa-go → Takayama: Nabook na Nohi Bus, 13:15 → 14:05.\nTakayama Bus Terminal → Hotel Wood: mga 12 minutong lakad.\nHotel → Sanmachi: katabi lang.\nHindi natin kailangan ng Japan Rail Pass o tren ngayon."
      },
      {
        "time": "🍽️ TIPS SA PAGKAIN",
        "text": "⚠️ Sa Shirakawa-go, kumain ng mga 12:00 sa Tanaka-ya para hindi malagay sa alanganin ang bus ng 13:15.\n⚠️ Sa Takayama nagsasara ang mga tindahan ng mga 17:00, pero mas mahuling bukas ang mga restaurant ng hapunan. Kaya ang hapunan ng 19:00. 🥩 Ang Takayama ay perpekto para tikman ang Hida beef -- order ang hoba miso at Hida beef nigiri-zushi."
      }
    ],
  ...
  },
  {
    ...
    "summary": "Maglalakbay tayo sa magandang panoramic na tren at pagkatapos ay sa pamamagitan ng bus hanggang Magome para simulan ang banayad na hiking trail sa lumang gubat. Maglalakad tayo papuntang Tsumago at babalik gamit ang bus sa Magome, kung saan tayo matutulog sa isang rural na inn.",
    ...
    "schedule": [
      {
        "time": "07:00",
        "text": "🍙 Gising na at mabilisang almusal. Ang Hotel Wood Takayama ay hindi dapat maging pagkukunan natin ng almusal ngayong umaga maliban kung kasama ito sa reserbasyon. Bumili ng almusal sa gabi bago: onigiri, sandwich, tinapay, prutas, kape/inumin. Kumain bago umalis o dalhin para sa bus. 💡 Tip: Umalis na handa na ang lahat dahil may nakabook tayong bus ng 08:00."
      },
      {
        "time": "07:20 humigit-kumulang",
        "text": "🚶 Umalis sa Hotel Wood Takayama papuntang Takayama Nohi Bus Center (mga 10–15 minutong lakad). Target: dumating sa pagitan ng 07:30 at 07:35 para mapalitan nang tahimik ang mga tiket."
      },
      {
        "time": "07:35",
        "text": "⚠️ **KAILANGANG PALITAN ANG E-TICKET:**\n\nSa Takayama Nohi Bus Center, ipakita ang E-ticket ng Japan Bus Online (sa cellphone o naka-print) sa counter para **ipalit ito sa pisikal na tiket**.\n\n⚠️ **MAHALAGA:** Kailangan ng operator na gawin ang palitan nang hindi bababa sa 15 minuto bago ang alis ng 08:00 (dumating bago mag-07:45 kung hindi mas maaga). Itago ang pisikal na tiket para ipakita pagsakay sa bus."
      },
      {
        "time": "08:00",
        "text": "🚌 Direktang Nohi Bus: Takayama → Magome.\n\n🎫 **SUICA:** ❌ HINDI\n📅 **RESERBASYON:** ✅ NABILI AT NAKUMPIRMA\n📄 **E-TICKET:** Reserbasyon 08302008262 · May-ari: Pablo C.\n\nAlis: Takayama Nohi Bus Center (08:00) → Pagdating: Magome (10:45).\nCar No. 01 · 5 Upuan: 2C, 2D, 3B, 3C, 3D.\nKabuuan: ¥25,000 (~135.61€) (5 adults · ¥5,000/tao · ~27€).\n\n⚠️ **MAHALAGA:**\nAng reserbasyon natin ay natatapos sa **MAGOME ng 10:45**. Kahit magpatuloy ang bus hanggang Tsumago (11:10), bababa tayo sa Magome para simulan ang paglalakad sa makasaysayang Nakasendo trail.\n\n🎧 **Kailangang-kailangan na podcast ngayong araw:** [Nakasendo Trail: paglalakad sa mga postcard na nayon](https://podcasts.apple.com/es/podcast/jap%C3%B3n-a-fondo/id1545542012?i=1000655007075) (*Japón a fondo* · Japonismo). Perpekto para sa biyahe sa bus, sisid sa makasaysayang buhay ng mga samurai at mga postal village ng Kiso Valley."
      },
      {
        "time": "10:45",
        "text": "📍 Pagdating sa MAGOME. Tapos na ang byahe sa bus. Ang hintuan ay 2 minuto lang na lakad mula sa ating tinutuluyan (Magome Chaya), mismo sa pangunahing kalyeng bato.\n\n🧳 **PLANO: iwan ang bagahe direkta sa Magome Chaya.** Maglalakad tayo papunta sa minshuku (2 min) at hihingi sa reception na alagaan ang bagahe bago ang opisyal na check-in (15:00) -- karaniwan at inaasahang gawain ito sa mga tirahan sa Japan, kahit hindi ito naipagbigay-alam nang maaga. Sa ganitong paraan, maiiwasan natin ang lahat ng logistics at hindi tiyak na gastos (¥500-1,000/bagahe) ng serbisyo ng transportasyon ng bagahe sa Magome↔Tsumago, dahil dito naman tayo matutulog sa Magome ngayong gabi.\n\n🗼 **PADAAN, ANG PINAKA-DISTINCTIVE SA MAGOME:** paakyat sa pangunahing kalye papunta sa simula ng daanan, may tradisyunal na **water wheel (suisha)** at isang **viewpoint** na tanaw ang Kiso Valley -- 10-15 minuto lang na liko, at padaan ito papunta sa kung saan nagsisimula ang ruta. Dahil malalate at mapapagod kayo mamayang gabi, ito ang pinakamagandang oras para tingnan ito nang tahimik at maliwanag pa.\n\n💡 **Backup na alternatibo (bagahe):** kung sa anumang dahilan ay hindi kayang alagaan ni Magome Chaya ang bagahe nang maaga, ang mga tourist office ng Magome at Tsumago ay nag-aalok ng tunay na serbisyo ng transportasyon ng bagahe sa pagitan ng dalawa (hindi locker): iiwan sa Magome ng 08:30–11:30 at kukunin sa Tsumago mula 13:00 pataas, sa ¥500-1,000/bagahe depende sa source (serbisyong tumatakbo mula Marso 20 hanggang Nobyembre 30)."
      },
      {
        "time": "11:15",
        "text": "🥾 Nakasendo Trail: Magome → Tsumago. Mga 8 km at mga 2h30-3h sa relaxed na bilis. Ang direksyon na Magome → Tsumago ay mas kaunti ang akyat: aakyat sa Magome-tōge pass (~300 m) at pagkatapos ay babababa halos lahat ng natitira. Praktikal na impormasyon: madali-katamtaman ang hirap; malinaw ang mga signage sa daanan; may bahaging kagubatan at asphalt; magdala ng tubig. May bear bells sa ilang punto, gamitin ito habang dumadaan.\n\n📍 **Mga landmark sa daan** (hindi na kailangang aktibong hanapin, lalabas lang ito nang mag-isa kung susundan ang mga signage):\n• **Tateba-chaya**: tradisyunal na teahouse kung saan nagbibigay ng libreng tsaa sa mga manlalakbay -- magandang lugar para sa unang pahinga.\n• **Odaki at Medaki Falls** (\"lalaki\" at \"babae\"): maliit na naka-signage na liko, ang Odaki ay bumabagsak nang mga 18 m, ang Medaki ay mas maliit at banayad.\n• **Kurashina Shrine**: katabi mismo ng mga talon.\n• **Otsumago**: liit na nayon na may tradisyunal na bahay mula sa Edo period, ~1 km bago makarating sa Tsumago -- kasama ang Fujihara house, mula kalagitnaan ng ika-17 siglo.\n\nJuancar, alam na naming bilang government employee sa Reina Sofía ay hindi ka masyadong gumagalaw, pero ngayong araw kailangang maglakad!"
      },
      {
        "time": "12:30–13:00",
        "text": "🍙 TANGHALIAN / SNACK HABANG NAGLALAKAD. Magdala ng pagkain mula Takayama/Magome. Huwag umasa na makahanap ng restaurant habang naglalakad. Bumili ng: onigiri, sandwich, prutas, inumin. Kung may makitang bukas na teahouse (tulad ng Tateba-chaya), puwedeng tumigil, pero huwag umasa dito."
      },
      {
        "time": "13:45 humigit-kumulang",
        "text": "🏘️ Pagdating sa Tsumago (depende sa bilis ng paglalakad -- tunay na reperensya: isang grupong umalis ng 11:11 ay dumating ng 13:46, 8.15 km na may 223 m na desnibel). Sa bus ng 14:22 pabalik, may oras para sa lakad na may tunay na laman, bagama't masikip -- ang Tsumago ay nagpapanatili ng mas maraming ORIHINAL na gusali kaysa Magome (na nasunog nang dalawang beses at muling itinayo):\n\n• **Pangunahing kalye**: bawal ang sasakyan mula 9:00 hanggang 17:00, nakalibing ang mga cable, walang kahit isang moderno na elemento na makikita.\n• **Kōtoku-ji Temple**: kilala sa mga puting pader at haligi ng bato nito, mula taong 1500, nakatanaw sa nayon mula sa isang maliit na burol.\n• **Waki-Honjin Okuya**: ang dating pangalawang inn, orihinal na gusali mula ika-19 siglo, Important Cultural Property.\n• **Nagiso History Museum** (Nagiso Rekishi Shiryokan): katabi ng Waki-Honjin, kung may oras pa.\n\n💡 Dahil sa maikling oras, unahin ang paglalakad sa pangunahing kalye at pagtingin sa Kōtoku-ji Temple mula sa labas -- ang Waki-Honjin at museo ay opsyonal na lang kung may natitirang ilang minuto.\n\n🏠 **Tungkol sa minshuku**: maliit na pamilyang tinutuluyan sa Japan, pinapatakbo ng mismong may-ari na pamilya, na halos palaging may kasamang homemade na hapunan at almusal -- ang katumbas ng rural na B&B. Ito ang uri ng tinutuluyan na nakabook ninyo ngayong gabi sa Magome Chaya."
      },
      {
        "time": "14:15–14:22",
        "text": "🚍 BUS TSUMAGO → MAGOME (Ontake Kotsu, linyang Nagiso-Tsumago-Magome). Alis sa Tsumago: 14:22. Pagdating sa Magome: 14:50. Tagal: 28 min.\n\n🎫 **SUICA:** ❌ HINDI\n📅 **RESERBASYON:** ❌ HINDI\n🛒 **PAMBILI:** Cash payment sa driver o tiket sa opisina ng Tsumago. Presyo: ¥1,000/tao (~6€). Hindi kailangan ng JR Pass. Hindi kailangang mag-reserve.\n\n⚠️ Nakumpirma ang oras gamit ang dalawang independent na source (japan-guide.com at Rome2Rio): ang linyang ito ay may 4 daily na alis mula Tsumago hanggang Magome, araw-araw walang exception."
      },
      {
        "time": "14:50",
        "text": "📍 Balik sa Magome. Nasa atin na ang bagahe.\n\n🍜 **KUMAIN SA MAGOME.** Buong hapon pa bago ang hapunan ng 18:00, magandang oras para kumain nang tahimik sa mismong nayon -- gohei-mochi at oyaki sa mga puwesto ng pangunahing kalye, o alinman sa maliliit na lokal na restaurant."
      },
      {
        "time": "15:30–18:00",
        "text": "🏨 Check-in sa Magome Chaya (https://www.google.com/maps/search/?api=1&query=Magome+Chaya+Gifu) -- nandoon na ang bagahe mula umaga, maligo at magpahinga bago ang hapunan.\n\n🚶 **Paano makarating sa Magome Chaya:** ang minshuku ay nasa mismong pangunahing kalye ng nayon (ang batong pababa ng Nakasendo), napakalapit sa hintuan ng local bus — mga dalawang minuto lang na paakyat na lakad. Sarado sa sasakyan ang makasaysayang kalye, kaya lahat ng huling bahagi ng biyahe ay lakad, walang kailangang taxi o ibang transportasyon.\n\n⚠️ **BAYAD SA TULUYAN:** Ang hotel na Magome Chaya ay HINDI pa bayad. **Kailangang bayaran ito doon sa hotel nang CASH (~178.98€ / ~¥32,000 grupo · ~35.80€/tao)**, kaya kailangang **kumuha ng cash** bago pumunta (sa 7-Eleven / konbini ATM) kung hindi pa ito nagawa.\n\n♨️ May maliit na communal bath na parang onsen (hiwalay para sa lalaki't babae), walang fixed na opisyal na oras — mas mabuting magtanong sa check-in; karaniwang mas tahimik ito sa mga 18:00–19:00, kapag naghahapunan ang iba."
      },
      {
        "time": "18:00",
        "text": "🍱 **TRADISYUNAL NA HAPUNAN SA MAGOME CHAYA**\n\nNakumpirmang tradisyunal na hapunan sa tinutuluyan (inihahain nang eksakto sa 18:00). Presyo: ¥3,630/tao (~23€).\n\nMay dalawang opsyon ng pangunahing menu:\n\n• **Menu A:** Inasnan at inihaw na isda sa ilog at mainit na nabemono ng baboy na may kabute.\n• **Menu B:** Tonkatsu (breaded at pritong baboy).\n\nParehong menu ay may kasamang tempura ng gulay, sashimi, kanin, side dish at dessert."
      },
      {
        "time": "~20:00",
        "text": "🏮 **PAGLALAKAD SA MAGOME SA GABI.**\n\nMga kalyeng bato na naiilawan ng tradisyunal na parol, mas tahimik kaysa sa tanghali. Sarado na ang mga tindahan, pero ang atmosphere at arkitektura ay kasing sarap pa rin. Huwag masyadong lumayo sa tinutuluyan, maagang nagsasara ang nayon.\n\n💧 Walang konbini o bukas na tindahan sa oras na ito sa Magome -- magdala ng tubig na binili na kung kailangan, huwag umasang may makikita habang naglalakad."
      },
      {
        "time": "🚍 BUOD NG TRANSPORTASYON",
        "text": "🏨 Hotel Wood Takayama\n↓ 10–15 min na lakad (07:20)\n↓ 🚌 Takayama Nohi Bus Center (07:35 palitan ng tiket)\n↓ 08:00–10:45 🚌 Direktang Nohi Bus (✅ Nabook)\n↓ 📍 Magome (baba 10:45)\n↓ iwan ang bagahe sa Magome Chaya (2 min na lakad)\n↓ 🥾 8 km / ~2h30-3h Nakasendo Trail\n↓ 📍 Tsumago\n↓ 🚌 14:22–14:50 Bus (Ontake Kotsu)\n↓ 📍 Magome\n↓ 🍜 Kumain sa Magome\n↓ 🏨 Magome Chaya (check-in, nandoon na ang bagahe)\n↓ 🍱 Hapunan 18:00\n↓ 🏮 Gabing lakad sa Magome."
      },
      {
        "time": "💡 NAKASENDO TIPS",
        "text": "🥤 Magdala ng sapat na tubig at magaan na pagkain bago magsimula. 🍵 May mga teahouse pero may iba't ibang oras. 🌙 Maagang nagsasara ang Magome, ang hapunan ng 18:00 ang ligtas na opsyon. 🥾 Komportableng sapatos na may magandang suwelas. 🌧️ Mag-ingat sa putik kung uulan. 🐻 Gamitin ang bear bells. 🎒 Maglakad lang na may maliit na backpack gamit ang serbisyo ng bagahe. 📸 Huwag magmadali, tamasahin ang ruta."
      }
    ],
    "money": "Tinatayang €40 (pagkain)"
  },
  {
    "title": "Paglipat patungong Tokyo",
    "cities": "Tokyo (Asakusa)",
    "summary": "Aalis tayo sa Alps upang maglakbay sakay ng bullet train papuntang Tokyo, kung saan makikita nating muli ang aming malaking bagahe. Tahimik na hapon para mag-settle sa hotel sa Asakusa at magpahinga mula sa maghapong biyahe sa tren, may simpleng hapunan malapit lang.",
    "history": "Ang Edo (sinaunang Tokyo) ay nagbago mula sa nayon ng mga mangingisda patungo sa pampulitikang sentro ng Japan noong 1603. Ang Asakusa, kung saan tayo tutuloy, ay naging popular na entertainment district ng lungsod sa loob ng mga siglo, sa paligid ng templong Sensō-ji.",
    "schedule": [
      {
        "text": "🍙 07:00 — ALMUSAL\nHindi nag-aalok ng almusal ang Magome Chaya simula 2026.\n\n⚠️ **Walang konbini sa Magome** (ito ay sinadyang napreserba na nayon na walang modernong chain, wala man lang makikitang vending machine sa pangunahing kalye) -- kaya walang mabibilhan dito ngayong maagang umaga, ni kagabi rin nang magsara na ang mga lokal na tindahan.\n\n✅ **KAKAIN TAYO NG ALMUSAL SA NAKATSUGAWA**, habang nagpapalit mula bus papuntang tren. Ang bus ng 08:15 ay darating sa Nakatsugawa mga 08:40, at ang Shinano ay hindi aalis hanggang 09:57 -- mahigit isang oras sa tunay na lungsod, na may train station, kung saan malamang na may makitang konbini (7-Eleven/Lawson/FamilyMart) malapit sa estasyon para makakain nang tahimik, pagkatapos kunin ang mga tiket ng JR-WEST."
      },
      {
        "text": "🚌 08:15 — LOKAL NA BUS MAGOME → NAKATSUGAWA\n\n🎫 **SUICA:** ❌ HINDI (cash lang)\n📅 **RESERBASYON:** ❌ HINDI\n🛒 **BILI:** Kumuha ng numbered ticket paakyat sa likurang pinto, magbayad ng cash sa driver pagbaba.\n\nAlis: Magome — 08:15\nDating: Nakatsugawa Station — 08:40\nTagal: halos 25 min.\nUri: lokal na bus.\nReserbasyon: HINDI pwedeng i-reserve.\nJapan Rail Pass: HINDI kasama.\nBayad: bumili/magbayad on the spot sundin ang instructions ng operator.\nEstimated presyo: ¥800/tao (~€5).\n\n⚠️ **IMPORTANTE:**\nSetyembre 15, 2026 ay Martes, kaya't weekday schedule ang susundin.\nDumating sa bus stop nang maaga ng ilang minuto.\nKailangan ang bus na ito para makakonekta ang Magome sa JR rail network."
      },
      {
        "text": "🎫 **08:40 — KUNIN ANG PISIKAL NA JR-WEST TICKETS (CRITICAL)**\n\nDating sa Nakatsugawa (~08:40). Aalis ang Shinano 4 nang **09:57** → ~**77 min**.\n\n🟢 Bayad na ang reserbasyon (**42093**). Hindi ito pagbili — **pagkuha ng pisikal na ticket**.\n\n⚠️ Kailangan: machine/ticket office **LABAS ng gates**, physical Mastercard **8625**, Reservation **42093**, PIN = **reservation PIN**.\n\n💡 Kung pwede, kunin nang mas maaga; kung hindi, **sa Nakatsugawa**."
      },
      {
      ...
      {
        "text": "🍜 **HAPUNAN: ASAKUSA MONJA MONRO** (rekomendasyon ng kaibigan ni Thibaut). Monjayaki at teppanyaki na niluluto sa harap ninyo mismo ng staff -- specialty ng bahay na may seafood mula sa Tsukiji/Toyosu markets. Mataas ang rating (top 5 sa mga review sa Asakusa). Puwedeng may kaunting hintayan, pero sulit. Ilang minuto lang mula sa hotel."
      },
      {
      ...
      {
        "text": "TANGHALIAN\nDahil maaga ang almusal at sa Shinkansen ang pangunahing tanghalian, hindi na kailangang mag-reserve ng anuman para sa tanghalian.\n\nHAPUNAN\nIwan ang hapunan para sa isang simpleng lugar malapit sa Asakusa.\nHuwag ipagpalagay na lahat ng restaurant ay bukas hanggang gabi.\nPara sa isang partikular na restaurant at dahil 5 tao, mag-reserve kung sikat ang napili."
      },
      {
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "Ueno Park at Ameyoko street market, maganda para sa murang tsaa at matamis. Magandang berdeng lugar para maglakad-lakad nang tahimik pagkatapos ng maagang gising.\n\n🦪 **MERYENDA SA AMEYOKO** (rekomendasyon ng kaibigan ni Thibaut): kilala rin ang mga puwesto ng palengke sa inihaw na seafood -- inihaw na talaba at igat, bukod sa iba pa. Kung hindi pa ninyo natikman ang igat (unagi), ito ang magandang pagkakataon.\n\n🎮 **YAMASHIROYA** (rekomendasyon ng kaibigan ni Thibaut): 6-palapag na tindahan ng anime/video game figure, laruan at merchandise, 1 minuto lang na lakad mula sa Ueno Station. Nakumpirma na mas mura ang presyo kaysa sa Akihabara, at halatang hindi masyadong siksikan."
      },
      {
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "time": "13:45–15:45",
        "text": "🎮 **Akihabara (2 oras).** Rutang susundin, sa ganitong pagkakasunod-sunod:\n\n• **Akihabara Station:** panimulang punto, labasan patungong Electric Town.\n• **Radio Kaikan:** makasaysayang 10-palapag na gusali mismo sa labasan ng estasyon, puno ng dose-dosenang tindahan ng figure, card at koleksyon na nakapatong-patong.\n• **Chuo-dori:** ang pangunahing kalye ng Akihabara, may malalaking neon signs (sarado sa sasakyan tuwing hapon ng Linggo; Sabado ngayon, kaya maaaring hindi applicable).\n• **Animate:** ang pinakamalaking manga/anime store chain sa Japan, may opisyal na merchandise ng halos kahit anong serye.\n• **Super Potato:** templo ng retro gaming, may NES, SNES at Game Boy sa ambiance na parang mula sa dekada '90.\n• **Mandarake:** malaking secondhand chain para sa manga, figure at koleksyon mula sa lahat ng panahon.\n• **Arcade Hey / Taito:** klasikong Japanese arcade, para sa UFO catcher, rhythm, o fighting games.\n• **Kanda Myojin:** Shinto shrine na mahigit 1,000 taon na, kakaibang popular sa mga otaku dahil sa pagbabasbas ng tech products at anime characters."
      },
      {
        "time": "15:45–16:15",
  ...
  },
  {
    ...
    "schedule": [
      {
        "text": "🏮 **TUNAY NA PAGBISITA SA ASAKUSA AT SENSŌ-JI** (hindi bilang backup plan mula sa ibang araw -- huling umaga, may sapat na oras at bukas na ang mga tindahan).\n\n• **Kaminarimon Gate**: ang malaking pulang parol, iconic na pasukan sa lugar ng templo.\n• **Nakamise Street**: halos 200 metro ng maliliit na tradisyunal na tindahan -- matamis, gawaing-kamay, souvenir, pamaypay, yukata -- hanggang sa pintuan ng templo. Magandang lugar para sa huling pamimili (flavored Kit-Kats, matcha).\n• **Sensō-ji Temple**: ang pinakalumang Buddhist temple sa Tokyo (taong 628), may malaking incense burner at pangunahing hall.\n• Tahimik na paglalakad sa mga tradisyunal na eskinita sa paligid, bago bumalik sa hotel.\n\n🍽️ **KAPPABASHI DORI** (rekomendasyon ng kaibigan ni Thibaut): ang kalyeng buong-buo na nakatuon sa mundo ng pagluluto, literal na katabi ng inyong hotel (nasa parehong kapitbahayan, Nishi-Asakusa). Ang lugar para makabili ng tunay na Japanese ceramics, at pati na rin ang sikat na plastic food replica (sampuru) -- isang napakatipikal na curiosity ng Japan, kahit hindi para sa lahat ng panlasa. Puwedeng idagdag nang hindi na kailangan ng transportasyon, pahabain lang ang parehong lakad ngayong umaga.\n\n💡 Dahil 10 minutong lakad lang ang hotel, walang kailangang transportasyon para dito -- puwedeng bumalik para sa bagahe nang tahimik bago ang biyahe papuntang airport."
      },
      {
      ...
      {
        "text": "Flight QR809 Narita → Doha (Qatar Airways, 10h 55m · 17:25 → 22:20). Pagsubaybay: https://www.google.com/search?q=flight+QR809. Layover sa Doha nang 2h 50m (22:20 → 01:10), tapos flight QR147 Doha → Madrid (Qatar Airways / Iberia, 7h 25m · 01:10 → 07:35). Pagsubaybay: https://www.google.com/search?q=flight+QR147. Pagdating sa Madrid (T4S) sa Mar Set 22 nang 07:35."
      }
    ],
    "money": "Tinatayang €40 (pagkain)"
  }
