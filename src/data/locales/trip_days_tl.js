export const days = [
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "Maikling pahinga para makapag-ayos: mag-unpack nang kaunti at maligo pagkatapos ng buong araw ng tren (bus + Shinano + Shinkansen mula umaga pa). Huwag lampasan ang isang oras -- may hapon pa sa unahan."
      },
      {
        "text": "🌉 **PAGLALAKAD PAPUNTANG TOKYO SKYTREE, KASABAY NG ILOG SUMIDA.** Napakasimple at magandang ruta ng lakad (~15-20 min) mula sa hotel: tatawirin ang kilalang pulang Azumabashi Bridge katabi ng gusali ng Asahi Beer (may kakaibang gintong eskultura, na tinawag na \"golden turd\" mismo ng mga taga-Tokyo), pagkatapos ay susundin ang promenade ng Ilog Sumida hanggang sa paanan ng tore.\n\n🗼 Ang Skytree (634 m) ang pinakamataas na tore sa Japan. Hindi na kailangang umakyat ngayon -- sapat nang makita ito nang malapitan at maglakad-lakad sa **Tokyo Solamachi**, ang mall sa paanan nito (300 tindahan, magandang lugar para sa meryenda o kape). Kung gusto at may lakas pa ang grupo pagkatapos ng maghapong biyahe sa tren, puwedeng isaalang-alang ang pag-akyat sa observation deck (posibleng may pila), pero hindi na kailangang pilitin ngayon.\n\n💡 Balik sa hotel gamit ang parehong ruta sa tabing-ilog, may sapat na oras bago ang hapunan ng 19:30."
      },
      {
