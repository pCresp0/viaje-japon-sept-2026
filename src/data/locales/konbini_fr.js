...
export const konbiniChains = [
  ...
  {
    badge: "Notre konbini préféré pour le petit-déjeuner · Pâtisseries 'Uchi Café' & Karaage-kun",
    vibe: "Le meilleur konbini et notre coup de cœur absolu pour le petit-déjeuner ! Son logo en bouteille de lait rappelle ses origines laitières. Inégalable le matin : viennoiseries toutes fraîches, excellent café, pâtisseries à la crème Uchi Café et poulet croustillant.",
    specialty: "Petits-déjeuners d'exception, café Machi Café (bleu & rouge), Melon Pan, brioches vapeur, mochis, barres protéinées & Karaage-kun.",
    bestFor: "Prendre son petit-déjeuner chaque matin (cafés, melon pan, egg steamed cake) et s'offrir des douceurs après le repas.",
    items: [
      {
        name: "Café Machi Café (Bleu sans sucre / Rouge sucré)",
        highlight: "☕ Notre rituel indispensable du matin en deux formats (M et L)",
        desc: "Le café en libre-service de Lawson (Machi Café) est excellent. Deux variantes reconnaissables à leur couleur : Bleu (sans sucre, café noir ou latte nature) et Rouge (sucré / latte gourmand). Disponible en tailles M et L. Idéal avec une viennoiserie.",
        tag: "Boisson / Petit-déjeuner",
        tip: "Commandez en caisse en précisant la taille et la couleur (« Aisu kōhī M / L, mutō [bleu] ou katō [rouge] ») ou prenez le gobelet glacé et préparez-le à la machine.",
      },
      {
        name: "Melon Pan (Classique & Chocolat)",
        highlight: "🍈 Qu'est-ce que le Melon Pan ? Brioche moelleuse sous une croûte sablée croustillante",
        desc: "Qu'est-ce que le Melon Pan ? L'une des viennoiseries les plus emblématiques du Japon. Il s'agit d'une brioche tendre et aérée recouverte d'une fine couche de pâte à biscuit sablée et croustillante, gravée d'un quadrillage rappelant l'écorce d'un melon cantaloup (d'où son nom, et non parce qu'il contient du melon). Chez Lawson, la version dorée classique et la version chocolatée sont toutes deux fabuleuses.",
        tag: "Boulangerie / Star du matin",
        tip: "Si vous pouvez le tiédir quelques secondes au micro-ondes, la croûte sablée devient encore plus croustillante et le cœur fondant.",
      },
      {
        name: "Egg Steamed Cake (Gâteau moelleux aux œufs à la vapeur)",
        highlight: "🥚 Moelleux incomparable : aérien, fondant et doux comme un nuage",
        desc: "Le célèbre Tamago Mushi-pan (gâteau cuit à la vapeur) de Lawson est une pure merveille. Cuit à la vapeur avec de bons œufs et du lait frais, il a une belle couleur jaune doré et une texture humide et fondante en bouche sans jamais être étouffante. Parfait avec un café chaud.",
        tag: "Boulangerie / Petit-déjeuner",
        tip: "À retrouver au rayon boulangerie emballée, sachet transparent avec étiquette jaune.",
      },
      {
        name: "Barres protéinées au chocolat blanc",
        highlight: "🍫 Un niveau TOP ! Croustillantes, au vrai chocolat blanc et énergisantes",
        desc: "Les barres protéinées japonaises de Lawson (marques Asahi 1本満足 ou Morinaga inBar) surpassent largement les barres occidentales. La version au chocolat blanc est irrésistible : gaufrettes croustillantes enrobées d'un chocolat blanc onctueux sans aucun arrière-goût chimique. 15g de protéines pour bien démarrer la journée.",
        tag: "Snack / Énergie & Protéines",
        tip: "Gardez-en toujours une ou deux dans le sac à dos lors des longues journées de marche.",
      },
      {
        name: "Mochi doux garni (Uchi Café)",
        highlight: "🍡 Texture élastique unique, le dessert parfait après le déjeuner ou le dîner",
        desc: "Pâtisserie traditionnelle japonaise confectionnée à base de riz gluant pilé (mochigome), à la texture souple et étirable caractéristique. La gamme Uchi Café propose des mochis individuels et des rouleaux fourrés à la crème d'Hokkaido, à la crème vanillée ou à la pâte de haricots rouges (anko). Le dessert idéal et léger pour clôturer un bon repas.",
        tag: "Dessert / Traditionnel sucré",
        tip: "Situé au rayon frais des desserts Uchi Café. À déguster bien frais au retour à l'hôtel.",
      },
      {
