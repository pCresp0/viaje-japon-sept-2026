export const days = [
  {
    "title": "Jour de voyage",
    "cities": "Madrid → Doha → Narita",
    "summary": "Départ matinal de Madrid sur un vol direct avec Qatar Airways. Long voyage transatlantique avec escale à Doha. Nous arriverons à Narita lundi après-midi, heure locale.",
  ...
  },
  {
    ...
    "schedule": [
      {
        "text": "**Conseils pratiques :**\n\n**Petit-déjeuner habituel :** environ 07h00–09h00.\n**Déjeuner :** environ 11h30–14h00.\n**Dîner :** environ 17h30–21h00.\n\nBeaucoup de petits restaurants ferment entre le déjeuner et le dîner.\n\nLes jours de départ très matinal, acheter le petit-déjeuner la veille dans un konbini. Pour les excursions aux horaires serrés, emporter un onigiri/sandwich de secours. Les konbini (7-Eleven, Lawson, FamilyMart) sont une option pratique et bon marché pour les onigiri, sandwichs, bento, fruits, yaourts, karaage et boissons. De plus, les konbini sont ouverts 24h/24 et 7j/7, donc on peut aller acheter le petit-déjeuner à n'importe quelle heure sans souci.\n\nUn repas simple de ramen/udon/donburi peut coûter environ **¥500–1 500 (~3–9€)**.\n\nPas besoin de réserver normalement pour les ramen, udon, donburi, fast-food japonais, izakaya informel ou stands de rue. Ne réserver que les restaurants spéciaux/populaires quand on veut vraiment y dîner.\n\nDans les marchés et les zones de street food, respecter les règles locales sur où manger. Au Japon, il n'est pas courant de manger en marchant dans les rues commerçantes ; au marché de Nishiki, c'est explicitement déconseillé."
      },
      {
        "text": "🛬 Atterrissage à Narita (NRT).\n\nIl faut passer l'immigration, récupérer les bagages enregistrés, la douane, puis sortir vers la zone publique de l'aéroport.\nPenser à avoir prêt le QR code de Visit Japan Web des 5 voyageurs pour accélérer les démarches.\n\n💡 Conseil : le temps réel pour sortir de l'aéroport peut beaucoup varier selon l'immigration, les bagages et la douane. C'est pourquoi nous n'avons pas acheté le Narita Express à l'avance."
      },
      {
        "text": "🚂 NARITA EXPRESS (N'EX) — ⏳ EN ATTENTE / À ACHETER À NARITA\n\n🎫 **SUICA :** ❌ NON pour payer (billet express nécessaire)\n📅 **RÉSERVATION :** 🔴 NÉCESSAIRE\n🛒 **ACHAT :** ACHETER SUR PLACE. Aux distributeurs ou aux guichets JR de l'aéroport de Narita lui-même. NE PAS acheter à l'avance.\n\nTrajet : Aéroport de Narita → Shinagawa\n(L'horaire d'environ 14h45 n'est qu'un objectif indicatif).\n\nAprès la douane, suivre les indications JR / Narita Express. Acheter le billet aux distributeurs JR ou à un guichet JR de l'aéroport.\n\n⚠️ **IMPORTANT :**\n- Ce n'est PAS le métro. C'est un train JR longue distance.\n- On le prend à la gare JR de l'aéroport.\n- Le billet n'est PAS encore acheté.\n- On ne veut pas fixer obligatoirement un train précis avant de voler, car le vol peut être retardé.\n- On l'achètera SUR PLACE À L'AÉROPORT DE NARITA une fois qu'on aura une estimation réaliste du temps.\n- Pour ce trajet, il faut un billet N'EX. Ne pas utiliser Smart EX.\n- Nous sommes 5 personnes : acheter les 5 billets ensemble et demander des sièges groupés si possible.\n\nNote : si le vol est retardé, on ne perd aucun billet N'EX puisqu'on ne l'a pas encore acheté. On achètera simplement le prochain N'EX qui nous permet d'arriver à temps à Shinagawa."
      },
      {
        "text": "🚄 **SHINKANSEN NOZOMI 53 (SHINAGAWA → KYOTO)**\n\nTrain à grande vitesse direct vers Kyoto Station (17h19 → 19h23 · 2h 04min). Billets achetés et sièges attribués sur Smart EX pour les 5 voyageurs. Déplier la carte ci-dessous pour consulter les sièges et les billets QR individuels."
      },
      {
        "text": "Nous voyageons avec de grandes valises enregistrées, mais pas particulièrement énormes. La réservation d'espace pour bagages hors gabarit n'est nécessaire que si une pièce dépasse 160 cm en additionnant hauteur + largeur + profondeur. (Exemple : 75 + 50 + 30 = 155 cm → pas hors gabarit). Pas besoin de réserver d'espace hors gabarit pour une valise normale de moins de 160 cm."
      },
      {
        "text": "🚅 Arrivée à Kyoto (JR Kyoto Station). On sort par la sortie Hachijo East Exit (八条東口). De là, il n'y a que 5 minutes à pied jusqu'à notre hôtel."
      },
      {
        "text": "🏨 **CHECK-IN : HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\n✅ Hôtel déjà payé (669,86€ via Booking).\n\nArrivée à l'hôtel, formalités de check-in pour les chambres du groupe, dépose des bagages, se rafraîchir et s'installer tranquillement après le vol international et les trains de la journée.\n\n♨️ L'hôtel a un grand onsen (bain public), séparé par sexe, ouvert de 15h00 à 01h00 et de 6h00 à 10h00 — parfait pour se détendre après le voyage."
      },
      {
        "text": "🍣 **DÎNER : KAITEN-SUSHI UOGASHI**\n\nRestaurant recommandé à **AEON MALL KYOTO** — Bâtiment Sakura, 4e étage (https://maps.app.goo.gl/ByDBQB6zaVZ3dj2E6). À environ 5–7 min à pied de l'hôtel et de la gare.\n\n**Kaiten-zushi** (sushi sur tapis roulant). Prix indicatif : **¥2 000–3 000/personne (~12–19€)**.\n\nHoraires : 11h00–22h00 (dernière commande vers 21h30). Pas besoin de réserver.\n\n**À essayer :** sushi variés ; morceaux de poisson frais ; nigiri ; plats spéciaux du jour ; un accompagnement chaud."
      },
      {
        "text": "🏨 **RETOUR À L'HÔTEL : HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\nRetour à l'hôtel après le dîner pour se reposer (1ère nuit à Kyoto à l'Hotel Keihan Kyoto Hachijoguchi)."
      },
      {
        "text": "🍙 **ACHAT DU PETIT-DÉJEUNER DANS UN KONBINI (PRÈS DE L'HÔTEL)**\n\nAvant de dormir, acheter dans un konbini proche (7-Eleven / Lawson / FamilyMart) le petit-déjeuner du Jour 2 (départ matinal pour Fushimi Inari). Ouvert 24h/24 : on peut y aller à 22h00 ou plus tard sans problème."
      }
    ],
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "**🚌 De JR Nara Station → Tōdai-ji :**\n🎫 **SUICA :** ✅ OUI, mais ⚠️ à Nara le bus ne fonctionne PAS comme à Kyoto — il y a deux types, il faut donc regarder lequel arrive :\n- Bus circulaire (jaune, « Loop Line ») : on monte par la porte AVANT et on passe la carte Suica EN MONTANT (tarif fixe, environ ¥250). On descend par la porte arrière.\n- Bus normal (vert, lignes numérotées 2/6/70/72/97/160) : on monte par la porte ARRIÈRE sans badger, et on paie en passant la Suica SEULEMENT EN DESCENDANT, par la porte avant (tarif selon la distance).\n\nEn arrivant à JR Nara, sortir par la East Exit et prendre le bus vers la zone « Tōdai-ji Daibutsuden / Kasuga Taisha-mae ». Pas besoin de fixer à l'avance un numéro de ligne précis, cela peut varier selon le service — vérifier le prochain bus pratique avec Google Maps sur place. Depuis l'arrêt, environ 5 minutes à pied jusqu'au Tōdai-ji.\n\n**Alternative :** marcher depuis JR Nara Station, mais cela prend plus de temps. Ne pas réserver à l'avance."
      },
      {
  ...
  },
  {
    ...
    "schedule": [
      {
        "text": "Réveil. 🍳 Petit-déjeuner à l'hôtel à 07:00. Kiyomizu-dera ouvre très tôt, il ne faut donc pas retarder le départ.\n\n⚠️ **RAPPEL IMPORTANT DU JOUR :** Dans la journée (en passant par Kyoto Station à midi ou en revenant d'Osaka), nous devons **récupérer les billets physiques** du train Thunderbird pour Kanazawa du lendemain aux distributeurs verts 5489 avec la carte Mastercard physique (terminée par 8625)."
      },
      {
      ...
      {
        "text": "🏯 KIYOMIZU-DERA. Ouvre à 06:00 et le 11 septembre ferme à 18:00. Visite : Bâtiment principal / scène de Kiyomizu, Otowa-no-taki, Pagode et environs, rues de Kiyomizu-zaka à la sortie. Aucune réservation requise. 💡 Conseil : Kiyomizu-dera à la première heure est un bon choix pour éviter la foule."
      },
      {
        "text": "🚶 HIGASHIYAMA → YASAKA → MARUYAMA → CHION-IN. Faites tout le trajet à pied : Kiyomizu-dera → Ninenzaka/Sannenzaka → Yasaka Jinja → Parc Maruyama → Chion-in.\n\n🗺️ Itinéraire complet sur Maps : https://maps.app.goo.gl/FTYMDo7piFPbU8X66?g_st=iw\n\n💡 Conseil : Cette zone s'apprécie mieux à pied et il ne faut pas essayer de suivre un itinéraire trop rigide dans les ruelles. N'essayez pas de tout faire à Higashiyama rapidement : l'attrait réside précisément dans les rues et petites boutiques entre les temples."
      },
      {
        "text": "⛩️ CHION-IN. Visitez l'enceinte et la Sanmon. Le domaine ouvre à 06:00 ; les visites/réceptions des zones intérieures commencent à 09:00. Si vous souhaitez visiter les jardins intérieurs, vérifiez l'ouverture et achetez l'entrée sur place. Aucune réservation."
      },
      {
        "text": "🚶 CHION-IN → HEIAN JINGU. Continuez à pied vers Heian Jingu."
      },
      {
      ...
      {
        "text": "🌃 DOTONBORI.\n\nLe quartier des néons et des enseignes géantes le long du canal, en plein cœur de Namba. Le canal fut creusé en 1615 et le quartier fut pendant des siècles le district des théâtres d'Osaka (kabuki et bunraku) ; c'est aujourd'hui la Mecque de la street food et de la balade nocturne, avec l'enseigne du coureur Glico comme icône la plus photographiée.\n\nBalade nocturne et street food. Priorité : Dotonbori, Glico, Ebisu Bridge, Hozenji Yokocho.\n\n💡 Conseils : pas besoin de réserver pour la street food à Dotonbori ; choisir les stands/restaurants sur place. Dotonbori est particulièrement intéressant après la tombée de la nuit, donc arriver vers 18h40 est un bon moment.\n\n🍜 À goûter ici : 1. Takoyaki 🐙 (Partager une portion. Option : Takoyaki Wanaka Dotonbori. Budget approx. : ¥500–1 000 (~3–6€)). 2. Okonomiyaki (Partager ou commander un par personne selon la faim. Option : CHIBO Dotonbori. Budget approx. : ¥2 000–3 000 par personne (~12–19€)). 3. Hozenji Yokocho (Bonne alternative pour sortir du tronçon le plus touristique de Dotonbori. Chercher un petit izakaya ou un restaurant local).\n⚠️ Ne pas entrer automatiquement dans le restaurant à la plus grande enseigne de Dotonbori. La zone principale est très touristique et certains établissements font payer plus cher l'emplacement. Entre environ 18h00 et 22h00, Dotonbori est très fréquenté. Rester groupés à 5 et avoir un point de rendez-vous clair."
      },
      {
        "text": "🏮 SHINSEKAI.\n\nS'il reste du temps et de l'énergie après Dotonbori : un quartier rétro construit en 1912, inspiré de Paris au nord et de Coney Island au sud, couronné par la tour Tsūtenkaku (qui imitait la tour Eiffel). Il contraste avec le Dotonbori plus soigné et touristique — ici l'ambiance est plus old-school, avec des enseignes délavées et une impression d'Osaka plus populaire.\n\n🍢 À goûter ici : le kushikatsu — des brochettes panées et frites, l'une des spécialités historiques du quartier. En essayer plusieurs sortes. Règle stricte : on ne peut pas tremper deux fois la même brochette dans la sauce commune, c'est affiché dans tous les restaurants.\n\n💴 Budget repas à Osaka (Dotonbori + Shinsekai réunis) : pour une soirée de food-crawl simple, prévoir environ ¥2 500–4 000 par personne (~15–25€) si on combine takoyaki + okonomiyaki/kushikatsu + une boisson, selon ce qu'on mange."
      },
      {
        "text": "🚆 OSAKA → KYOTO. Retour à Kyoto par JR. Aucune réservation. Utilisez la carte IC ou un billet simple."
      },
      {
        "text": "🏨 **RETOUR À L'HÔTEL : HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\nAprès le train depuis Osaka, retour à l'hôtel pour se reposer (5e et dernière nuit à Kyoto). Demain : envoi des bagages à Tokyo et Thunderbird vers Kanazawa.\n\n**Depuis Kyoto Station :** ~5 min à pied via la sortie Hachijo East Exit (八条東口)."
      },
      {
      ...
      {
        "text": "Ne mangez pas en marchant au marché de Nishiki. Aux stands de nourriture, mangez dans la zone indiquée par le vendeur. Dans les petits restaurants, vérifiez s'ils acceptent les cartes ; prévoyez du liquide. Ne laissez pas de pourboire. Dans beaucoup de restaurants, on paie à la caisse, pas forcément à table. Les nouilles peuvent être aspirées bruyamment ; ne vous en faites pas. Si un restaurant a une file énorme, cherchez une alternative une ou deux rues plus loin. Ne présumez pas qu''ouvert de 17:00 à 23:00' signifie que la cuisine prend des commandes jusqu'à 23:00 ; vérifiez toujours la dernière commande."
      }
    ],
    "money": "Env. 40 € (repas)"
  },
  {
    ...
    "schedule": [
      {
        "text": "🧳 Réveil et expédition des bagages. L'hôtel Keihan Kyoto Hachijoguchi dispose d'un service d'expédition de bagages. Envoyez la grande valise directement à l'hôtel de Tokyo et voyagez avec un sac à dos/petit bagage.\n⚠️ Confirmez à la réception le jour de l'envoi la date prévue de livraison à l'hôtel de Tokyo. Ne supposez pas qu'elle arrivera le lendemain. Préparez dans le sac à dos tout le nécessaire pour les jours intermédiaires jusqu'à ce que la valise soit récupérée. 🍳 Petit-déjeuner : Prenez le petit-déjeuner à l'hôtel Keihan Kyoto Hachijoguchi s'il est inclus, ou achetez quelque chose de simple la veille si nous devons partir très vite. (Remarque : L'hôtel Resol Trinity Kanazawa propose un petit-déjeuner buffet 07:00–10:00, mais comme nous arrivons à Kanazawa le jour même, cela ne s'applique pas à ce matin)."
      },
      {
        "text": "🚆 KYOTO → TSURUGA → KANAZAWA. Hôtel Keihan Kyoto Hachijoguchi → Kyoto Station : environ 5 minutes à pied jusqu'à Hachijo East Exit. Partez avec suffisamment de marge pour être sur le quai environ 10–15 minutes avant. 1. Limited Express THUNDERBIRD 5 : Kyoto Station (08:10) → Tsuruga Station (09:03).\n\n🎫 **SUICA:** ❌ NON\n📅 **RÉSERVATION:** ✅ DÉJÀ ACHETÉE et billets récupérés la veille.\n\nSièges confirmés : Voiture 5 (11-D, 12-C, 12-D, 13-C, 13-D).\n\n2. À Tsuruga (09:03 - 09:21) : Transfert (18 min) vers le Hokuriku Shinkansen. Suivez les panneaux de correspondance Thunderbird → Shinkansen. Ne sortez pas inutilement de la gare.\n\n3. Hokuriku Shinkansen KAGAYAKI 508 : Tsuruga (09:21) → Kanazawa (10:03).\n\n🎫 **SUICA:** ❌ NON\n📅 **RÉSERVATION:** ✅ DÉJÀ ACHETÉE\n\nSièges confirmés : Voiture 5 (11-E, 12-D, 12-E, 13-D, 13-E).\n\nArrivée à Kanazawa à 10:03.\n\n🧳 **À propos des bagages à l'arrivée :** les 5 grandes valises ne sont PAS avec vous — elles ont été envoyées directement de Kyoto à Tokyo ce matin même (arrivée estimée avant ou le 15/09). Malgré tout, avant de commencer la journée, on peut passer par le Hotel Resol Trinity Kanazawa pour déposer les sacs à dos et bagages à main légers à la réception — le check-in officiel est à 15h00, mais l'hôtel propose de garder les bagages gratuitement dès le matin. L'hôtel est à environ 12-15 min à pied de la sortie est de la gare (ou un arrêt de bus local jusqu'à Musashigatsuji/Omicho Ichiba, ~5 min + 1 min à pied), donc ce n'est pas un grand détour avant de se diriger vers Kenroku-en."
      },
      {
  ...
  {
    "title": "Shirakawa-go et Takayama",
    "cities": "Shirakawa-go, Takayama",
    "summary": "Bus matinal vers le village traditionnel isolé de Shirakawa-go. L'après-midi, direction la pittoresque Takayama pour flâner dans sa vieille ville et profiter d'un dîner haut de gamme.",
    ...
    "schedule": [
      {
        "time": "07:30",
        "text": "🍙 Réveil + petit-déjeuner rapide à emporter. L'Hotel Resol Trinity Kanazawa n'inclut PAS le petit-déjeuner dans notre réservation. Bien que l'hôtel propose le petit-déjeuner à partir de 07h00, il est plus pratique ce matin d'acheter la veille dans un konbini : onigiri, sandwich, fruits, café/boisson. Ne pas compter sur le petit-déjeuner de l'hôtel car il faut prendre le bus de 08h40. Prévoir aussi de l'eau à emporter."
      },
      {
        "time": "08:40",
        "text": "🚌 Nohi Bus Kanazawa → Shirakawa-go.\n\n📍 **OÙ MONTER :** Gare de Kanazawa, sortie OUEST (West Exit / Kanazawa-ko guchi), Terminal de bus n°4 -- confirmé directement sur le billet officiel 12GO/Nohi Bus (voir PDF ci-dessous), donc aucun doute possible.\n\n🎫 **SUICA :** ❌ NON\n📅 **RÉSERVATION :** ✅ DÉJÀ ACHETÉE\n🛒 **ACHAT :** Utiliser la réservation confirmée de 12GO / Hokutetsu.\n\nDépart : 08h40. Réservation : 12GO31991741. Booking ID M26125669. 5 places confirmées (1-2D, 3ABCD). Durée approximative : 1h25. Arrivée prévue : 10h05. Réservation obligatoire pour ce service. Ce n'est pas un train JR. N'utilise pas le Japan Rail Pass. Ne pas utiliser Suica : on utilise la réservation/le billet du bus. ⚠️ **INDISPENSABLE d'apporter le voucher IMPRIMÉ sur papier** -- le chauffeur doit garder le papier physique, le montrer sur le téléphone ou une capture d'écran n'est pas accepté. 💡 Conseil : arriver à l'arrêt avec de la marge. Retards possibles de 2h ou plus à cause du trafic, de la neige ou de fermetures d'autoroute en saison.\n\n🎧 **Podcast pour le trajet :** [Takayama et Shirakawa-go : le cœur des Alpes](https://podcasts.apple.com/es/podcast/jap%C3%B3n-a-fondo/id1545542012?i=1000527462410) (*Japón a fondo* · Japonismo). Pour écouter l'histoire des maisons gassho-zukuri, la vie isolée dans la neige et l'artisanat traditionnel de Takayama."
      },
      {
        "time": "10:05",
      ...
      {
        "time": "🎫 RÉSERVATIONS",
        "text": "DÉJÀ RÉSERVÉ : Kanazawa → Shirakawa-go (08h40, 5 places) et Shirakawa-go → Takayama (13h15, 5 places). On n'a PAS besoin de Japan Rail Pass, de trains, ni de Suica pour ces bus."
      },
      {
        "time": "🚍 RÉSUMÉ DES TRANSPORTS",
        "text": "Kanazawa → Shirakawa-go : Nohi Bus réservé, 08h40 → 10h05 (3 h 10 de visite à Shirakawa-go).\nShirakawa-go : Tout à pied.\nShirakawa-go → Takayama : Nohi Bus réservé, 13h15 → 14h05.\nTerminal de bus de Takayama → Hotel Wood : environ 12 min à pied.\nHôtel → Sanmachi : juste à côté.\nOn n'a pas besoin de Japan Rail Pass ni de trains aujourd'hui."
      },
      {
        "time": "🍽️ CONSEILS REPAS",
        "text": "⚠️ À Shirakawa-go, manger vers 12h00 à Tanaka-ya pour ne pas risquer de rater le bus de 13h15.\n⚠️ À Takayama les boutiques ferment vers 17h00, mais les restaurants pour le dîner ouvrent plus tard. Le dîner à 19h00 est jouable. 🥩 Takayama est idéal pour goûter le bœuf de Hida -- commander le hoba miso et les nigiri-sushi de bœuf de Hida."
      }
    ],
    "money": "Env. 40 € + dîner wagyu premium"
  },
  {
    "title": "Le sentier Nakasendo",
    "cities": "Takayama, Magome, Tsumago",
    "summary": "Nous voyagerons dans un magnifique train panoramique puis en bus jusqu'à Magome pour commencer un sentier de randonnée doux à travers une forêt millénaire. Nous marcherons jusqu'à Tsumago et reviendrons en bus à Magome, où nous passerons la nuit dans une auberge rurale.",
    ...
    "schedule": [
      {
        "time": "07:00",
        "text": "🍙 Réveil et petit-déjeuner rapide. L'Hotel Wood Takayama ne doit pas être notre source de petit-déjeuner ce matin, sauf s'il est inclus dans la réservation. Acheter le petit-déjeuner la veille : onigiri, sandwich, pain, fruits, café/boisson. Manger avant de partir ou l'emporter pour le bus. 💡 Conseil : partir avec tout prêt car nous avons un bus réservé à 08h00."
      },
      {
        "time": "07:20 environ",
        "text": "🚶 Quitter l'Hotel Wood Takayama vers le Takayama Nohi Bus Center (environ 10–15 minutes à pied). Objectif : arriver entre 07h30 et 07h35 pour échanger les billets tranquillement."
      },
      {
        "time": "07:35",
        "text": "⚠️ **ÉCHANGE OBLIGATOIRE DE L'E-TICKET :**\n\nAu Takayama Nohi Bus Center, présenter l'E-ticket Japan Bus Online (sur le téléphone ou imprimé) au comptoir pour **l'échanger contre les billets physiques**.\n\n⚠️ **IMPORTANT :** L'opérateur exige l'échange au moins 15 minutes avant le départ de 08h00 (arriver à 07h45 au plus tard). Garder les billets physiques pour les présenter en montant dans le bus."
      },
      {
        "time": "08:00",
        "text": "🚌 Bus Nohi direct : Takayama → Magome.\n\n🎫 **SUICA :** ❌ NON\n📅 **RÉSERVATION :** ✅ ACHETÉE ET CONFIRMÉE\n📄 **E-TICKET :** Réservation 08302008262 · Titulaire : Pablo C.\n\nDépart : Takayama Nohi Bus Center (08h00) → Arrivée : Magome (10h45).\nVoiture n°01 · 5 places : 2C, 2D, 3B, 3C, 3D.\nTotal : ¥25 000 (~135,61€) (5 adultes · ¥5 000/pers · ~27€).\n\n⚠️ **IMPORTANT :**\nNotre réservation se termine à **MAGOME à 10h45**. Bien que le bus continue jusqu'à Tsumago (11h10), nous descendons à Magome pour commencer la randonnée sur le sentier historique du Nakasendo.\n\n🎧 **Podcast indispensable du jour :** [Sentier Nakasendo : randonnée entre villages carte postale](https://podcasts.apple.com/es/podcast/jap%C3%B3n-a-fondo/id1545542012?i=1000655007075) (*Japón a fondo* · Japonismo). Idéal pour le trajet en bus, en plongeant dans l'histoire féodale des samouraïs et des villages-relais de la vallée du Kiso."
      },
      {
        "time": "10:45",
        "text": "📍 Arrivée à MAGOME. Fin du trajet en bus. L'arrêt est à seulement 2 minutes à pied de notre hébergement (Magome Chaya), directement sur la rue principale pavée.\n\n🧳 **PLAN : laisser les bagages directement à Magome Chaya.** On marche jusqu'au minshuku (2 min) et on demande à la réception de garder nos bagages avant le check-in officiel (15h00) -- c'est une pratique courante et attendue dans les hébergements japonais, même sans prévenir à l'avance. On évite ainsi toute la logistique et le coût incertain (¥500-1 000/sac) du service de transport de bagages Magome↔Tsumago, puisqu'on dort ici à Magome de toute façon ce soir.\n\n🗼 **EN CHEMIN, LE PLUS DISTINCTIF DE MAGOME :** en montant la rue principale vers le début du sentier, il y a une **roue à eau (suisha)** traditionnelle et un **belvédère** avec vue sur la vallée du Kiso -- juste un détour de 10-15 min, et c'est sur le chemin vers le début du sentier. Comme vous rentrerez tard et fatigués ce soir, c'est le meilleur moment pour le voir tranquillement en plein jour.\n\n💡 **Alternative de secours (bagages) :** si pour une raison quelconque Magome Chaya ne peut pas garder les bagages si tôt, les offices de tourisme de Magome et Tsumago proposent un véritable service de transport de bagages entre les deux (pas un casier) : dépôt à Magome de 08h30 à 11h30 et récupération à Tsumago à partir de 13h00, pour ¥500-1 000/sac selon la source (service actif du 20 mars au 30 novembre)."
      },
      {
        "time": "11:15",
        "text": "🥾 Sentier Nakasendo : Magome → Tsumago. Environ 8 km et 2h30-3h à un rythme tranquille. Le sens Magome → Tsumago a moins de montée : on monte le col de Magome-tōge (~300 m) puis on descend presque tout le reste. Infos pratiques : difficulté facile–modérée ; sentier bien balisé ; tronçons de forêt et d'asphalte ; prévoir de l'eau. Il y a des cloches anti-ours à plusieurs endroits, les utiliser en passant.\n\n📍 **Points de repère en chemin** (pas besoin de les chercher activement, ils apparaissent d'eux-mêmes en suivant les panneaux) :\n• **Tateba-chaya** : maison de thé traditionnelle où l'on offre du thé gratuit aux randonneurs -- bon endroit pour une première pause.\n• **Chutes Odaki et Medaki** (« mâle » et « femelle ») : un petit détour balisé, l'Odaki chute d'environ 18 m, la Medaki est plus petite et douce.\n• **Sanctuaire Kurashina** : juste à côté des chutes.\n• **Otsumago** : hameau avec des maisons traditionnelles de l'époque Edo, ~1 km avant d'arriver à Tsumago -- inclut la maison Fujihara, du milieu du XVIIe siècle.\n\nJuancar, on sait bien qu'en tant que fonctionnaire au Reina Sofía tu ne bouges pas beaucoup, mais aujourd'hui il faut marcher !"
      },
      {
        "time": "12:30–13:00",
        "text": "🍙 DÉJEUNER / SNACK PENDANT LA RANDONNÉE. Emporter de la nourriture depuis Takayama/Magome. Ne pas compter sur un restaurant pendant la randonnée. Acheter : onigiri, sandwich, fruits, boisson. Si on trouve une maison de thé ouverte (comme la Tateba-chaya), on peut s'arrêter, mais sans compter dessus."
      },
      {
        "time": "13:45 environ",
        "text": "🏘️ Arrivée à Tsumago (variable selon le rythme de la randonnée -- une référence réelle : un groupe parti à 11h11 est arrivé à 13h46, 8,15 km avec 223 m de dénivelé). Avec le bus de 14h22 pour le retour, il y a le temps pour une visite avec du contenu réel, quoique serrée -- Tsumago conserve plus de bâtiments ORIGINAUX que Magome (qui a brûlé deux fois et a été reconstruite) :\n\n• **Rue principale** : voitures interdites de 9h00 à 17h00, câbles enterrés, aucun élément moderne en vue.\n• **Temple Kōtoku-ji** : reconnaissable à ses murs blancs et sa base en pierre, de l'an 1500, domine le village depuis une petite butte.\n• **Waki-Honjin Okuya** : l'ancienne auberge secondaire, bâtiment original du XIXe siècle, Bien culturel important.\n• **Musée d'Histoire de Nagiso** (Nagiso Rekishi Shiryokan) : à côté du Waki-Honjin, si le temps le permet.\n\n💡 Avec le temps compté, privilégier la promenade sur la rue principale et voir le temple Kōtoku-ji de l'extérieur -- le Waki-Honjin et le musée restent optionnels s'il reste quelques minutes.\n\n🏠 **À propos des minshuku** : un petit hébergement familial japonais, géré par la famille propriétaire elle-même, avec dîner et petit-déjeuner faits maison presque toujours inclus -- l'équivalent d'un B&B rural. C'est le type d'hébergement que vous avez réservé ce soir à Magome Chaya."
      },
      {
        "time": "14:15–14:22",
        "text": "🚍 BUS TSUMAGO → MAGOME (Ontake Kotsu, ligne Nagiso-Tsumago-Magome). Départ Tsumago : 14h22. Arrivée Magome : 14h50. Durée : 28 min.\n\n🎫 **SUICA :** ❌ NON\n📅 **RÉSERVATION :** ❌ NON\n🛒 **ACHAT :** Paiement en espèces au chauffeur ou billet à l'office de Tsumago. Prix : ¥1 000/personne (~6€). Ne nécessite pas le JR Pass. Pas besoin de réserver.\n\n⚠️ Horaire vérifié avec deux sources indépendantes (japan-guide.com et Rome2Rio) : cette ligne a 4 départs quotidiens de Tsumago vers Magome, tous les jours de la semaine sans exception."
      },
      {
        "time": "14:50",
        "text": "📍 Retour à Magome. On a déjà les bagages avec nous.\n\n🍜 **MANGER À MAGOME.** Avec tout l'après-midi devant nous jusqu'au dîner de 18h00, bon moment pour manger quelque chose tranquillement dans le village même -- gohei-mochi et oyaki aux étals de la rue principale, ou l'un des petits restaurants locaux."
      },
      {
        "time": "15:30–18:00",
        "text": "🏨 Check-in à Magome Chaya (https://www.google.com/maps/search/?api=1&query=Magome+Chaya+Gifu) -- les bagages sont déjà là depuis le matin, douche et repos avant le dîner.\n\n🚶 **Comment aller à Magome Chaya :** le minshuku se trouve sur la rue principale du village (la pente pavée du Nakasendo), tout près de l'arrêt du bus local — à peine deux minutes à pied en montant. La rue historique est fermée à la circulation, donc tout le trajet final se fait à pied, sans besoin de taxi ni d'autre transport.\n\n⚠️ **PAIEMENT DE L'HÉBERGEMENT :** L'hôtel Magome Chaya n'est PAS prépayé. **Il faut payer sur place à l'hôtel en ESPÈCES (~178,98€ / ~¥32 000 groupe · ~35,80€/personne)**, il faut donc **retirer de l'argent liquide** au préalable (dans un 7-Eleven / konbini) si ce n'est pas déjà fait.\n\n♨️ Il y a un petit bain communautaire type onsen (séparé par sexe), sans horaire officiel fixe — mieux vaut demander au check-in ; c'est généralement plus calme vers 18h00–19h00, quand les autres dînent."
      },
      {
        "time": "18:00",
        "text": "🍱 **DÎNER TRADITIONNEL À MAGOME CHAYA**\n\nDîner traditionnel confirmé à l'hébergement (servi ponctuellement à 18h00). Prix : ¥3 630/personne (~23€).\n\nDeux options de menu principal au choix :\n\n• **Menu A :** Poisson de rivière grillé au sel et pot chaud (nabemono) de porc aux champignons.\n• **Menu B :** Tonkatsu (escalope de porc panée et frite).\n\nLes deux menus incluent tempura de légumes, sashimi, riz, accompagnements et dessert."
      },
      {
        "time": "~20:00",
        "text": "🏮 **SE PROMENER DANS MAGOME LA NUIT.**\n\nRues pavées éclairées par des lanternes traditionnelles, bien plus calmes qu'en journée. Les boutiques seront fermées, mais l'ambiance et l'architecture se savourent tout autant. Ne pas trop s'éloigner de l'auberge, le village ferme tôt.\n\n💧 Il n'y a ni konbini ni boutiques ouvertes à cette heure à Magome -- prévoir de l'eau déjà achetée si besoin, ne pas compter trouver quoi que ce soit pendant la promenade."
      },
      {
        "time": "🚍 RÉSUMÉ DES TRANSPORTS",
        "text": "🏨 Hotel Wood Takayama\n↓ 10–15 min à pied (07h20)\n↓ 🚌 Takayama Nohi Bus Center (07h35 échange billets)\n↓ 08h00–10h45 🚌 Bus Nohi direct (✅ Réservé)\n↓ 📍 Magome (descente 10h45)\n↓ dépôt bagages à Magome Chaya (2 min à pied)\n↓ 🥾 8 km / ~2h30-3h Sentier Nakasendo\n↓ 📍 Tsumago\n↓ 🚌 14h22–14h50 Bus (Ontake Kotsu)\n↓ 📍 Magome\n↓ 🍜 Manger à Magome\n↓ 🏨 Magome Chaya (check-in, bagages déjà là)\n↓ 🍱 Dîner 18h00\n↓ 🏮 Promenade nocturne dans Magome."
      },
      {
        "time": "💡 CONSEILS NAKASENDO",
        "text": "🥤 Prévoir assez d'eau et de la nourriture légère avant de commencer. 🍵 Il y a des maisons de thé mais avec des horaires variables. 🌙 Magome ferme tôt, le dîner à 18h00 est l'option sûre. 🥾 Chaussures confortables avec de bonnes semelles. 🌧️ Attention à la boue s'il pleut. 🐻 Utiliser les cloches anti-ours. 🎒 Marcher seulement avec un petit sac à dos en utilisant le service de bagages. 📸 Ne pas se presser, profiter du parcours."
      }
    ],
    "money": "Env. 40 € (repas)"
  },
  {
    "title": "Transit vers Tokyo",
    "cities": "Tokyo (Asakusa)",
    "summary": "Nous quitterons les Alpes pour voyager en train à grande vitesse vers Tokyo, où nous retrouverons nos gros bagages. Après-midi tranquille pour nous installer à l'hôtel d'Asakusa et nous reposer de cette journée de trains, avec un dîner simple à proximité.",
    "history": "Edo (l'ancienne Tokyo) est passée d'un village de pêcheurs au centre politique du Japon en 1603. Asakusa, où nous logeons, fut pendant des siècles le quartier des divertissements populaires de la ville, autour du temple Sensō-ji.",
    "schedule": [
      {
        "text": "🍙 07h00 — PETIT-DÉJEUNER\nMagome Chaya n'offre PAS de petit-déjeuner à partir de 2026.\n\n⚠️ **Il n'y a pas de konbini à Magome** (c'est un village délibérément préservé sans chaînes modernes, pas même de distributeurs automatiques visibles sur la rue principale) -- donc il n'y a nulle part où acheter quoi que ce soit ici tôt ce matin, ni hier soir une fois les boutiques locales fermées.\n\n✅ **NOUS PRENDRONS LE PETIT-DÉJEUNER À NAKATSUGAWA**, pendant la correspondance bus-train. Le bus de 08h15 arrive à Nakatsugawa vers 08h40, et le Shinano ne part qu'à 09h57 -- plus d'une heure dans une vraie ville, avec une gare, où il est fort probable de trouver un konbini (7-Eleven/Lawson/FamilyMart) près de la gare pour prendre un petit-déjeuner tranquille, après avoir récupéré les billets JR-WEST."
      },
      {
        "text": "🚌 08:15 — BUS LOCAL MAGOME → NAKATSUGAWA\n\n🎫 **SUICA :** ❌ NON (espèces uniquement)\n📅 **RÉSERVATION :** ❌ NON\n🛒 **ACHAT :** Prendre un ticket numéroté en montant par la porte arrière, payer en espèces au chauffeur en descendant.\n\nDépart : Magome — 08:15\nArrivée : Nakatsugawa Station — 08:40\nDurée : env. 25 min.\nType : bus local.\nRéservation : NE PEUT PAS être réservé.\nJapan Rail Pass : NON inclus.\nPaiement : acheter/payer localement selon les instructions de l'opérateur.\nPrix estimé : ¥800/personne (~5€).\n\n⚠️ **IMPORTANT :**\nLe 15 septembre 2026 est un mardi, les horaires de semaine s'appliquent.\nArrivez à l'arrêt quelques minutes en avance.\nCe bus est nécessaire pour relier Magome au réseau ferroviaire JR."
      },
      {
        "text": "🎫 **08:40 — RÉCUPÉRER LES BILLETS PHYSIQUES JR-WEST (CRITIQUE)**\n\nArrivée à Nakatsugawa (~08:40). Le Shinano 4 part à **09:57** → ~**77 min** de marge.\n\n🟢 Réservation **DÉJÀ PAYÉE** (nº **42093**). Ce n'est PAS un achat : c'est la **récupération des billets physiques**.\n\n⚠️ **OBLIGATOIRE avant de monter :** machine/guichet **HORS des portiques**, carte Mastercard physique **8625**, réservation **42093**, PIN = **PIN de la réservation**.\n\n💡 Si possible, récupérer plus tôt ; sinon **obligatoire à Nakatsugawa**."
      },
      {
        "text": "🚆 **SHINANO 4 — NAKATSUGAWA → NAGOYA**\n\n🟢 **RÉSERVÉ ET CONFIRMÉ** (JR-WEST)\n\nDépart **09:57** → Arrivée **10:53** (56 min).\nVoiture **4** · Places **11-D · 12-C · 12-D · 13-C · 13-D**.\n5 adultes · **¥14.350 (~77,84€)** · Réservation **#42093** · Receipt **AEE6606M**.\n\n🎫 Billets physiques encore à récupérer (voir 08:40)."
      },
      {
      ...
      {
        "text": "DÉJEUNER\nComme le petit-déjeuner sera tôt et le repas principal dans le Shinkansen, il n'est pas nécessaire de réserver quoi que ce soit pour le déjeuner.\n\nDÎNER\nLaisser le dîner pour un endroit simple près d'Asakusa.\nNe pas supposer que tous les restaurants restent ouverts très tard.\nPour un restaurant précis et à 5 personnes, réserver si l'on choisit un lieu populaire."
      },
      {
        "text": "1. 🚌 Magome → Nakatsugawa : 08:15 → 08:40. Sans réservation. ¥800 env. (~5€). Paiement sur place.\n2. 🚆 Nakatsugawa → Nagoya : Limited Express **Shinano 4**. 09:57 → 10:53.\n\n🟢 **DÉJÀ RÉSERVÉ** (JR-WEST n° 42093 · ¥14.350 (~77,84€) · Voiture 4). 🎫 Récupérer les billets physiques avant de monter.\n3. 🚅 Nagoya → Tokyo : **Nozomi 358**. 11:29 → 13:06.\n\n🟢 **DÉJÀ ACHETÉ** (Smart EX n° 2002 · ¥54.500 (~295,62€) · Voiture 12 · QR-Ticket).\n4. 🚇 Tokyo → Asakusa/Kappabashi : Métro/JR. Sans réservation. Suica."
      },
      {
        "text": "🟢 **FAIT**\n• Shinano 4 Nakatsugawa → Nagoya (09:57 → 10:53) · Réservation 42093 · Receipt AEE6606M · ¥14.350 (~77,84€).\n• Nozomi 358 Nagoya → Tokyo (11:29 → 13:06) · Smart EX **2002** · ¥54.500 (~295,62€) · Voiture 12 · sièges 11-D/11-E/12-C/12-D/12-E.\n\n🎫 **À RÉCUPÉRER (Shinano, ce n'est pas acheter) :** billets physiques JR-WEST avant de monter (Mastercard terminée par 8625 + PIN de la réservation).\n\n📱 **PRÉPARATION Nozomi :** sauvegarder le QR-Ticket / confirmer l'accès ; vérifier les dimensions des valises.\n\n🟢 NE PAS RÉSERVER bus Magome / transfert hôtel Tokyo / transports urbains."
      },
      {
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "Parc d'Ueno et marché de rue d'Ameyoko, parfait pour du thé et des douceurs pas chers. Bel espace vert pour se promener tranquillement après le réveil matinal.\n\n🦪 **GRIGNOTER À AMEYOKO** (recommandation d'une amie de Thibaut) : les étals du marché sont aussi très réputés pour les fruits de mer grillés -- huîtres et anguilles grillées, entre autres. Si vous n'avez pas encore goûté l'anguille (unagi), c'est une bonne occasion.\n\n🎮 **YAMASHIROYA** (recommandation d'une amie de Thibaut) : un magasin de 6 étages de figurines, jouets et produits dérivés d'anime/jeux vidéo, à seulement 1 minute à pied de la gare d'Ueno. Confirmé que les prix sont généralement moins chers qu'à Akihabara, et c'est nettement moins fréquenté."
      },
      {
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "time": "13:45–15:45",
        "text": "🎮 **Akihabara (2 heures).** Itinéraire à suivre, dans cet ordre :\n\n• **Gare d'Akihabara :** point de départ, sortie vers Electric Town.\n• **Radio Kaikan :** bâtiment historique de 10 étages juste à la sortie de la gare, avec des dizaines de boutiques de figurines, cartes et objets de collection empilées les unes sur les autres.\n• **Chuo-dori :** la rue principale d'Akihabara, avec ses grandes enseignes au néon (fermée à la circulation le dimanche après-midi ; aujourd'hui c'est samedi, donc ça pourrait ne pas s'appliquer).\n• **Animate :** la plus grande chaîne de boutiques manga/anime du Japon, avec des produits dérivés officiels de pratiquement toutes les séries.\n• **Super Potato :** un temple du jeu vidéo rétro, avec NES, SNES et Game Boy dans une ambiance tout droit sortie des années 90.\n• **Mandarake :** une grande chaîne d'occasion pour le manga, les figurines et les objets de collection de toutes les époques.\n• **Arcade Hey / Taito :** salles d'arcade japonaises classiques, pour des parties d'UFO catcher, de rythme ou de combat.\n• **Kanda Myojin :** un sanctuaire shinto vieux de plus de 1 000 ans, curieusement populaire chez les otaku pour bénir les produits technologiques et les personnages d'anime."
      },
      {
        "time": "15:45–16:15",
  ...
  {
    "title": "Palais Impérial, Gare de Tokyo et Ginza",
    "cities": "Otemachi, Marunouchi, Ginza, Hibiya",
    "summary": "⚠️ Changement de programme : l'excursion à Nikko n'a pas lieu à cause du mauvais temps (conservée dans 'À faire une prochaine fois' pour un futur voyage). À la place, une journée à pied dans le centre historique et commercial de Tokyo : les jardins du Palais Impérial, Tokyo Character Street, KITTE et le musée Intermediatheque, et un long après-midi à Ginza, se terminant par une promenade à Hibiya/Yurakucho. Presque tout se fait à pied -- un itinéraire très logique en ligne droite, sans déplacements absurdes.",
    "history": "Le Palais Impérial s'élève sur le site de l'ancien château d'Edo, siège du shogunat Tokugawa pendant plus de 250 ans et, à son apogée, la plus grande forteresse du monde. Ginza, de son côté, signifie littéralement 'la maison de l'argent' -- la ceca d'argent du shogunat s'y trouvait pendant la période Edo, avant de devenir le quartier commerçant le plus élégant de Tokyo après sa reconstruction en architecture occidentale à la fin du XIXe siècle.",
    "schedule": [
      {
        "time": "08:15",
        "text": "Réveil."
      ...
      {
        "time": "09:00",
        "text": "🚇 Départ de l'hôtel vers Otemachi en métro. Depuis Asakusa/Kappabashi, comptez environ 25-35 min porte à porte (marcher jusqu'à la gare, attendre et sortir)."
      },
      {
        "time": "~09:30–09:40",
        "text": "Arrivée à Otemachi."
      },
      {
        "time": "09:40–11:00",
        "text": "🏯 **PALAIS IMPÉRIAL (EAST GARDENS).** D'Otemachi à la porte Ote-mon, environ 5-10 min à pied. Les jardins occupent une partie de l'ancien domaine du château d'Edo -- douves, murs de pierre cyclopéens et vestiges de la base de l'ancien donjon (tenshu), le plus haut que le Japon ait jamais eu avant de brûler dans le grand incendie de Meireki (1657) et de ne jamais être reconstruit.\n\n🎫 Entrée gratuite, sans réservation. Fermé les lundis et vendredis -- aujourd'hui c'est dimanche, donc ouvert normalement."
      },
      {
        "time": "11:00–11:20",
        "text": "🚶 Promenade du Palais à la gare de Tokyo, en passant par Marunouchi. Environ 15-20 min à pied -- l'itinéraire touristique officiel de Tokyo relie précisément East Gardens, Marunouchi et KITTE comme une promenade naturelle, donc pas besoin de métro pour ce tronçon."
      },
      {
        "time": "11:20–12:30",
        "text": "🐉 **TOKYO CHARACTER STREET.** Au sous-sol de la gare de Tokyo (Tokyo Station Ichibangai B1). Tout un couloir de boutiques officielles Pokémon, Dragon Ball, Jump, One Piece, Sanrio et bien plus -- l'un des meilleurs arrêts merchandising de tout le voyage. Ouvert de 10h00 à 20h30."
      },
      {
        "time": "12:30–12:40",
        "text": "🚶 Gare de Tokyo → KITTE. À peine 1 minute à pied selon la signalisation officielle, mais en comptant le temps de s'orienter dans la gare, prévoyez 10 minutes réelles."
      },
      {
        "time": "12:40–13:25",
        "text": "🦴 **INTERMEDIATHEQUE.** Un musée à l'intérieur même du bâtiment KITTE, géré par l'Université de Tokyo -- collections scientifiques et historiques (squelettes, instruments anciens, taxidermie) dans une mise en scène très soignée, gratuite. Ouvert le dimanche de 11h00 à 18h00."
      },
      {
        "time": "13:25–14:25",
        "text": "🍛 Déjeuner : curry japonais ou ramen, à décider sur place dans le quartier -- pas besoin de faire un grand détour."
      },
      {
        "time": "14:25–14:50",
        "text": "🚶 KITTE → Ginza, en passant par Kyobashi. À pied, environ 1,5-2 km (20-25 minutes réelles) -- ce trajet fait partie de la promenade, ce n'est pas du temps perdu."
      },
      {
        "time": "14:50–18:00",
        "text": "🛍️ **GINZA (3h10).**\n\n• **14:50–15:20 · Ginza-dori / Chuo-dori :** la rue principale, piétonne le dimanche de 12h00 à 18h00 (sauf annulation pour cause de mauvais temps) -- simplement en profiter.\n• **15:20–15:50 · Itoya :** le grand magasin de papeterie le plus célèbre du Japon, 9 étages de tout type de matériel d'écriture et de design.\n• **15:50–16:30 · Ginza Six :** le plus grand centre commercial de luxe de Ginza, avec une installation artistique qui change dans l'atrium central. Ouvert jusqu'à 20h30.\n• **16:30–17:00 · Ginza Sony Park :** un espace urbain expérimental sur le site de l'ancien bâtiment Sony, avec des installations qui changent selon les saisons. Ouvert de 11h00 à 19h00.\n• **17:00–18:00 · Temps libre à Ginza :** délibérément sans programme -- pour ce qui se présente : une boutique de plus, une trouvaille geek, un café, une douceur, des photos."
      },
      {
        "time": "18:00–18:30",
        "text": "🚶 Ginza → Yurakucho/Hibiya à pied, environ 10-15 min selon l'endroit où l'on quitte Ginza."
      },
      {
        "time": "18:30–19:30",
        "text": "🌆 **HIBIYA/YURAKUCHO, TEMPS LIBRE.** Une heure entièrement libre : continuer à flâner, boire quelque chose, acheter une douceur, s'asseoir un moment, ou simplement décider tranquillement où dîner."
      },
      {
        "time": "19:30–21:00",
        "text": "🍜 Dîner d'adieu du groupe dans le quartier, lors de la dernière journée complète avant de rentrer en Espagne."
      },
      {
        "time": "~21:30",
        "text": "🏨 **RETOUR À L'HÔTEL : KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (https://maps.app.goo.gl/ccK7MTfGL6HJXFf76?g_st=ic)\n\nEn métro depuis Hibiya/Yurakucho. Dernière nuit à Tokyo avant de rentrer en Espagne."
      }
    ],
    "money": "Env. 40 € (repas) + shopping à Ginza selon l'envie"
  },
  {
    "title": "Retour à la maison",
    "cities": "Tokyo, Narita",
    "summary": "Dernières heures au Japon : achats de dernière minute dans les pharmacies locales ou promenade d'adieu près de l'hôtel. Train vers Narita avec beaucoup de temps pour s'enregistrer.",
    "history": "Après deux semaines intenses à parcourir l'histoire des shoguns, la philosophie zen et la technologie de l'archipel, le voyage s'achève. Narita est le principal port d'entrée et de sortie international de la région du Kanto depuis 1978.",
    "schedule": [
      {
        "text": "🏮 **UNE VRAIE VISITE D'ASAKUSA ET DU SENSŌ-JI** (pas comme un plan B d'un autre jour -- dernière matinée, avec du temps et les boutiques déjà ouvertes).\n\n• **Porte Kaminarimon** : la grande lanterne rouge, entrée emblématique de l'enceinte du temple.\n• **Rue Nakamise** : presque 200 mètres de petites boutiques traditionnelles -- douceurs, artisanat, souvenirs, éventails, yukata -- jusqu'à la porte du temple. Idéal pour les derniers achats (Kit-Kats aromatisés, matcha).\n• **Temple Sensō-ji** : le plus ancien temple bouddhiste de Tokyo (an 628), avec le grand brûle-encens et le hall principal.\n• Une promenade tranquille dans les ruelles traditionnelles alentour, avant de retourner à l'hôtel.\n\n🍽️ **KAPPABASHI DORI** (recommandation d'une amie de Thibaut) : la rue entièrement dédiée à l'univers de la cuisine, littéralement à côté de votre hôtel (dans le même quartier, Nishi-Asakusa). L'endroit où ramener de la céramique japonaise authentique, et aussi les fameuses répliques de plats en plastique (sampuru) -- une curiosité très typique du Japon, même si ce n'est pas du goût de tout le monde. On peut l'ajouter sans transport, en prolongeant la même promenade de ce matin.\n\n💡 Comme l'hôtel n'est qu'à 10 minutes à pied, aucun transport n'est nécessaire pour cela -- on peut retourner chercher les bagages tranquillement avant le transfert vers l'aéroport."
      },
      {
      ...
      {
        "text": "Vol QR809 Narita → Doha (Qatar Airways, 10h 55m · 17:25 → 22:20). Suivi : https://www.google.com/search?q=vol+QR809. Escale à Doha de 2h 50m (22:20 → 01:10), puis vol QR147 Doha → Madrid (Qatar Airways / Iberia, 7h 25m · 01:10 → 07:35). Suivi : https://www.google.com/search?q=vol+QR147. Arrivée à Madrid (T4S) le Mar 22 sept à 07:35."
      }
    ],
    "money": "Env. 40 € (repas)"
  }
