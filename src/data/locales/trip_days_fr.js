export const days = [
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "🌃 DOTONBORI + SHINSEKAI. Promenade nocturne et nourriture de rue. Priorité : Dotonbori, Glico, Pont d'Ebisu, Hozenji Yokocho. S'il reste du temps et de l'énergie, continuez vers Shinsekai. 💡 Conseils : À Dotonbori, nul besoin de réserver pour la cuisine de rue ; choisissez les stands/restaurants sur place. Dotonbori est particulièrement intéressant après la tombée de la nuit, il est donc conseillé de maintenir l'arrivée vers 18:30. 🍜 Osaka Food Crawl — que goûter : 1. Takoyaki 🐙 (Partagez une portion. Option : Takoyaki Wanaka Dotonbori. Budget approx : 500–1 000 ¥). 2. Okonomiyaki (Partagez ou commandez-en un par personne. Option : CHIBO Dotonbori. Budget approx : 2 000–3 000 ¥/personne (~12–19€)). 3. Kushikatsu (Si nous arrivons à Shinsekai. Goûtez plusieurs brochettes. Spécialité historique). 4. Hozenji Yokocho (Bonne alternative pour sortir du tronçon le plus touristique).\n⚠️ N'entrez pas automatiquement dans le restaurant avec la plus grande enseigne de Dotonbori. La zone principale est très touristique et certains endroits font payer plus cher l'emplacement. Entre env. 18:00 et 22:00, Dotonbori est très bondé. Gardez le groupe de 5 ensemble et ayez un point de rencontre clair. 💴 Budget gastronomique Osaka : Pour une soirée food crawl simple à Dotonbori/Shinsekai, comptez env. 2 500–4 000 ¥ par personne si on combine takoyaki + okonomiyaki/kushikatsu + boisson, bien que cela dépende de combien on mange."
      },
      {
