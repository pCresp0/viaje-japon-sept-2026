export const days = [
  ...
  },
  {
    ...
    "schedule": [
      ...
      {
        "text": "📍 Arrivée à Magome à 10:45. Fin du trajet en bus. Début du sentier Nakasendo à pied vers Tsumago (8 km). Avant la randonnée, laissez les bagages au service de transfert."
      },
      {
        "text": "🧳 ENVOYER LES BAGAGES À TSUMAGO -- ⚠️ Ce n'est PAS un casier où l'on récupère au même endroit : c'est un véritable service de transport entre les deux offices de tourisme (Magome et Tsumago). Vous déposez vos sacs à l'office de Magome, le service les transporte lui-même en camionnette pendant la journée, et vous les récupérez à l'office de Tsumago l'après-midi -- vous ne les portez jamais pendant la randonnée.\n\nHoraires de dépôt à Magome : 08h30–11h30. Récupération à Tsumago : à partir de 13h00 (généralement jusqu'à 17h00). Service saisonnier, actif du 20 mars au 30 novembre, donc il fonctionne normalement en septembre.\n\n💰 **Prix : non confirmé avec certitude.** Les sources divergent entre ¥500 et ¥1 000 par sac -- confirmer le prix exact en le déposant au comptoir de Magome, et prévoir assez d'espèces pour l'un ou l'autre montant.\n\n⚠️ **IMPORTANT :**\nNous arrivons à 10h45, il y a le temps de le déposer avant 11h30. Pendant la randonnée, ne porter qu'un petit sac à dos avec de l'eau, les papiers, le téléphone, la batterie et de l'argent. NE PAS emporter de grandes valises sur le sentier (il comporte des pierres et un terrain irrégulier)."
      },
      {
      ...
      {
        "text": "Promenade tranquille dans Magome-juku (15h00–17h30), ses maisons traditionnelles et rues historiques. Ce créneau sert à : check-in, déposer les bagages, se reposer, se doucher et profiter du village.\n\n🚶 **Comment se rendre à Magome Chaya :** le minshuku se trouve sur la rue principale même du village (la pente pavée du Nakasendo), tout près de l'arrêt du bus local — à peine deux minutes à pied en montant. La rue historique est fermée à la circulation, donc tout le trajet final se fait à pied, sans besoin de taxi ni d'aucun autre transport.\n\n⚠️ **PAIEMENT DE L'HÉBERGEMENT :** l'hôtel Magome Chaya n'est PAS payé à l'avance. **Il faut payer sur place, en ESPÈCES (environ ¥32 000 pour le groupe / ~178,98 € · ~35,80 €/personne)**, donc il faut **retirer de l'argent liquide** au préalable (à un distributeur 7-Eleven / konbini).\n\n⚠️ **IMPORTANT :**\nBeaucoup de boutiques et restaurants ferment tôt. Ne pas laisser les achats ou la nourriture pour le dernier moment."
      },
      {
