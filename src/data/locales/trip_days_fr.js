export const days = [
  ...
  },
  {
    ...
    "schedule": [
      {
        "text": "🧳 **DERNIERS ACHATS, VALISES ET CHECK-OUT.** Dernière matinée tranquille avant le transfert vers l'aéroport :\n\n• Derniers achats de dernière minute dans le quartier de l'hôtel (pharmacies, Kappabashi-dori pour des ustensiles de cuisine ou les répliques de plats en plastique, ou tout ce qu'il reste à faire).\n• Préparer et fermer les valises tranquillement.\n• Check-out à la réception du KOKO HOTEL Residence Asakusa Kappabashi.\n\n💡 Tout étant à portée de main dans le quartier, aucun transport n'est nécessaire pour cela -- largement le temps avant de partir vers Narita."
      },
      {
