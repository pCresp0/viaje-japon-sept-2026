export const days = [
  ...
  {
    "title": "Transit vers Tokyo et Akihabara",
    "cities": "Akihabara (Tokyo)",
    "summary": "Nous quitterons les Alpes pour voyager en train à grande vitesse vers Tokyo, où nous retrouverons nos gros bagages. Après-midi immersif à Akihabara, paradis de la technologie, de l'anime et de la culture otaku.",
    "history": "Edo (l'ancienne Tokyo) est passée d'un village de pêcheurs au centre politique du Japon en 1603. Après la Seconde Guerre mondiale, Akihabara a réémergé comme marché de composants radio, évoluant pour être l'épicentre de la culture pop japonaise.",
    "schedule": [
      {
      ...
      {
        "text": "Court repos pour s'installer : défaire un peu les bagages et se doucher après toute une journée de trains (bus + Shinano + Shinkansen depuis tôt le matin). Ne pas dépasser une heure -- il reste de l'après-midi devant nous."
      },
      {
        "text": "🌉 **PROMENADE JUSQU'AU TOKYO SKYTREE, LE LONG DE LA RIVIÈRE SUMIDA.** Un itinéraire à pied très simple et agréable (~15-20 min) depuis l'hôtel : en traversant l'emblématique pont rouge Azumabashi près du bâtiment de la brasserie Asahi (avec sa curieuse sculpture dorée, surnommée \"la crotte d'or\" par les Tokyoïtes eux-mêmes), puis en suivant la promenade de la rivière Sumida jusqu'au pied de la tour.\n\n🗼 Le Skytree (634 m) est la tour la plus haute du Japon. Pas besoin de monter aujourd'hui -- il suffit de la voir de près et de flâner dans **Tokyo Solamachi**, le centre commercial à sa base (300 boutiques, bons endroits pour grignoter ou prendre un café). Si le groupe en a envie et l'énergie après une journée de trains, on peut envisager de monter au belvédère (avec une file d'attente probable), mais pas besoin de le forcer aujourd'hui.\n\n💡 Retour à l'hôtel par le même chemin le long de la rivière, avec largement le temps avant le dîner de 19h30."
      },
      {
        "text": "🍜 **DÎNER : ASAKUSA MONJA MONRO** (recommandation de l'amie petit-fromage de Thibaut). Monjayaki et teppanyaki cuisinés devant vous par le personnel -- spécialité maison avec des fruits de mer des marchés de Tsukiji/Toyosu. Très bien noté (top 5 des avis à Asakusa). Il peut y avoir un peu d'attente, mais ça vaut le coup. À quelques minutes de l'hôtel."
      },
      {
