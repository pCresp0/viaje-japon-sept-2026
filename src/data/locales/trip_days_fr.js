export const days = [
  ...
  },
  {
    ...
    "summary": "Nous voyagerons dans un magnifique train panoramique puis en bus jusqu'à Magome pour commencer un sentier de randonnée doux à travers une forêt millénaire. Nous marcherons jusqu'à Tsumago, où nous passerons la nuit dans une auberge rurale.",
    ...
    "schedule": [
      ...
      {
        "text": "🚶 Quittez l'hôtel Wood Takayama pour le Takayama Nohi Bus Center (env. 10–15 min à pied). Objectif : arriver entre 07:30 et 07:35 pour échanger les billets physiques sereinement."
      },
      {
        "text": "⚠️ **ÉCHANGE OBLIGATOIRE DU BILLET ÉLECTRONIQUE :**\nAu Takayama Nohi Bus Center, présentez l'E-ticket de Japan Bus Online (sur mobile ou imprimé) au guichet pour **l'échanger contre les billets physiques**.\n\n⚠️ **IMPORTANT :** L'opérateur exige d'effectuer l'échange au moins 15 minutes avant le départ de 08:00 (arriver au plus tard à 07:45). Conservez les billets physiques pour monter à bord."
      },
      {
        "text": "🚌 Bus direct Nohi Bus : Takayama → Magome.\n\n🎫 **SUICA:** ❌ NON\n📅 **RÉSERVATION:** ✅ ACHETÉE ET CONFIRMÉE\n📄 **E-TICKET :** Réservation 08302008262 · Titulaire : Pablo Crespo Bellido\n\nDépart : Takayama Nohi Bus Center (08:00) → Arrivée : Magome (10:45).\nCar No. 01 · 5 Sièges : 2C, 2D, 3B, 3C, 3D.\nTotal : 25 000 ¥ (5 adultes · 5 000 ¥/pers).\n\n⚠️ **IMPORTANT :**\nNotre réservation se termine à **MAGOME à 10:45**. Même si le bus continue vers Tsumago (11:10), nous descendons à Magome pour commencer la randonnée du sentier historique de Nakasendo."
      },
      {
        "text": "📍 Arrivée à Magome à 10h45. Fin du trajet en bus. L'arrêt est à seulement 2 minutes à pied de notre hébergement (Magome Chaya), directement sur la rue principale pavée.\n\n🧳 **PLAN : laisser les bagages directement à Magome Chaya.** On marche jusqu'au minshuku (2 min) et on demande à la réception de garder nos bagages avant le check-in officiel (15h00) -- c'est une pratique courante et attendue dans les hébergements japonais, même sans prévenir à l'avance. On évite ainsi toute la logistique et le coût incertain (¥500-1 000/sac) du service de transport de bagages Magome↔Tsumago, puisqu'on dort ici à Magome de toute façon ce soir.\n\n💡 **Alternative de secours :** si pour une raison quelconque Magome Chaya ne peut pas garder les bagages si tôt, les offices de tourisme de Magome et Tsumago proposent un véritable service de transport de bagages entre les deux (pas un casier) : dépôt à Magome de 08h30 à 11h30 et récupération à Tsumago à partir de 13h00, pour ¥500-1 000/sac selon la source (service actif du 20 mars au 30 novembre)."
      },
      {
        "text": "🥾 Sentier Nakasendo : Magome → Tsumago. Env. 8 km et 3h à un rythme tranquille. Le sens Magome → Tsumago a moins de montées. Infos pratiques : difficulté facile–modérée ; bien balisé ; forêt et asphalte ; apportez de l'eau. Il y a des cloches à ours, sonnez-les en passant. Juancar, on sait qu'en tant que fonctionnaire au Reina Sofía tu ne bouges pas beaucoup, mais aujourd'hui on marche !"
      },
      {
      ...
      {
        "text": "🏘️ Arrivée à Tsumago vers 14h15. Courte promenade dans le village -- aucune gestion de bagages ici, puisqu'ils sont restés à Magome Chaya."
      },
      {
        "text": "🚍 BUS TSUMAGO → MAGOME (Magome Line, local). Départ Tsumago : 14h22. Arrivée Magome : 14h50. Durée : 28 min.\n\n🎫 **SUICA :** ❌ NON\n📅 **RÉSERVATION :** ❌ NON\n🛒 **ACHAT :** Paiement en espèces au chauffeur ou billet à l'office de Tsumago. Prix : ¥1 000/personne (~6€). Ne nécessite pas le JR Pass. Pas besoin de réserver.\n\n⚠️ **IMPORTANT :** Ce bus est indispensable pour rentrer dormir à Magome."
      },
      {
        "text": "📍 Retour à Magome à 14:50. Nous avons nos bagages."
      },
      {
        "text": "Promenade tranquille dans Magome-juku, ses maisons traditionnelles et ses rues historiques. Ce créneau sert pour : le check-in officiel (les bagages sont déjà là depuis le matin), se reposer, se doucher et profiter du village.\n\n🚶 **Comment aller à Magome Chaya :** le minshuku se trouve sur la rue principale du village (la pente pavée du Nakasendo), tout près de l'arrêt du bus local — à peine deux minutes à pied en montant. La rue historique est fermée à la circulation, donc tout le trajet final se fait à pied, sans besoin de taxi ni d'autre transport.\n\n⚠️ **PAIEMENT DE L'HÉBERGEMENT :** L'hôtel Magome Chaya n'est PAS prépayé. **Il faut payer sur place à l'hôtel en ESPÈCES (~178,98€ / ~¥32 000 groupe · ~35,80€/personne)**, il faut donc **retirer de l'argent liquide** au préalable (dans un 7-Eleven / konbini).\n\n⚠️ **IMPORTANT :**\nBeaucoup de boutiques et restaurants ferment tôt. Ne pas laisser les achats ou le repas pour la dernière minute."
      },
      {
        "text": "🍱 **DÎNER TRADITIONNEL À MAGOME CHAYA**\n\nDîner traditionnel confirmé à l'auberge (servi ponctuellement à 18:00). Prix : 3 630 ¥/personne (~23€).\n\nDeux options de menu principal au choix :\n\n• **Menu A :** Poisson de rivière grillé au sel et marmite chaude (nabemono) de porc et champignons.\n• **Menu B :** Tonkatsu (escalope de porc panée et croustillante).\n\nLes deux menus incluent tempura de légumes, sashimi, riz, accompagnements et dessert."
      },
      {
