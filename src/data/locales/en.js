...
export default {
  ...
  pendingItems: [
    ...
    { title: "Book Shinkansen seats", detail: "Two key bullet trains: Day 1 Tokyo to Kyoto and Day 9 Nagoya to Tokyo. Since we don't have JR Pass, book online (SmartEX or Klook) and reserve oversized baggage seats if needed.", deadline: "Weeks in advance" },
    { title: "Book Narita Express (N'EX)", detail: "Trains from the airport to downtown (Day 1) and back (Day 15). Since we don't have JR Pass, it's best to book in advance online or at the airport.", deadline: "Weeks in advance or on arrival" },
