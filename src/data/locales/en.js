...
export default {
  ...
  pendingItems: [
    { title: "Book Shinkansen Nozomi Day 1 (Shinagawa → Kyoto)", detail: "Day 1 (Sept 7): Buy in advance from abroad weeks earlier on the SmartEX app/web (https://smart-ex.jp/reservation/reserve_smart/sp/) from Shinagawa to Kyoto (~€90). As a group of 5 with large suitcases, you MUST select 'Seat with an oversized baggage area' and pick E seats (right window) to see Mt. Fuji ~40 min after departure.", deadline: "Weeks before trip" },
    { title: "Buy Narita Express - N'EX (Narita Airport → Shinagawa)", detail: "Day 1 (Sept 7): Do NOT buy in advance. Depending on flight arrival (12:55) and customs queues, buy directly on arrival at Narita B1 floor at the RED JR ticket counters/machines for the next available train to Shinagawa (~€19, departures every 30 min, 1h 10m direct).", deadline: "Upon landing at Narita (Floor B1)" },
    { title: "Book Shinkansen Nozomi Day 9 (Nagoya → Tokyo)", detail: "Day 9 (Sept 15): Nozomi bullet train from Nagoya to Tokyo (~€50, 1h 40m). Buy in advance on SmartEX reserving seats with Oversized Baggage for large luggage.", deadline: "Weeks before trip" },
    { title: "Book Hida Express panoramic train (Takayama → Nagoya)", detail: "Day 8 (Sept 14): panoramic train from Takayama to Nagoya. Very popular in September, reserved seats sell out. Since we don't have JR Pass, tickets must be bought in advance.", deadline: "Weeks in advance" },
    { title: "Book Thunderbird train (Kyoto → Kanazawa)", detail: "Day 6 (Sept 12): Thunderbird train from Kyoto to Kanazawa. September is peak season in Kanazawa. Since we don't have JR Pass, tickets must be bought in advance.", deadline: "Weeks in advance" },
    { title: "Book JR Shinano train", detail: "Days 8 and 9: JR Shinano Limited Express between Nagoya and Nakatsugawa. Recommended to book in advance since we don't have JR Pass.", deadline: "Weeks in advance" },
    ...
    { title: "Book backpack forwarding Magome ↔ Tsumago", detail: "Luggage transport service between both ends of the Nakasendo trail to walk light. Usually booked at the tourist office same day.", deadline: "Confirm schedules before" },
    { title: "Confirm dinner at Magome Chaya", detail: "Reply to Jeng's email confirming dinner for 5 at 18:00 h and notify if anyone in the group has food allergies.", deadline: "Before traveling" },
    { title: "Buy online tickets (TeamLab & Shibuya Sky)", detail: "Buy online tickets for teamLab museum and Shibuya Sky observatory (sunset slot) now, as they sell out fast.", deadline: "As soon as possible" },
    { title: "Internet and local transport", detail: "Buy data eSIMs (Airalo, Ubigi, etc.) and add digital Suica card directly to Apple Wallet to top it up.", deadline: "Before traveling" },
    { title: "Breakfast for Nakasendo route", detail: "Buy some breakfast at a konbini in Takayama or Nakatsugawa on day 14, since the rural inn does not serve morning food.", deadline: "Day 14 in Japan" }
  ],
  categoryLabels: {
