...
export const konbiniChains = [
  ...
  },
  {
    ...
    badge: "Nuestro konbini favorito para desayunar · Repostería 'Uchi Café' y Karaage-kun",
    themeColor: "#0068b7", // Cobalt Blue
    accentColor: "#e60012", // Red
    bgLight: "rgba(0, 104, 183, 0.06)",
    borderColor: "rgba(0, 104, 183, 0.25)",
    vibe: "¡El mejor konbini y el que más nos gustó para comprar el desayuno! Su logotipo de botella de leche delata su origen lácteo. Es indiscutiblemente el rey matutino: bollería recién horneada, café excelente, postres de nata fresca Uchi Café y bocaditos de pollo.",
    specialty: "Desayunos top, café Machi Café (azul y rojo), Melon Pan, bollería al vapor, mochi, barritas y Karaage-kun.",
    bestFor: "Comprar el desayuno cada mañana (cafés, melon pan, egg steamed cake) y postres para rematar tras comer o cenar.",
    mapQuery: "Lawson",
    items: [
      {
        ...
        tag: "Bebida / Desayuno",
        tip: "Pídelo en caja indicando tamaño y color («Aisu kōhī M / L, mutō [azul] o katō [rojo]») o compra el vaso con hielo y prepáralo en la máquina.",
      },
      {
        ...
        tip: "Si tienes opción de calentarlo unos segundos, la costra de galleta azucarada cruje aún más y el interior se vuelve mantecoso.",
      },
      {
        ...
        tip: "En la sección de panadería envasada, paquete transparente con etiqueta amarilla.",
      },
      {
        ...
        tip: "Lleva siempre una o dos en la mochila para reponer fuerzas durante las caminatas de 20.000 pasos.",
      },
      {
        ...
        tag: "Postre / Dulce",
        tip: "Se encuentran en las baldas refrigeradas de Uchi Café. Servidos bien fríos están insuperables.",
      },
      {
