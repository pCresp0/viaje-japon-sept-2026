...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:00", text: "⛩️ **TEMPLOS Y PASEO POR HARAJUKU.** Calle Takeshita (moda juvenil, crepes, tiendas de kawaii), terminando en el santuario Meiji, dentro del bosque del parque Yoyogi -- un cambio de ritmo total respecto al bullicio de la calle." },
      { time: "14:15–15:30", text: "🍜 Comida por la zona de Harajuku." },
