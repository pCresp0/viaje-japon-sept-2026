...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "~10:30", text: "Parque de Ueno y mercadillo de Ameyoko, ideal para compras baratas de té y dulces. Buena zona verde para pasear con calma tras el madrugón.\n\n🦪 **PICOTEO EN AMEYOKO** (recomendación de amiga de Thibaut): los puestos del mercado son también muy conocidos por el marisco a la brasa -- ostras y anguila asadas, entre otras cosas. Si no habéis probado la anguila (unagi), es una buena ocasión.\n\n🎮 **YAMASHIROYA** (recomendación de amiga de Thibaut): tienda de 6 plantas de figuras, juguetes y merchandising de anime/videojuegos, a solo 1 minuto andando de la Estación de Ueno. Confirmado que los precios suelen ser más baratos que en Akihabara, y está bastante menos masificada." },
