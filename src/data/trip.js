...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "10:05", text: "Llegada a Shirakawa-go a las 10:05. Disponemos de aproximadamente 3 h 10 min en Shirakawa-go (desde las 10:05 hasta la salida del bus a Takayama a las 13:15).\n\n🗺️ Ruta completa de Shirakawa-go: https://maps.app.goo.gl/mBcF6hHWpwwC5HxeA?g_st=iw\n\n🔒 **TAQUILLAS PARA LAS MOCHILAS:** La propia Terminal de Shirakawa-go tiene taquillas de monedas (18 en total) justo detrás/al lado del edificio principal — pequeñas/medianas ¥500, grandes ¥1.000, horario 08:00–17:00 (encaja perfectamente con nuestra ventana de hoy). No se puede dejar de un día para otro, pero para las pocas horas de hoy no hay problema. Si están todas ocupadas, se puede pedir en el mostrador de información/venta de billetes que guarden el equipaje manualmente (edificio anexo, a pocos metros). Llevar monedas de ¥100 o cambiar billetes grandes en el propio mostrador." },
      { time: "10:05–10:15", text: "🌉 Cruzar el **Puente Deai**, el puente colgante que da entrada al pueblo sobre el río Shogawa -- la primera vista icónica del día." },
      { time: "10:15–10:50", text: "⛰️ **MIRADOR SHIROYAMA** (imprescindible). Subida andando por carretera asfaltada, cuesta suave, 15-20 min desde el centro del pueblo. Alternativa: shuttle bus ¥200-300 (sale cada 20 min desde cerca de Wada House, con parada al mediodía). \n\n💡 Por qué subir ahora y no más tarde: hacia las 11:30 el pueblo se llena bastante (la cola del shuttle puede tener 30 personas) -- yendo nada más llegar lo tendréis casi para vosotros solos." },
      { time: "10:50–11:35", text: "🚶 Bajar del mirador (15-20 min) y paseo por **Ogimachi**: canales, arrozales, calles tradicionales, vistas de las montañas. Es la esencia del pueblo -- no hace falta prisa aquí." },
      { time: "11:35–11:55", text: "🏠 **WADA HOUSE** (única casa a visitar). La casa gassho-zukuri más grande y mejor conservada del pueblo, abierta 09:00–17:00, ¥400 (~2,5€), sin reserva, pago en efectivo, a 3-4 min de la terminal. No hace falta entrar en más casas (Kanda House / Nagase House son redundantes)." },
      { time: "12:00–12:45", text: "🍜 **COMIDA EN TANAKA-YA** (recomendado por el grupo). Restaurante con mesas bajas, sentados en el suelo -- comida riquísima.\n\n🗺️ Tanaka-ya en Google Maps: https://maps.app.goo.gl/GYV8d8g1gaTi3Emb7?g_st=ic\n\n💡 No alargar demasiado la comida: el bus a Takayama sale a las 13:15 y hay que volver a la terminal con margen." },
      { time: "12:45–13:05", text: "🚶 Última vuelta por el pueblo y regreso caminando a Shirakawa-go Bus Terminal (15 min). No alejarse de la zona central a partir de aquí." },
      { time: "13:05–13:15", text: "⏳ Margen en la terminal antes de la salida del bus. Recoger la mochila de la taquilla si se dejó allí." },
      { time: "13:15", text: "🚌 Nohi Bus Shirakawa-go → Takayama.\n\n📍 **DÓNDE SUBIR:** Shirakawa-go Bus Terminal (Ogimachi) — el mismo sitio donde os dejó el bus al llegar a las 10:05, no hay más de una terminal en el pueblo, así que no hay pérdida.\n\n🎫 **SUICA:** ❌ NO\n📅 **RESERVA:** ✅ YA COMPRADA (asientos NO reservados individualmente, es billete de plaza garantizada sin número de asiento)\n🛒 **COMPRA:** Utilizar la reserva confirmada de 12GO / Nohi Bus.\n\nSalida: 13:15. Reserva: 12GO31992254. Booking ID M26125670. 5 plazas confirmadas. Duración aproximada: 50 min. Llegada prevista a Takayama Nohi Bus Center: 14:05. Reserva obligatoria. No es JR. No requiere Japan Rail Pass. No utilizar Suica: utilizar la reserva/billete del autobús. ⚠️ **IMPRESCINDIBLE llevar el voucher IMPRESO en papel** -- el conductor debe quedarse con el papel físico, no vale enseñar el móvil ni una captura de pantalla." },
      { time: "14:05–14:30", text: "Llegada a Takayama. Desde Takayama Bus Terminal hasta Hotel Wood Takayama: aproximadamente 12 minutos andando. El hotel está prácticamente junto al casco histórico, por lo que NO necesitamos taxi ni transporte urbano.\n\n🗺️ Ruta completa de Takayama: https://maps.app.goo.gl/VsKEtfcaxV6jcSmS9?g_st=ic\n\nDejar el equipaje en recepción / check-in si la habitación ya está lista (oficial a las 15:00).\n\n✅ Hotel ya pagado (274,98€ vía Booking).\n\n♨️ El hotel tiene onsen (separado por sexos), abierto de 15:00 a 00:00 y de 6:00 a 9:00, con helado gratis de cortesía al salir." },
      { time: "14:30–14:45", text: "🚶 Andar desde el hotel hasta **Sanmachi Suji** (centro del casco antiguo)." },
      { time: "14:45–15:30", text: "🍶 **SANMACHI SUJI** (imprescindible): las 3 calles históricas (Ichinomachi, Ninomachi, Sannomachi). Catas de sake (¥100/copa en varias bodegas), artesanía de madera, tiendas de sarubobo.\n\n💡 Priorizar esto ahora: las tiendas cierran sobre las 17:00, a diferencia de las calles y templos, que se pueden ver más tarde." },
      { time: "15:30–16:00", text: "🏛️ **TAKAYAMA JINYA** (imprescindible). Único edificio de gobierno del periodo Edo que se conserva íntegro en Japón. Abierto 08:45–17:00 (última entrada 16:30), entrada ¥430." },
      { time: "16:00–16:15", text: "🌉 Cruzar el **Puente Nakabashi**, el puente rojo icónico -- parada fotográfica de paso hacia el resto del casco antiguo." },
      { time: "16:15–16:40", text: "⛩️ **HIDA KOKUBUNJI** (opcional pero recomendado). Templo del siglo VIII con pagoda de 3 pisos y un ginkgo de 1.200 años." },
      { time: "16:40–17:10", text: "⛩️ **SAKURAYAMA HACHIMANGU** (opcional). El recinto del santuario es gratuito y precioso. El museo Yatai Kaikan (¥1.000) cierra a las 17:00, así que solo entrar si se llega con margen -- si no, quedarse con el santuario en sí." },
      { time: "17:10–17:45", text: "🚶 Paseo libre de vuelta por el casco antiguo. 🍡 Snack opcional: Hida beef sushi, mitarashi dango, o helado de sarubobo -- sin llenarse demasiado antes de la cena." },
      { time: "17:45–18:45", text: "🏨 Vuelta al hotel: descanso + **onsen** si apetece antes de la cena. No programar más visitas turísticas después de esto para llegar con calma a cenar." },
      { time: "18:45–19:00", text: "🚶 Caminar hacia el restaurante de la cena." },
      { time: "19:00", text: "🥩 **Cena especial de Hida beef en Takayama.**\n\n**Qué pedir:** *rosu* (sirloin) para shabu-shabu o a la plancha, o *hire* (solomillo) si buscáis lo más tierno. El **hoba miso** (carne a la brasa sobre una hoja de magnolia con miso local) es la especialidad de la zona -- pedirlo sí o sí si está en la carta. Una o dos piezas de **Hida beef nigiri-zushi** como entrante son la forma clásica de probarlo sin llenar. Acompañar con un **sake local** de Hida." },
      ...
      { time: "🍽️ CONSEJOS DE COMIDA", text: "⚠️ En Shirakawa-go, comer sobre las 12:00 en Tanaka-ya para no arriesgar el bus de las 13:15.\n⚠️ En Takayama las tiendas cierran sobre las 17:00, pero los restaurantes de cena abren más tarde. La cena a las 19:00 es viable. 🥩 Takayama es ideal para probar Hida beef -- pedir hoba miso y nigiri-zushi de Hida beef." },
    ],
