...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "~21:30", text: "🏨 **REGRESO AL HOTEL (HOTEL KEIHAN KYOTO HACHIJOGUCHI)**\n\nRegreso desde Gion/Pontocho a nuestro hotel en Kioto (Hotel Keihan Kyoto Hachijoguchi) para descansar (2ª noche aquí).\n\n**Cómo volver:**\n- 🚇 Metro/Bus: Bus urbano o metro desde Shijo/Gion hasta Kyoto Station (~10–15 min, 🎫 **SUICA:** ✅ SÍ).\n- 🚶 A pie: Aprox. 25–30 min andando disfrutando del ambiente nocturno de Kioto." },
