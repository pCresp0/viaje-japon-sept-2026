...
export const tripMeta = {
  ...
  about: {
    title: "Sobre la web",
    description: "Esta aplicación web ha sido construida a medida utilizando el ecosistema de React, empaquetada con Vite para un HMR ultra rápido y estilada con TailwindCSS para un diseño responsive. Se trata de una PWA (Progressive Web App) con Service Workers para garantizar el acceso offline en todo Japón. La interfaz incluye micro-animaciones con Framer Motion, soporte i18n para 4 idiomas y componentes modulares (SSOT en trip.js). Desplegada sobre Vercel con Edge caching para máxima velocidad. Todo el código es open-source en GitHub.",
...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:30–14:15", text: "🍜 COMIDA EN KYOTO. IMPORTANTE: Intentar terminar aproximadamente sobre las 14:15 para conservar margen para el tren a Osaka.\n⚠️ Esta comida debe ser rápida. Tenemos el tren hacia Osaka a las 14:30. Recomendación: comer cerca del camino hacia Kyoto Station; ramen; udon/soba; curry; donburi; teishoku rápido. No reservar restaurante para esta comida. Alternativa: Comprar bento/ekiben en Kyoto Station si vamos justos." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "18:00", text: "🍱 CENA EN MAGOME CHAYA. La cena se sirve EXACTAMENTE a las 18:00 y termina aprox. a las 19:00. Precio: ¥3.630/persona (¥18.150 para 5). La cena debe estar confirmada previamente. IMPORTANTE: No llegar tarde. El restaurante está justo enfrente del alojamiento.\n⚠️ NO HAY DESAYUNO para la mañana siguiente: Magome Chaya no ofrece desayuno. Comprar con antelación, el pueblo no tiene comercios abiertos a primera hora." },
...
export const transports = [
  ...
  { day: 3, date: "2026-09-09", name: "Bus y Metro", from: "Kioto", to: "Mercado Nishiki / Gion", type: "Operador Privado / Local", real: 4, jrPass: 4 },
  { day: 4, date: "2026-09-10", name: "Metro y Bus 205", from: "Kioto", to: "Kinkakuji", type: "Operador Privado / Local", real: 3, jrPass: 3 },
  { day: 4, date: "2026-09-10", name: "Tranvía Randen", from: "Ninna-ji", to: "Arashiyama", type: "Operador Privado", real: 1.5, jrPass: 1.5 },
  { day: 4, date: "2026-09-10", name: "Tren JR Línea San-In", from: "Arashiyama", to: "Kioto", type: "Línea JR Local", real: 1.5, jrPass: 0 },
  { day: 5, date: "2026-09-11", name: "Tren rápido JR (ida y vuelta)", from: "Kioto", to: "Osaka", type: "Línea JR Local", real: 7, jrPass: 0 },
  { day: 6, date: "2026-09-12", name: "Thunderbird + Hokuriku Shinkansen", from: "Kioto", to: "Kanazawa", type: "Línea JR Exprés", real: 43.5, jrPass: 0 },
  ...
  { day: 8, date: "2026-09-14", name: "Nohi Bus directo Takayama → Magome", from: "Takayama Nohi Bus Center", to: "Magome", type: "Operador Privado (Bus)", real: 25, jrPass: 25, note: "Reservar 5 plazas · 08:00–10:45 · ¥5.000/persona" },
  { day: 9, date: "2026-09-15", name: "Bus local Magome → Nakatsugawa", from: "Magome", to: "Nakatsugawa", type: "Operador Privado (Bus)", real: 3, jrPass: 3, note: "Salida 08:15 → Llegada 08:40 · ¥800/persona · Sin reserva" },
  { day: 9, date: "2026-09-15", name: "JR Limited Express Shinano 4", from: "Nakatsugawa", to: "Nagoya", type: "Línea JR Exprés", real: 15, jrPass: 0, note: "09:57 → 10:53 · Reservar asiento para 5 personas" },
  { day: 9, date: "2026-09-15", name: "Shinkansen Nozomi", from: "Nagoya", to: "Tokio", type: "Línea JR (Tren Bala)", real: 50, jrPass: 0, note: "~11:15–11:30 → ~13:00 · Reservar por adelantado para 5 · Smart EX" },
  ...
  { day: 14, date: "2026-09-20", name: "Shinkansen ida y vuelta (Excursión Fuji)", from: "Tokio", to: "Mishima / Shin-Fuji", type: "Línea JR (Tren Bala)", real: 62, jrPass: 0, note: "Tokio→Mishima (Kodama 805) y regreso Shin-Fuji→Tokio" },
