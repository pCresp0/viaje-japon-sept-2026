...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "11:35", text: "🥾 Ruta Nakasendo: Magome → Tsumago. Aproximadamente 8 km y unas 3 horas a ritmo tranquilo. El sentido Magome → Tsumago tiene menos subida: se sube el paso de Magome-tōge (~300 m) y luego se baja casi todo el resto. Info práctica: dificultad fácil–moderada; sendero bien señalizado; tramos de bosque y asfalto; llevar agua. Hay campanas para ahuyentar osos en varios puntos, utilizarlas al pasar.\n\n📍 **Hitos por el camino** (no hay que buscarlos activamente, van saliendo solos si seguís las señales):\n• **Tateba-chaya**: casa de té tradicional donde ofrecen té gratis a los caminantes -- buen sitio para un primer descanso.\n• **Cascadas Odaki y Medaki** (\"macho\" y \"hembra\"): un pequeño desvío señalizado, la Odaki cae unos 18 m, la Medaki es más pequeña y suave.\n• **Santuario Kurashina**: justo al lado de las cascadas.\n• **Otsumago**: aldea con casas tradicionales del periodo Edo, ~1 km antes de llegar a Tsumago -- incluye la casa Fujihara, de mediados del s. XVII.\n\nJuancar, ya sabemos que como funcionario en el Reina Sofía no te mueves mucho, ¡pero hoy toca andar!" },
      { time: "12:50–13:20", text: "🍙 COMIDA / SNACK DURANTE LA RUTA. Llevar comida desde Takayama/Magome. No depender de encontrar un restaurante durante la caminata. Comprar: onigiri, sandwich, fruta, bebida. La prioridad es no alargar la caminata porque debemos recoger el equipaje y coger el bus de vuelta a Magome. Si encontramos una casa de té abierta, podemos parar, pero no depender de ello." },
      { time: "14:35 aprox.", text: "🏘️ Llegada a Tsumago (variable según el ritmo de la caminata). Con el bus elegido de vuelta (16:42), hay más de **2 horas reales** para ver el pueblo -- Tsumago conserva más edificios ORIGINALES que Magome (que se quemó dos veces y se reconstruyó):\n\n• **Calle principal**: coches prohibidos de 9:00 a 17:00, cables enterrados, sin ningún elemento moderno a la vista.\n• **Templo Kōtoku-ji**: reconocible por sus paredes blancas y base de piedra, del año 1500, domina el pueblo desde un pequeño altozano.\n• **Waki-Honjin Okuya**: la antigua posada secundaria, edificio original del s. XIX, Bien Cultural Importante -- incluye un pequeño museo (horario habitual 9:00-17:00, comprobar al llegar).\n• **Museo de Historia de Nagiso** (Nagiso Rekishi Shiryokan): sobre la historia del valle de Kiso y la ruta Nakasendo, junto al Waki-Honjin.\n\n💡 Con más de 2 horas ahora sí da tiempo a entrar con calma en el Waki-Honjin y/o el museo, además de pasear la calle principal y ver el templo.\n\n🏠 **Sobre los minshuku**: el pequeño alojamiento familiar japonés, gestionado por la propia familia propietaria, con cena y desayuno caseros incluidos casi siempre -- el equivalente a un B&B rural. Es el tipo de alojamiento que tenéis reservado esta noche en Magome Chaya." },
      { time: "16:35–16:42", text: "🚍 BUS TSUMAGO → MAGOME (Ontake Kotsu, línea Nagiso-Tsumago-Magome). Salida Tsumago: 16:42. Llegada Magome: 17:10. Duración: 28 min.\n\n⚠️ **Por qué este bus y no uno antes:** el bus de las 14:22 (que salía justo al llegar) solo daba unos minutos en Tsumago -- prácticamente nada. Este de las 16:42 es la siguiente salida que llega hasta Magome, y da más de 2 horas reales para ver el pueblo como merece.\n\n🎫 **SUICA:** ❌ NO\n📅 **RESERVA:** ❌ NO\n🛒 **COMPRA:** Pago en efectivo al conductor o billete en la oficina de Tsumago. Precio: ¥1.000/persona (~6€). No requiere JR Pass. No hace falta reservar.\n\n⚠️ **IMPORTANTE:** Este es el último bus útil del día para volver a Magome a dormir -- no perderlo. Horario verificado en la web oficial de Ontake Kotsu / japan-guide.com." },
      { time: "17:10", text: "📍 Regreso a Magome. Ya tenemos el equipaje con nosotros." },
      { time: "17:10–18:00", text: "Poco más de 45 min antes de la cena de las 18:00: check-in rápido en Magome Chaya (las maletas ya están ahí desde por la mañana), ducha y descanso breve.\n\n🚶 **Cómo llegar a Magome Chaya:** el minshuku está en la propia calle principal del pueblo (la cuesta empedrada del Nakasendo), muy cerca de donde para el bus local — apenas un par de minutos andando cuesta arriba. La calle histórica está cerrada al tráfico rodado, así que todo el trayecto final es a pie, sin necesidad de taxi ni ningún otro transporte.\n\n⚠️ **PAGO DEL ALOJAMIENTO:** El hotel Magome Chaya NO está pagado de antemano. **Se debe pagar allí en el hotel en EFECTIVO / metálico (~178,98€ / ~¥32.000 grupo · ~35,80€/persona)**, por lo que hay que **sacar dinero en efectivo** previamente (en un cajero 7-Eleven / konbini) -- idealmente antes de salir de Takayama por la mañana, ya que hoy no habrá tiempo de sobra.\n\n⚠️ **IMPORTANTE:**\nCon tan poco margen hasta la cena, no dejar ninguna compra pendiente para esta franja." },
      ...
      { time: "~19:30", text: "🏨 **ALOJAMIENTO: MAGOME CHAYA (MINSHUKU)** (https://www.google.com/maps/search/?api=1&query=Magome+Chaya+Gifu)\n\n⚠️ Pago pendiente en efectivo en el hotel (sacar dinero antes).\n\nDescanso en la posada rural tras la cena (1ª y única noche en Magome Chaya).\n\n♨️ Tiene un pequeño baño comunitario tipo onsen (separado por sexos), sin horario oficial fijo — mejor preguntar al hacer el check-in; suele estar más tranquilo sobre las 18:00–19:00, cuando el resto cena." },
      { time: "~20:00", text: "🏮 **PASEO POR MAGOME DE NOCHE** (recomendado, no solo si sobran ganas).\n\nComo hoy la tarde se ha ido casi entera a Tsumago, esta es la ocasión real de ver Magome con calma: calles empedradas iluminadas con faroles tradicionales, mucho más tranquilas que a mediodía. Las tiendas ya estarán cerradas, pero el ambiente y la arquitectura se disfrutan igual -- y ya habéis visto de día lo más distintivo (mirador y rueda de molino) esta mañana, al llegar. No alejarse mucho de la posada, el pueblo cierra temprano." },
      { time: "🚍 RESUMEN DE TRANSPORTE", text: "🏨 Hotel Wood Takayama\n↓ 10–15 min andando (07:20)\n↓ 🚌 Takayama Nohi Bus Center (07:35 canje billetes)\n↓ 08:00–10:45 🚌 Nohi Bus directo (✅ Reservado)\n↓ 📍 Magome (bajada 10:45)\n↓ dejar equipaje en Magome Chaya (2 min andando)\n↓ 🥾 8 km / ~3 h Ruta Nakasendo\n↓ 📍 Tsumago (>2h reales para verlo)\n↓ 🚌 16:42–17:10 Bus (Ontake Kotsu)\n↓ 📍 Magome\n↓ 🏨 Magome Chaya (check-in rápido, maletas ya están ahí)\n↓ 🍱 Cena 18:00." },
