...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "12:45–13:30", text: "🍜 Comida en Odaiba (foodcourt de DiverCity o Aqua City) -- ya que estáis aquí, más simple que buscar algo por la zona de la Torre de Tokio." },
      { time: "13:30–14:00", text: "🚇 **HACIA LA TORRE DE TOKIO.** Yurikamome hasta Shimbashi + transbordo a la línea Toei Oedo hasta Akabanebashi (o Hibiya hasta Kamiyacho) -- un solo cambio, unos 25-30 min en total." },
      { time: "14:00–17:45", text: "🗼 **TORRE DE TOKIO, CON ATARDECER INCLUIDO.** Inaugurada en 1958, con 333 m es unos 20 m más alta que la Torre Eiffel en la que se inspiró -- pintada de blanco y naranja internacional por normativa de seguridad aérea, no por elección estética.\n\n🎟️ **Main Deck** (150 m, ~¥1.200, entrada normal sin reserva): el mirador estándar. **Top Deck** (150-250 m, ~¥3.000, con tramos de suelo de cristal): más caro y requiere reserva de franja horaria -- comprobar disponibilidad de última hora antes de contar con él.\n\n🌇 El sol se pone sobre las **17:45-17:50** en estas fechas -- con margen de sobra desde las 14:00 para visitar con calma y quedaros arriba para verlo caer sobre la ciudad." },
      { time: "~17:45–18:15", text: "🚇 **HACIA ASAKUSA (UNIQLO).** Desde la Torre de Tokio, unos 25-30 min con un transbordo (Oedo/Hibiya + línea Ginza o Asakusa)." },
      { time: "18:15–20:00", text: "🛍️ **UNIQLO ASAKUSA STORE.** Compras hasta el cierre a las 20:00 -- con margen de sobra.\n\nhttps://maps.app.goo.gl/uAJszQKRPMjwdudx5?g_st=ic" },
