...
export const days = [
  ...
  },
  {
    ...
    money: "Aprox. 40€ (comidas) + compras + entrada al Skytree si se elige esa opción",
  },
  {
    num: 14,
    date: "2026-09-20",
    ...
    cities: "Nikko",
    summary:
      "⚠️ Movida del sábado al domingo por falta de disponibilidad de trenes -- se hace si el tiempo acompaña. Día completo de naturaleza y templos a 2 horas de Tokio en tren directo desde Asakusa (literalmente al lado del hotel): el santuario Toshogu, mausoleo del shogun Tokugawa Ieyasu y Patrimonio de la Humanidad, el Puente Shinkyo, las cataratas Kegon y el lago Chuzenji por la carretera de montaña Irohazaka. Cena de despedida del grupo por la noche, en el último día completo antes de volver a España.",
    history:
    ...
    schedule: [
      ...
      { time: "🟢 07:30", text: "🚅 **TREN CONFIRMADO: LIMITED EXPRESS KEGON, ASAKUSA → TOBU-NIKKO.** Verificado en el horario oficial de Tobu Railway (servicio diario) -- llegada a Tobu-Nikko a las **09:20** (1 h 50 min de trayecto).\n\n🎫 **SUICA:** ❌ NO (requiere billete expreso con plaza)\n📅 **RESERVA:** 🔴 PENDIENTE DE COMPRAR -- recomendado el **Tobu World Heritage Pass** (~¥4.160/persona ≈ 22,60€), que incluye ida y vuelta en Limited Express MÁS autobuses ilimitados por Nikko durante 2 días. Al comprarlo, pedir la plaza en el Kegon de las 07:30.\n📅 **COMPRA:** En las máquinas o taquillas de Tobu Asakusa Station, o con antelación en la app/web de Tobu Railway. Al ser domingo, mejor comprarlo con unos días de margen para asegurar los 5 asientos juntos." },
      ...
      { time: "🟢 17:44", text: "🚅 **TREN CONFIRMADO: LIMITED EXPRESS REVATY KEGON, TOBU-NIKKO → ASAKUSA.** Verificado en el horario oficial de Tobu Railway (datos a fecha de septiembre 2026) -- llegada a Asakusa a las **19:35** (1 h 51 min de trayecto)." },
      { time: "19:35", text: "Llegada a Asakusa Station." },
      { time: "~20:00–21:00", text: "🍜 Cena de despedida del grupo en Tokio (Asakusa), en el último día completo antes de volver a España." },
    ...
    money: "Aprox. 74€/persona en total (40€ comidas, incluye cena de despedida + 11,40€ entradas Toshogu + 22,60€ Tobu World Heritage Pass) -- 🔴 el Pase de Tobu está PENDIENTE DE COMPRAR (pedir plaza en el Kegon 07:30 y el Revaty Kegon 17:44, ambos confirmados); ascensor a Kegon opcional aparte (~3,10€/persona).",
  },
  {
    num: 15,
    date: "2026-09-21",
