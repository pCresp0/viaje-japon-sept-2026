...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "15:45–16:30", text: "🗼 **TORRE DE TOKIO.** Inaugurada en 1958, con 333 m es unos 20 m más alta que la Torre Eiffel en la que se inspiró -- pintada de blanco y naranja internacional por normativa de seguridad aérea, no por elección estética.\n\n🎟️ **Main Deck** (150 m, ~¥1.200, entrada normal sin reserva): el mirador estándar. **Top Deck** (150-250 m, ~¥3.000, con tramos de suelo de cristal): más caro y requiere reserva de franja horaria -- con solo 45 min por delante, mejor centrarse en el Main Deck." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "🟢 07:30", text: "🚅 **TREN CONFIRMADO: LIMITED EXPRESS KEGON, ASAKUSA → TOBU-NIKKO.** Verificado en el horario oficial de Tobu Railway (servicio diario, no solo findes) -- llegada a Tobu-Nikko a las **09:20** (1 h 50 min de trayecto).\n\n🎫 **SUICA:** ❌ NO (requiere billete expreso con plaza)\n📅 **RESERVA:** 🔴 PENDIENTE DE COMPRAR -- recomendado el **Tobu World Heritage Pass** (~¥4.160/persona ≈ 22,60€), que incluye ida y vuelta en Limited Express MÁS autobuses ilimitados por Nikko durante 2 días. Al comprarlo, pedir la plaza en el Kegon de las 07:30.\n📅 **COMPRA:** En las máquinas o taquillas de Tobu Asakusa Station, o con antelación en la app/web de Tobu Railway. Al ser sábado, mejor comprarlo con unos días de margen para asegurar los 5 asientos juntos." },
      { time: "09:20", text: "Llegada a Tobu-Nikko Station. Recogida de folletos/mapa en el centro de turismo de la estación." },
      { time: "~09:40", text: "🚌 **BUS HACIA LA ZONA DE TEMPLOS.** Parada justo enfrente de la estación, dirección Chuzenji-onsen/Yumoto-onsen -- bajar en \"Shinkyo\" o \"Nishisando-iriguchi\" (esta última es la parada más cercana a Toshogu, Rinno-ji y Futarasan). Según el horario oficial de Tobu Bus hay salidas cada 15-30 min durante toda la mañana, así que no hace falta apuntarse a una exacta -- simplemente coger la siguiente que pase. Trayecto de unos 10 min.\n\n🎫 Incluido en el Tobu World Heritage Pass." },
      ...
      { time: "13:00–13:45", text: "🍜 Almuerzo local: probar el yuba (piel de tofu), especialidad de Nikko desde hace siglos, en cualquiera de los restaurantes cerca de la entrada al santuario." },
      { time: "~13:55", text: "🚌 **BUS HACIA EL LAGO CHUZENJI.** Desde la misma parada de Nishisando/Shinkyo, dirección Chuzenji-onsen -- por la carretera de montaña Irohazaka (curvas muy pronunciadas, vistas espectaculares). Según el horario oficial hay salidas frecuentes también por la tarde. Trayecto de 40-50 min, incluido en el pase." },
      { time: "~14:40", text: "Llegada a Chuzenji-onsen." },
      { time: "14:40–16:30", text: "🏔️ **LAGO CHUZENJI Y CATARATAS KEGON.** El lago, a los pies del monte Nantai, con paseo junto a la orilla. Las cataratas Kegon, de 97 m de caída, están a un paseo del lago; se ven bien de forma gratuita desde la plataforma superior, o se puede bajar en ascensor a la plataforma inferior para verlas de cerca (entrada aprox. ¥570 ≈ 3,10€, no reservable, se paga in situ)." },
      { time: "~16:40", text: "🚌 **BUS DE VUELTA A TOBU-NIKKO.** Misma parada de Chuzenji-onsen, dirección Tobu-Nikko -- salidas frecuentes según el horario oficial. Trayecto de 40-50 min." },
      { time: "~17:30", text: "Llegada a Tobu-Nikko Station. Margen de sobra antes del tren de vuelta." },
      { time: "🟢 17:44", text: "🚅 **TREN CONFIRMADO: LIMITED EXPRESS REVATY KEGON, TOBU-NIKKO → ASAKUSA.** Verificado en el horario oficial de Tobu Railway (datos a fecha de septiembre 2026) -- llegada a Asakusa a las **19:35** (1 h 51 min de trayecto). Justo el rango horario que buscabais, sin necesidad de precipitarse con un tren anterior." },
      { time: "19:35", text: "Llegada a Asakusa Station." },
      { time: "~20:00–21:00", text: "🍜 Cena por Nakano o Asakusa." },
      { time: "~21:15", text: "🏨 **REGRESO AL HOTEL: KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (https://maps.app.goo.gl/ccK7MTfGL6HJXFf76?g_st=ic)\n\nRegreso a la residencia para descansar y preparar el día de mañana: Ruta Nintendo, Ikebukuro y Akihabara, último día completo antes de volver (5ª noche en Tokio)." },
    ],
    money: "Aprox. 74€/persona en total (40€ comidas + 11,40€ entradas Toshogu + 22,60€ Tobu World Heritage Pass) -- 🔴 el Pase de Tobu está PENDIENTE DE COMPRAR (pedir plaza en el Kegon 07:30 y el Revaty Kegon 17:44, ambos confirmados); ascensor a Kegon opcional aparte (~3,10€/persona).",
  },
  {
    num: 14,
    date: "2026-09-20",
