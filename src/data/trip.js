...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "17:25", text: "✈️ Vuelo QR809 Narita → Doha (Qatar Airways, 10h 55m). Llegada a Doha a las 22:20." },
      { time: "01:10", text: "✈️ Escala en Doha de 2h 50m (22:20 → 01:10), luego vuelo QR147 Doha → Madrid (Qatar Airways, 7h 25m). Llegada a Madrid (T4S) el mar 22 sept a las 07:35." },
    ],
    money: "Aprox. 40€ (comidas)",
  },
];
...
export const transports = [
  ...
  { day: 4, date: "2026-09-10", name: "Metro, Bus 205 y Tranvía Randen", from: "Kioto", to: "Kinkakuji / Arashiyama", type: "Operador Privado / Local", real: 4.50, jpy: 750, coverage: "no-jr", jrPassCovered: false, suicaCategory: "yes", note: "✓ Realizado · Pagado con Suica (Randen ¥250) · No cubierto por JR Pass", purchased: true, advance: false },
  ...
  { day: 6, date: "2026-09-12", name: "Thunderbird + Hokuriku Shinkansen", from: "Kioto", to: "Kanazawa", type: "Línea JR Exprés", real: 41.88, jpy: 7720, coverage: "jr", jrPassCovered: true, suicaCategory: "no", note: "✓ Comprado JR-WEST (Reserva 47932) · ¥38.600 total · 209,38€ Revolut · Kioto → Kanazawa", purchased: true, advance: true },
  { day: 7, date: "2026-09-13", name: "Nohi Bus Kanazawa → Shirakawa-go", from: "Kanazawa Sta.", to: "Shirakawa-go Bus Terminal", type: "Operador Privado (Bus)", real: 19.12, jpy: 3100, coverage: "no-jr", jrPassCovered: false, suicaCategory: "no", note: "✓ Reservado 12GO31991741 · 95,59€ total (19,12€/pax) · Salida 08:40 · ⚠️ No cubierto por JR Pass", purchased: true, advance: true },
  { day: 7, date: "2026-09-13", name: "Nohi Bus Shirakawa-go → Takayama", from: "Shirakawa-go Bus Terminal", to: "Takayama Nohi Bus Center", type: "Operador Privado (Bus)", real: 20.03, jpy: 3250, coverage: "no-jr", jrPassCovered: false, suicaCategory: "no", note: "✓ Reservado 12GO31992254 · 100,14€ total (20,03€/pax) · Salida 13:15 · ⚠️ No cubierto por JR Pass", purchased: true, advance: true },
  ...
  { day: 9, date: "2026-09-15", name: "Bus local Magome → Nakatsugawa", from: "Magome", to: "Nakatsugawa", type: "Operador Privado (Bus)", real: 4.85, jpy: 800, coverage: "no-jr", jrPassCovered: false, suicaCategory: "no", note: "✓ Realizado · ¥800/persona (~4,85€) en efectivo al bajar · ⚠️ No cubierto por JR Pass", purchased: true, advance: false },
  { day: 9, date: "2026-09-15", name: "JR Limited Express Shinano 4", from: "Nakatsugawa", to: "Nagoya", type: "Línea JR Exprés", real: 15.57, jpy: 2870, coverage: "jr", jrPassCovered: true, suicaCategory: "partial", note: "✓ JR-WEST nº 42093 · ¥14.350 total · 77,84€ Revolut · Car 4 · Nakatsugawa → Nagoya", purchased: true, advance: false },
  { day: 9, date: "2026-09-15", name: "Shinkansen Nozomi 358", from: "Nagoya", to: "Tokio", type: "Línea JR (Tren Bala)", real: 59.12, jpy: 10900, coverage: "jr", jrPassCovered: false, suicaCategory: "no", note: "✓ Smart EX nº 2002 · ¥54.500 total · 295,62€ Revolut · Car 12 · ⚠️ Nozomi NO incluido en JR Pass", purchased: true, advance: false },
  { day: 10, date: "2026-09-16", name: "Excursión en autobús Monte Fuji (GetYourGuide)", from: "Tokio", to: "Kawaguchiko / Oishi Park / Chureito", type: "Operador Privado (Tour Bus)", real: 42.00, jpy: 7750, coverage: "no-jr", jrPassCovered: false, suicaCategory: "no", note: "✓ Comprado GetYourGuide · 210€ total (42€/pax) Revolut · Tour completo en autobús · ⚠️ No cubierto por JR Pass", purchased: true, advance: true },
  ...
  { day: 15, date: "2026-09-21", name: "Keisei Skyliner (Tokio → Narita)", from: "Keisei-Ueno", to: "Aeropuerto de Narita", type: "Línea Keisei", real: 14.39, jpy: 2570, coverage: "no-jr", jrPassCovered: false, suicaCategory: "partial", note: "✓ Comprado Keisei Electric Railway · 43,17€ total (14,39€/pax) Revolut · Skyliner directo Ueno→Narita", purchased: true, advance: true },
];
  ...
  categories: [
    {
      ...
      details: [
        ...
        "Vuelta: QR809 NRT→DOH + QR147 DOH→MAD (21 sept, 17:25 → 22 sept, 07:35, 21h 10m).",
    ...
    },
    {
      ...
      details: [
        "<strong>✅ 100% de los transportes realizados y cerrados (datos reales de Revolut y Splitwise)</strong>:",
