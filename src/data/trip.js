...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "16:15–19:00", text: "🌉 **PASEO HASTA EL TOKYO SKYTREE, JUNTO AL RÍO SUMIDA.** Ruta a pie muy sencilla y bonita (~15-20 min) desde el hotel: cruzando el Puente Azumabashi (icónico, rojo) junto al edificio de la cervecera Asahi, y siguiendo el paseo del río Sumida hasta la base de la torre.\n\n🗼 No hace falta subir arriba hoy -- basta con verla de cerca y pasear por su base. Si el grupo tiene ganas y energía después de un día de trenes, se puede valorar la entrada al mirador (previa cola), pero no hace falta forzarlo hoy.\n\n💡 Vuelta al hotel por el mismo camino junto al río, con tiempo de sobra antes de la cena de las 19:30." },
  ...
  },
  {
    ...
    schedule: [
      { time: "07:00", text: "Despertar y desayuno rápido en el hotel o de camino." },
      { time: "~07:05–07:15", text: "🚇 **Salida del hotel hacia Shinjuku.** Desde el KOKO HOTEL Residence Asakusa Kappabashi el trayecto en metro/JR ronda los 40-45 min -- con la estación de Shinjuku de por medio (una de las más grandes y confusas de Japón, con más de 200 salidas), conviene salir con margen extra. Ver la tarjeta de abajo para el mensaje completo del guía con el punto exacto de encuentro.\n\n⚠️ **HORARIO ACTUALIZADO POR EL GUÍA (15 sept):** encuentro a las **08:10**, salida del autobús puntual a las **08:20** -- ya NO es a las 08:30 como se indicaba antes." },
      { time: "08:10", text: "📍 **PUNTO DE ENCUENTRO CON EL GUÍA.** Buscar la bandera naranja con el número **19** (guía: Omar). Ver la tarjeta de abajo para el mensaje completo, con enlace directo al punto exacto en el mapa." },
  ...
  },
  {
    ...
    summary:
      "Día de coleccionismo y videojuegos: Mega Pokémon Center de Ikebukuro (con sus estatuas de Mewtwo, Charizard y Lucario a tamaño real) y Nintendo Store Tokyo. Por la tarde, Nakano Broadway, el mejor lugar de Tokio para cartas Pokémon originales, figuras de Dragon Ball y artículos retro/frikis a precio justo -- ideal para los regalos de los amigos.",
    history:
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "20:00", text: "🍜 Cena de despedida del grupo en Tokio (Asakusa)." },
      { time: "~21:30", text: "🏨 **REGRESO AL HOTEL: KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (https://maps.app.goo.gl/ccK7MTfGL6HJXFf76?g_st=ic)\n\nÚltima noche en Tokio antes de volver a España." },
    ],
    money: "Aprox. 2.700¥/persona ida (Tobu Express) + entradas Toshogu + comida",
  },
  {
    num: 15,
    date: "2026-09-21",
