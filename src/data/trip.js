...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "~21:30", text: "🏨 **REGRESO AL HOTEL: KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (https://www.google.com/maps/search/?api=1&query=KOKO+HOTEL+Residence+Asakusa+Kappabashi)\n\nRegreso a la residencia para descansar y preparar el madrugón de mañana: excursión al Monte Fuji con Ken Kaneshima, con salida muy temprana hacia la Estación de Mishima (5ª noche en Tokio)." },
    ],
    ...
    podcasts: [
      {
        ...
        moment: "En el tren bala Shinkansen o durante el trayecto hacia los miradores del Fuji.",
      },
    ],
    schedule: [
      { time: "06:15", text: "Comprobar cámaras web en directo en mtfujitoday.com e isfujivisible.com desde el hotel en Tokio (la regla de oro matutina).\n\n⚠️ **Mirad la vista NORTE (Kawaguchiko), no la de Hakone/Sur:** aunque el tour de hoy sale desde Mishima (lado sur), casi todas las paradas fotográficas del día —Pagoda Chureito, Kitaguchi Hongu Fuji Sengen Jinja, Oshino Hakkai, la ruta de los lagos— están en el lado norte del Fuji. La visibilidad puede ser buena en un lado y mala en el otro el mismo día, así que comprobad siempre esa vista." },
      ...
      { time: "07:27", text: "🚅 Tokaido-Sanyo Shinkansen KODAMA 805.\n\n🎫 **SUICA:** ❌ NO\n📅 **RESERVA:** 🔴 NECESARIA\n🛒 **COMPRA:** COMPRAR POR ADELANTADO (ida y vuelta) por Smart EX o taquillas JR.\n\nSalida de Tokio a las 07:27, llegada a Mishima a las 08:20. \n\n⚠️ **IMPORTANTE:**\nDebe ser el Kodama para que pare en Mishima.\n\n🎧 **Podcast para la excursión:** [Los mejores lugares para ver el Monte Fuji](https://podcasts.apple.com/es/podcast/jap%C3%B3n-a-fondo/id1545542012?i=1000740790906) (*Japón a fondo* · Japonismo). Consejos clave sobre miradores, visibilidad meteorológica y el misticismo del volcán sagrado." },
