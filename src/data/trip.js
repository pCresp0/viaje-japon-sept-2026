...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "⚠️ ALERTA MAGOME", text: "⚠️ IMPORTANTE — MAGOME POR LA TARDE. La mayoría de tiendas y restaurantes de Magome cierran después de las 17:00. Hay muy pocas opciones de cena en el pueblo y sus horarios pueden variar. Por eso NO debemos contar con encontrar un restaurante alternativo espontáneamente. Confirmar la cena con el alojamiento y conservar la confirmación. COMIDA EN MAGOME: Como las tiendas pueden cerrar temprano, no retrasar demasiado la comida. Si encontramos un restaurante abierto durante la visita, aprovechar la oportunidad." },
      { time: "🍙 DESAYUNO", text: "🍙 DESAYUNO DEL DÍA SIGUIENTE. El alojamiento NO incluye desayuno. Comprar el desayuno el día anterior en Takayama o en una tienda/convenience store antes de llegar a Magome. NO asumir que habrá un konbini abierto en Magome por la mañana. Comprar antes de llegar: onigiri; sandwiches; pan; fruta; bebida; café. Guardar el desayuno en la mochila para la mañana siguiente." }
    ],
    money: "Aprox. 40€ (comidas)",
  },
  {
