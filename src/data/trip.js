...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "~09:55", text: "🚏 **LLEGADA AL CRUCE DE SHIBUYA.** El cruce peatonal más transitado del mundo -- hasta 3.000 personas lo cruzan a la vez en hora punta, en todas direcciones al mismo tiempo, cuando el semáforo se pone en verde para los peatones por los 4 lados a la vez. Justo al lado, la estatua de Hachiko (el perro fiel que esperó a su dueño durante años en la estación) es el punto de quedada más famoso de Tokio -- normal que esté siempre rodeada de gente." },
      { time: "~10:15", text: "🌳 **MIYASHITA PARK.** A pie desde el cruce (~5 min). Parque elevado sobre un centro comercial, con zona de skate, pista deportiva y terrazas -- una forma curiosa de aprovechar el espacio en una ciudad tan densa. Buena parada corta para estirar las piernas antes de seguir." },
      { time: "~10:30", text: "🎮 **POKÉMON CENTER SHIBUYA Y NINTENDO TOKYO** (Shibuya Parco, 6ª planta, ~10 min a pie desde Miyashita Park) — famoso por su gran estatua de Mewtwo (dentro de un tubo de cristal, ideal para fotos) y su estilo neón futurista. En la misma planta también está Nintendo TOKYO. Ojo, que a Sergio seguro que se le ocurre montar un huerto urbano aquí para sus plantas de Aluche." },
      { time: "~12:00", text: "🏙️ **OPCIONAL: SHIBUYA SKY** (decidir en el momento). Mirador de pago justo encima de la estación de Shibuya, 229 m de altura, 360°. Ya tenéis un mirador GRATUITO por la noche en Shinjuku, así que este es un extra si os apetece.\n\n💰 Precio: ¥2.700 online antes de las 15:00 / ¥3.400 desde las 15:00 (en taquilla, +¥300). Horario: 10:00–22:30, última entrada 21:20.\n⚠️ Los turnos de atardecer se agotan con facilidad en fechas con buena previsión de tiempo -- si os apetece de verdad ir a esa hora, mejor reservar con antelación en la web oficial en vez de improvisar sobre la marcha." },
