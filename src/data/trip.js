...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "14:30–16:00", text: "🍶 **SANMACHI SUJI** (imprescindible, priorizar antes de las 17:00 por el cierre de tiendas): las 3 calles históricas (Ichinomachi, Ninomachi, Sannomachi). Catas de sake (¥100/copa), artesanía de madera, tiendas de sarubobo.\n\nSeguido de **Takayama Jinya** (¥430, cierra 17:00, última entrada 16:30) -- único edificio de gobierno del periodo Edo que se conserva íntegro en Japón." },
      { time: "16:00–17:45", text: "🌉 Cruzar el **Puente Nakabashi** (el puente rojo, parada fotográfica) y seguir hacia **Hida Kokubunji** (templo del s. VIII con pagoda de 3 pisos y ginkgo de 1.200 años) y **Sakurayama Hachimangu** (recinto gratuito; el museo Yatai Kaikan cierra a las 17:00, así que solo si llegáis con margen).\n\nTiempo libre para pasear de vuelta por el casco antiguo. 🍡 Snack opcional: Hida beef sushi, mitarashi dango, o helado de sarubobo -- sin llenarse antes de la cena." },
