...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "~14:00–15:00", text: "🏨 **CHECK-IN: KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (https://maps.app.goo.gl/ccK7MTfGL6HJXFf76?g_st=ic)\n\n✅ Hotel ya pagado (1.927,13€ vía Booking · 6 noches).\n\nLlegada y check-in (oficial desde las 15:00). Si llegamos antes, dejar las maletas en recepción si el hotel lo permite y aprovechar para pasear con calma por el barrio.\n\nDirección: 3-24-2 Nishi-Asakusa, Taito-ku.\n\n🧳 **Las 5 maletas grandes enviadas desde Kioto (Takkyubin/Yamato):**\n- Nº de seguimiento: **753-3690-9535**.\n- Entrega programada: **15/09, franja de mañana (AM)** — es decir, deberían haber llegado al hotel ANTES de que lleguéis vosotros por la tarde. Al hacer el check-in, preguntar en recepción si ya las tienen guardadas.\n- Recibo a nombre de Juan Carlos Rodríguez Pérez, remitente Hotel Keihan Kyoto Hachijoguchi.\n- 5 bultos (品名: Clothes), coste total ¥13.060 (ya pagado en el hotel de Kioto al despacharlas)." },
      { time: "15:00–16:00", text: "Descanso corto para instalarnos: deshacer un poco el equipaje y ducharnos tras el día entero de trenes (bus + Shinano + Shinkansen desde primera hora). Sin alargarlo más de una hora -- queda tarde por delante." },
      { time: "16:00–19:00", text: "🌉 **PASEO HASTA EL TOKYO SKYTREE, JUNTO AL RÍO SUMIDA.** Ruta a pie muy sencilla y bonita (~15-20 min) desde el hotel: cruzando el Puente Azumabashi (icónico, rojo) junto al edificio de la cervecera Asahi (con su curiosa escultura dorada, apodada \"la boñiga de oro\" por los propios tokiotas), y siguiendo el paseo del río Sumida hasta la base de la torre.\n\n🗼 El Skytree (634 m) es la torre más alta de Japón. No hace falta subir arriba hoy -- basta con verla de cerca y pasear por **Tokyo Solamachi**, el centro comercial de su base (300 tiendas, buenos sitios para picar algo o tomar un café). Si el grupo tiene ganas y energía después de un día de trenes, se puede valorar la entrada al mirador (previa cola), pero no hace falta forzarlo hoy.\n\n💡 Vuelta al hotel por el mismo camino junto al río, con tiempo de sobra antes de la cena de las 19:30." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "07:45", text: "Hacia la Estación de Shinjuku / punto de encuentro (Tokyo Mode Gakuen). Llegar con margen: la salida en autobús es puntual a las 08:30." },
      { time: "08:30", text: "🚌 **SALIDA DE LA EXCURSIÓN AL MONTE FUJI** (reserva confirmada). Ver más abajo la tarjeta con todos los detalles: punto de encuentro exacto, paradas del recorrido (Kawaguchiko, Parque Oishi, Oshino Hakkai, Pagoda Chureito), duración y contacto del proveedor." },
