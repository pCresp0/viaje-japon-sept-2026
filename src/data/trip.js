...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "21:30–22:00", text: "🍙 **COMPRA DE DESAYUNO Y DESCANSO EN HOTEL KEIHAN KYOTO HACHIJOGUCHI** (https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\n⚠️ Comprar esta noche el desayuno del Día 2 en un konbini cercano al hotel (1ª noche en Kioto en Hotel Keihan Kyoto Hachijoguchi)." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "08:40", text: "08:40 — Llegada a Nakatsugawa Station.\n\n☕ **1 h 17 min de margen en Nakatsugawa (08:40 → 09:57):**\nEste margen amplio es intencionado y deliberado. No intentar reducirlo ni ajustar la ruta; permite al grupo de 5 personas:\n- Ir al baño tranquilamente.\n- Tomar un café o desayuno ligero.\n- Comprar agua y comida/snacks en las tiendas de la estación.\n- Localizar con calma el andén de JR y esperar al Limited Express Shinano 4 sin prisas." },
...
export const transports = [
  ...
  { day: 9, date: "2026-09-15", name: "JR Limited Express Shinano 4", from: "Nakatsugawa", to: "Nagoya", type: "Línea JR Exprés", real: 15, jpy: 3070, coverage: "jr", suicaCategory: "partial", note: "09:57 → 10:53 (1h17 de margen previo en Nakatsugawa) · Reservar en taquillas/canal JR para 5 personas", purchased: false, advance: true },
