...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "🚆 TRANSPORTE DEL DÍA", text: "1. 🚌 Magome → Nakatsugawa: 08:15 → 08:40. Sin reserva. ¥800 aprox. (~5€). Pago local.\n2. 🚆 Nakatsugawa → Nagoya: Limited Express **Shinano 4**. 09:57 → 10:53.\n\n🟢 **YA RESERVADO** (JR-WEST nº 42093 · ¥14.350 · Car 4). 🎫 Recoger billetes físicos antes de subir.\n3. 🚅 Nagoya → Tokyo: Nozomi. ~11:20–11:30 → ~13:00.\n\n🟠 **PENDIENTE** — RESERVAR POR ADELANTADO para 5 (Smart EX).\n4. 🚇 Tokyo → Asakusa/Kappabashi: Metro/JR. Sin reserva. Suica.\n5. 🚇 Asakusa → Akihabara: Transporte urbano. Sin reserva. Suica." },
      { time: "🎫 RESERVAS", text: "🟢 **HECHO**\nLimited Express Shinano 4 Nakatsugawa → Nagoya (09:57 → 10:53) · Reserva 42093 · Receipt AEE6606M · ¥14.350.\n\n🎫 **PENDIENTE DE RECOGER (no es comprar):** billetes físicos JR-WEST antes de subir (tarjeta Mastercard **8625 + PIN cumpleaños de Pablo).\n\n🔴 **PRIORIDAD ALTA — AÚN PENDIENTE**\nRESERVAR Shinkansen Nozomi Nagoya → Tokyo para 5 personas (~11:20–11:30).\n\n🟢 NO RESERVAR\nBus local Magome → Nakatsugawa (08:15).\n\n🟢 NO RESERVAR\nTokyo → hotel / transporte urbano en Tokyo." },
      { time: "💡 PUNTOS IMPORTANTES", text: "⚠️ El Shinano 4 de las 09:57 **YA ESTÁ RESERVADO**. No cambiar esta hora salvo petición expresa.\n\n⚠️ La reserva NO sustituye la recogida física de billetes. Sin tickets, JR-WEST advierte que puede hacer falta comprar de nuevo sin descuento.\n\n⚠️ El Shinkansen Nagoya → Tokio **sigue pendiente** de reservar (Smart EX).\n\n⚠️ Comprar el desayuno el día anterior porque Magome Chaya no ofrece desayuno.\n\n⚠️ No confiar en horarios antiguos de 08:50 / 09:30: no corresponden a los servicios del 15/09/2026." },
      { time: "✅ CHECKLIST DEL DÍA", text: "☑️ Bus Magome → Nakatsugawa\n☑️ Reserva Shinano 4 Nakatsugawa → Nagoya (nº 42093 · YA HECHA)\n☐ Recoger billetes físicos JR-WEST (fuera de tornos)\n☐ Comprobar que llevamos la tarjeta física Mastercard terminada en 8625\n☐ Tener a mano Reservation No. 42093\n☐ Tener a mano el PIN de 4 dígitos (cumpleaños de Pablo)\n☐ Comprar/reservar Tokaido Shinkansen Nagoya → Tokyo (sigue pendiente)" },
    ],
    money: "Aprox. 40€ (comidas)",
  },
  {
