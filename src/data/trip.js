...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "09:57", text: "🚆 09:57 — JR Limited Express SHINANO 4\n\n🎫 **SUICA:** 🟡 PARCIAL (la tarjeta base puede intervenir pero el Limited Express requiere billete/suplemento con asiento reservado; recomendamos comprar el billete completo en JR)\n📅 **RESERVA:** 🔴 RESERVAR / COMPRAR\n🛒 **COMPRA:** Canales oficiales de JR / taquillas en estación (NO Smart EX).\n\nNakatsugawa → Nagoya\nSalida: 09:57\nLlegada: 10:53\nDuración: aprox. 56 min.\nRecomendación: ASIENTO RESERVADO para los 5 viajeros.\nNo necesitamos Japan Rail Pass.\nEl Limited Express requiere billete + suplemento Limited Express.\n\n⚠️ RESERVA RECOMENDADA\nAl viajar 5 personas, reservar los 5 asientos juntos para no separarnos.\nLos asientos reservados deben gestionarse mediante los canales de JR o en ventanilla/taquilla JR." },
      { time: "10:53", text: "10:53 — Llegada a Nagoya. Transbordo al Tokaido Shinkansen. Tenemos aproximadamente 25–35 minutos de margen para el Shinkansen.\nComprar aquí un EKIBEN si no hemos comido antes.\nNo sentarse a comer en la estación: comprar comida para llevar y comerla en el Shinkansen.\nRecomendación: ekiben, sandwich, sushi/bento, bebida." },
      ...
      { time: "~11:20–11:30", text: "🚅 ~11:20–11:30 — Tokaido Shinkansen NOZOMI\n\n🎫 **SUICA:** ❌ NO\n📅 **RESERVA:** 🔴 NECESARIA\n🛒 **COMPRA:** COMPRAR POR ADELANTADO mediante Smart EX.\n\nNagoya → Tokyo\nDuración: aprox. 1h40.\nLlegada aproximada: ~13:00–13:10.\n\n⚠️ **IMPORTANTE:**\n- Salida objetivo: ~11:20–11:30 (deja margen suficiente tras la llegada del Shinano a las 10:53; NO reservar a las 11:00 por ser solo 7 min de enlace).\n- RESERVAR POR ADELANTADO para 5 personas mediante Smart EX con asientos juntos.\n\n🧳 **Equipaje en Shinkansen:**\n⚠️ MEDIR LAS MALETAS ANTES DE RESERVAR (largo + ancho + alto):\n- Si la suma es ≤ 160 cm: NO hace falta reserva especial de equipaje.\n- Si supera 160 cm y hasta 250 cm: Seleccionar asiento con 'Seat with Oversized Baggage Area' en Smart EX." },
...
export const transports = [
  ...
  { day: 6, date: "2026-09-12", name: "Thunderbird + Hokuriku Shinkansen", from: "Kioto", to: "Kanazawa", type: "Línea JR Exprés", real: 43.5, jpy: 7720, coverage: "jr", suicaCategory: "no", note: "Transbordo en Tsuruga. Comprar en JR-West Online Train Reservation (ya disponible).", purchased: false, advance: true },
  ...
  { day: 8, date: "2026-09-14", name: "Nohi Bus directo Takayama → Magome", from: "Takayama Nohi Bus Center", to: "Magome", type: "Operador Privado (Bus)", real: 31, jpy: 5000, coverage: "no-jr", suicaCategory: "no", note: "Reservar 5 plazas online · 08:00–10:45 · ¥5.000/persona (¥25.000 total grupo)", purchased: false, advance: true },
  ...
  { day: 9, date: "2026-09-15", name: "JR Limited Express Shinano 4", from: "Nakatsugawa", to: "Nagoya", type: "Línea JR Exprés", real: 15, jpy: 3070, coverage: "jr", suicaCategory: "partial", note: "09:57 → 10:53 · Reservar en taquillas/canal JR (NO Smart EX) para 5 personas", purchased: false, advance: true },
  { day: 9, date: "2026-09-15", name: "Shinkansen Nozomi", from: "Nagoya", to: "Tokio", type: "Línea JR (Tren Bala)", real: 50, jpy: 11300, coverage: "jr", suicaCategory: "no", note: "~11:20–11:30 → ~13:00 · Smart EX · Medir maletas (solo área especial si >160cm)", purchased: false, advance: true },
  ...
  { day: 14, date: "2026-09-20", name: "Shinkansen ida y vuelta (Excursión Fuji)", from: "Tokio", to: "Mishima / Shin-Fuji", type: "Línea JR (Tren Bala)", real: 62, jpy: 9000, coverage: "jr", suicaCategory: "no", note: "Comprar vía Smart EX tras confirmar fecha definitiva de la excursión", purchased: false, advance: true },
  { day: 15, date: "2026-09-21", name: "Narita Express (N'EX)", from: "Estación de Tokio", to: "Aeropuerto de Narita", type: "Línea JR", real: 19, jpy: 3330, coverage: "jr", suicaCategory: "partial", note: "Reservar con antelación o comprar en Japón. Requiere asiento reservado.", purchased: false, advance: true },
];
