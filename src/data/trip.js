...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:00–13:45", text: "🍜 COMIDA EN KYOTO. \n\n⚠️ **IMPORTANTE:**\nIntentar terminar aproximadamente sobre las 13:45 para conservar margen para el tren a Osaka.\n⚠️ Con el margen ganado esta mañana, ya no hace falta comer con tantas prisas como estaba previsto. Tenemos el tren hacia Osaka a las 14:30. Recomendación: comer cerca del camino hacia Kyoto Station; ramen; udon/soba; curry; donburi; teishoku rápido. No reservar restaurante para esta comida. \n\n\n**Alternativa:** Comprar bento/ekiben en Kyoto Station si vamos justos." },
      { time: "13:45–14:00", text: "🚶 Traslado a Kyoto Station." },
