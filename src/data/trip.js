...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "10:45–11:15", text: "🧳 ENVIAR EQUIPAJE A TSUMAGO -- ⚠️ No es un locker donde recoges en el mismo sitio: es un servicio real de transporte entre las dos oficinas de turismo (Magome y Tsumago). Dejáis las maletas en la oficina de Magome, el propio servicio las traslada en furgoneta durante el día, y las recogéis en la oficina de Tsumago por la tarde -- vosotros nunca las cargáis durante la caminata.\n\nHorario de entrega en Magome: 08:30–11:30. Recogida en Tsumago: a partir de la 13:00 (normalmente hasta las 17:00). Servicio de temporada, activo del 20 de marzo al 30 de noviembre, así que en septiembre funciona con normalidad.\n\n💰 **Precio: no confirmado con certeza.** Las fuentes discrepan entre ¥500 y ¥1.000 por maleta -- confirmar el precio exacto al dejarla en el mostrador de Magome, y llevar efectivo suficiente para cualquiera de las dos cifras.\n\n⚠️ **IMPORTANTE:**\nLlegamos a las 10:45, hay tiempo para dejarlo antes de las 11:30. Llevar durante la caminata únicamente una mochila pequeña con agua, documentación, móvil, batería y dinero. NO llevar maletas grandes durante la ruta (el sendero tiene piedras y desnivel)." },
