...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "🍜 CENA EN KYOTO STATION", text: "Cena fácil en Kyoto Station. Después del viaje, no complicarse con una cena larga. Kyoto Station es la mejor zona para cenar esta primera noche. Opciones: ramen; udon/soba; curry japonés; donburi; ekiben/bento si estamos cansados. Opción concreta: Kyoto Ramen Koji, en la planta 10 de Kyoto Station, es una opción sencilla para probar ramen sin desplazarnos lejos del hotel. Horario aproximado 11:00–22:00. Alternativa rápida: comprar un bento/ekiben dentro de Kyoto Station." },
