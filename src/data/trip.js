...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      { time: "09:00", text: "🧳 **ÚLTIMAS COMPRAS, MALETA Y CHECK-OUT.** Última mañana con margen antes del traslado al aeropuerto:\n\n• Últimas compras de última hora por la zona del hotel (farmacias, Kappabashi-dori para menaje de cocina o las réplicas de comida de plástico, o cualquier cosa pendiente).\n• Preparar y cerrar las maletas con calma.\n• Check-out en la recepción del KOKO HOTEL Residence Asakusa Kappabashi.\n\n💡 Como está todo a mano en el propio barrio, no hace falta transporte para esto -- margen de sobra antes de salir hacia Narita." },
