...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "07:15", text: "🍙 Salida del hotel. Desayuno en un konbini cercano (Lawson o 7-Eleven, el que quede más a mano) de camino hacia la parada de bus — en vez del buffet del hotel." },
      { time: "07:15–08:15", text: "🚌 Hacia Ginkaku-ji. Desde el Hotel Keihan Kyoto Hachijoguchi caminar hasta Kyoto Station (parando en el konbini para el desayuno). Tomar el Kyoto City Bus nº 5 o nº 7 con destino hacia Ginkaku-ji y bajar en Ginkakuji-michi.\n\n🎫 **SUICA:** ✅ SÍ; pasar tarjeta por el lector del bus al subir/bajar.\n\nCon la salida más temprana hay margen de sobra para el desayuno y el trayecto (35–45 min de bus) sin prisas, llegando justo cuando abre Ginkaku-ji. Alternativa si el tráfico es malo: usar metro + bus según Google Maps/Navitime en ese momento. Pago: No reservar. Usar Suica. También se puede comprar billete sencillo." },
