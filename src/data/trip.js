...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "07:45–08:00", text: "🚆 JR Nara Line: Kyoto Station → Inari Station (aprox. 5 min). No requiere reserva; utilizar IC card o billete sencillo." },
      { time: "08:00–10:15", text: "Santuario Fushimi Inari. No es necesario subir hasta la cima del monte Inari; recorrido flexible según energía y tiempo." },
      { time: "10:20–10:30", text: "🚆 JR Nara Line: Inari → Nara. Tren LOCAL directo, sin transbordo, aproximadamente 50–55 min. No requiere reserva. Importante: no todos los trenes de la línea paran en Inari; utilizar un servicio Local." },
      { time: "11:30–12:30", text: "🏯 Todai-ji y Gran Buda." },
      { time: "12:30–14:00", text: "🦌 Parque de Nara y ciervos." },
      ...
      { time: "15:45–16:15", text: "🚆 JR Nara → Kyoto. Coger el siguiente servicio conveniente; no es necesario reservar." },
      { time: "17:00–18:30", text: "🌇 Paseo por Pontocho, Kamogawa, Miyagawacho y Gion. El atardecer será aproximadamente sobre las 18:15, por lo que esta franja permite disfrutar también de la hora azul. Yasaka Jinja puede visitarse opcionalmente si vamos bien de tiempo." },
      { time: "🎫", text: "Reservas: no es necesario reservar por adelantado ninguno de los trenes de este día. Kyoto → Inari, Inari → Nara y Nara → Kyoto son trayectos de JR regionales. Utilizar IC card o comprar billete en la estación." }
    ],
  ...
  },
  {
    ...
    schedule: [
      { time: "07:30", text: "Despertar y desayuno." },
      { time: "08:00", text: "Salida del hotel." },
      { time: "08:00–09:00", text: "🚇 Transporte hacia Kinkaku-ji: Línea Karasuma desde Kyoto Station hasta Kitaoji Station y después bus 204/205 hasta Kinkakuji-michi. Evitar el bus 205 directo desde Kyoto Station porque suele sufrir congestión." },
      { time: "09:00–10:00", text: "🏯 Kinkaku-ji (Pabellón Dorado). Llegar a la apertura para evitar las mayores aglomeraciones. La visita es relativamente corta; reservar aproximadamente 60 minutos. 💡 Consejo: ir a primera hora. El recorrido es de sentido único y el pabellón se contempla desde el exterior; no se puede entrar en el edificio." },
      { time: "10:00–10:20", text: "🚶 Kinkaku-ji → Ryoan-ji por Kinukake-no-Michi (~18 min)." },
      { time: "10:20–11:20", text: "🪨 Ryoan-ji. Visita del famoso jardín karesansui y del recinto." },
      { time: "11:20–11:35", text: "🚶 Ryoan-ji → Ninna-ji por Kinukake-no-Michi (~11 min)." },
      { time: "11:35–12:30", text: "🏯 Ninna-ji. Visita del complejo principal. En septiembre abre a las 09:00." },
      { time: "12:30–13:00", text: "🚋 Randen desde Omuro-Ninnaji hasta Arashiyama. Trayecto aproximado de 20–30 min según conexión. No requiere reserva; pagar con IC card cuando sea posible. 🍜 Comida rápida al llegar a Arashiyama." },
      { time: "13:30–14:00", text: "🚕/🚌 Subida hacia Saga-Toriimoto. Si estamos cansados, utilizar taxi para ahorrar tiempo y evitar la subida." },
      { time: "14:00–14:45", text: "🏯 Adashino Nenbutsu-ji y distrito histórico de Saga-Toriimoto. El templo es famoso por sus numerosas estatuas de piedra y se encuentra en la ruta hacia la zona de Otagi. La visita debe hacerse antes de continuar bajando hacia el bosque de bambú." },
      { time: "14:45–15:45", text: "🚶 Descenso por Saga-Toriimoto → bosque de bambú → centro de Arashiyama. Priorizar el recorrido por las calles tradicionales de Saga-Toriimoto y después el Bamboo Grove. 💡 El bosque de bambú estará bastante concurrido incluso por la tarde. No intentar dedicarle demasiado tiempo: el atractivo principal es recorrerlo y continuar hacia el centro de Arashiyama." },
      { time: "Opcional", text: "Si vamos bien de tiempo: Tenryu-ji o paseo hasta el puente Togetsukyo." },
      { time: "17:00", text: "🚆 Regreso a Kyoto en JR desde Saga-Arashiyama, Línea San-In (Sagano Line), directo. Trayecto aproximado 15–20 min. No requiere reserva." },
      { time: "🎫 RESERVAS", text: "No es necesario reservar por adelantado ninguno de los transportes de este día ni las visitas principales. Kinkaku-ji, Ryoan-ji, Ninna-ji y Adashino Nenbutsu-ji se visitan comprando la entrada allí. El Randen y los trenes JR son servicios regionales sin reserva de asiento." },
      { time: "⚠️ IMPORTANTE", text: "Otagi Nenbutsu-ji queda fuera de este día porque el miércoles 9 de septiembre está cerrado. Si queremos visitarlo durante el viaje, habrá que moverlo a otro día que no sea miércoles ni sábado." }
    ],
    money: "Aprox. 40€ (comidas)",
  },
  {
