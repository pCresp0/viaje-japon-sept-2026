...
export const flights = {
  ...
  back: {
    ...
    label: "Vuelta",
    date: "2026-09-21",
    text: "Salida Lun 21 sept desde Narita (Terminal 2) a las 17:25 (Qatar Airways QR809). Escala en Doha de 2h 50m (22:20 → 01:10). Llegada a Madrid (T4S) el Mar 22 sept a las 07:35.",
    ...
    leg2: {
      ...
      depTime: "01:10",
      arrTime: "07:35",
      trackUrl: "https://www.google.com/search?q=vuelo+IB6952",
    },
    trackUrl: "https://www.google.com/search?q=vuelo+QR809",
    ...
    options: [
      {
        ...
        total: "669,86€",
        paid: true,
        paidBy: "Juancar (Booking · 1 sept 2026)",
        ...
        note: "✅ Ya pagado por Juancar vía Booking (669,86€ · ~133,97€/persona). A pagar en el hotel únicamente la tasa turística de Kioto si aplica. No incluye comidas.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        onsen: { has: false },
        note: "✅ Ya pagado por Juancar vía Booking (161,89€ · ~32,38€/persona). No incluye comidas.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        note: "✅ Ya pagado por Juancar vía Booking (274,98€ · ~55,00€/persona). Check-out temprano (10:00). No incluye comidas.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        note: "⚠️ PENDIENTE DE PAGO EN EL HOTEL EN EFECTIVO: Se debe pagar allí en el hotel en metálico / yenes (aprox. ¥32.000 / ~178,98€ grupo · ~35,80€/persona). Hay que sacar dinero en efectivo previamente (en konbini/cajero). Cena casera a hora fija (~18:00). NO incluye desayuno.",
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        guests: "5 adultos",
        onsen: { has: false },
        note: "✅ Ya pagado por Juancar vía Booking (1.927,13€ · ~385,43€/persona). Residencia / apartamento completo para 6 noches.",
      },
    ],
  },
];
...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      { time: "07:30", text: "Despertar. 🍳 Desayuno en el hotel a las 07:00. Kiyomizu-dera abre muy temprano, por lo que no conviene retrasar la salida.\n\n⚠️ **RECORDATORIO IMPORTANTE DE HOY:** Durante el día de hoy (al pasar por Kyoto Station a mediodía o al volver de Osaka) debemos **recoger los billetes físicos** del tren Thunderbird a Kanazawa del día siguiente en las máquinas verdes 5489 con la tarjeta física Mastercard (terminada en 8625)." },
      ...
      { time: "13:00–14:15", text: "🥟 **COMIDA: CHAO CHAO GYOZA - SANJO KIYAMACHI** (https://maps.app.goo.gl/ScXREEXfRmmTKcj88?g_st=ic)\n\n浪花ひとくち餃子 餃々 三条木屋町店 — restaurante izakaya de gyozas muy bien valorado (4,6★, +2700 reseñas), junto a Kiyamachi, a un paseo de la estación de Sanjo. Aprox. ¥1.000–2.000/persona. No requiere reserva.\n\n💡 Recomendación de otros visitantes: las gyozas de chocolate con helado de postre." },
      { time: "14:15–14:20", text: "🚶 Caminar hasta la estación de Sanjo (Keihan). Apenas 200 m, unos 3 min." },
      { time: "~14:45", text: "🚆 SANJO → OSAKA (Temmabashi).\n\n🎫 **SUICA:** ✅ SÍ; pasar la tarjeta directamente por los tornos.\n\nKeihan Electric Railway, línea principal (Keihan Main Line), Limited Express dirección Yodoyabashi. Trayecto de 8 paradas, aproximadamente 47 min. Tarifa aprox. ¥490. Sin reserva. Esta línea Keihan (no es JR) conecta directamente el centro de Kioto con el corazón de Osaka.\n\n🎧 **Podcast para el trayecto:** [Osaka: gastronomía, ambiente y diversión](https://podcasts.apple.com/es/podcast/jap%C3%B3n-a-fondo/id1545542012?i=1000516234185) (*Japón a fondo* · Japonismo). Ideal para sumergirse en la cultura del 'kuidaore' (comer hasta arruinarse), Dotonbori y el ambiente callejero durante el viaje en tren." },
      { time: "~16:00–16:20", text: "🎫 **RECOGIDA DE BILLETES FÍSICOS JR-WEST (EN OSAKA STATION)**\n\nAprovechando la parada en Osaka, se recogen en las máquinas verdes 5489 los billetes físicos de DOS reservas:\n- 🚆 Thunderbird 5 Kyoto → Tsuruga (mañana, 12 de septiembre), localizador **47932**.\n- 🚆 Shinano 4 Nakatsugawa → Nagoya (15 de septiembre), localizador **42093**.\n\nAmbas se canjean con la misma tarjeta de crédito física (Mastercard terminada en 8625) y el mismo PIN de 4 dígitos. Con esto, ya no hace falta volver a pasar por ninguna máquina 5489 para estas dos reservas el resto del viaje." },
      { time: "~16:20–17:00", text: "🚶 OSAKA STATION → OSAKA CASTLE. Caminar hasta el castillo." },
      { time: "17:00–18:10", text: "🏯 OSAKA CASTLE. \n\n⚠️ **IMPORTANTE — visita comprimida:**\nCon la llegada sobre las 17:00, el Museo del Castillo de Osaka (abre 09:00–18:00, última entrada 17:30) deja muy poco margen: apenas 30 min antes de la última entrada, y cierre total a las 18:00. Si se quiere entrar al interior, entrar cuanto antes y priorizar el mirador de arriba; si se prefiere no ir con prisas, quedarse solo con el exterior (murallas, foso, parque) y guardar el interior para otra ocasión. Entrada: ¥1.200 (~7,5€) adulto. Se puede pagar con efectivo, tarjeta e Suica." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "10:05", text: "Llegada a Shirakawa-go. Disponemos de aproximadamente 3 h 10 min (hasta la salida del bus a Takayama a las 13:15).\n\n🗺️ Ruta completa de Shirakawa-go: https://maps.app.goo.gl/mBcF6hHWpwwC5HxeA?g_st=iw\n\n🔒 **TAQUILLAS PARA LAS MOCHILAS:** La propia Terminal de Shirakawa-go tiene taquillas de monedas (18 en total) justo detrás/al lado del edificio principal — pequeñas/medianas ¥500, grandes ¥1.000, horario 08:00–17:00. Si están todas ocupadas, se puede pedir en el mostrador de información que guarden el equipaje manualmente." },
      { time: "10:05–11:55", text: "🌉 Cruzar el **Puente Deai** (la entrada icónica al pueblo) y subir andando al **Mirador Shiroyama** (15-20 min, cuesta suave asfaltada; alternativa shuttle ¥200-300). Subirlo ahora, nada más llegar, porque hacia las 11:30 el pueblo se llena bastante.\n\nBajar y pasear por **Ogimachi**: canales, arrozales, calles tradicionales. Terminar con la visita a **Wada House** (única casa a visitar, la más grande y mejor conservada, ¥400, sin reserva, 09:00–17:00, 3-4 min de la terminal)." },
      ...
      { time: "15:40–16:20", text: "🏛️ **TAKAYAMA JINYA** (高山陣屋). Único edificio de gobierno del periodo Edo que se conserva íntegro en Japón. La visita interior suele durar unos 30 minutos; intentad entrar antes de las 16:00 (cierra a las 17:00, última entrada 16:30, entrada ¥430)." },
      { time: "16:20–17:30", text: "🍶 **SANMACHI SUJI + PUENTE NAKABASHI.** Las tres calles históricas (Ichinomachi, Ninomachi, Sannomachi): tiendas de sake con catas (¥100/copa), artesanía de madera, sarubobo. Cruzar también el **Puente Nakabashi**, el icónico puente rojo." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "14:00–15:00", text: "🍜 **COMIDA: NIKUJIRU GYOZA DANDADAN KAPPABASHI.** Gyoza jugosos hechos a mano, cocinados a la vista en plancha especial -- también tienen fideos, ensaladas y alitas de pollo. En pleno Kappabashi, a solo 6 min andando del hotel.\n\nhttps://maps.app.goo.gl/6u6EkzqoowquijNY8?g_st=ic" },
      { time: "15:00–16:15", text: "🚶 Caminar hasta el hotel (6 min).\n\n🏨 **CHECK-IN: KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (https://maps.app.goo.gl/ccK7MTfGL6HJXFf76?g_st=ic)\n\n✅ Hotel ya pagado (1.927,13€ vía Booking · 6 noches).\n\nCheck-in (oficial desde las 15:00), 1 hora aproximadamente para dejar las maletas, deshacer un poco el equipaje y ducharnos tras el día entero de trenes.\n\nDirección: 3-24-2 Nishi-Asakusa, Taito-ku.\n\n🧳 **Las 5 maletas grandes enviadas desde Kioto (Takkyubin/Yamato):**\n- Nº de seguimiento: **753-3690-9535**.\n- Entrega programada: **15/09, franja de mañana (AM)** — es decir, deberían haber llegado al hotel ANTES de que lleguéis vosotros. Al hacer el check-in, preguntar en recepción si ya las tienen guardadas.\n- Recibo a nombre de Juan Carlos R., remitente Hotel Keihan Kyoto Hachijoguchi.\n- 5 bultos (品名: Clothes), coste total ¥13.060 (ya pagado en el hotel de Kioto al despacharlas)." },
      ...
      { time: "19:30–21:00", text: "🍜 **CENA: ASAKUSA MONJA MONRO** (recomendación de amiga quesito de Thibaut). Monjayaki y teppanyaki cocinados delante de vosotros por el propio personal -- especialidad de la casa con marisco de los mercados de Tsukiji/Toyosu. Muy bien valorado (top 5 de Asakusa en reseñas). Puede haber algo de espera, pero merece la pena. A pocos minutos del hotel." },
  ...
  },
  {
    ...
    summary:
      "Excursión de día completo con reserva CONFIRMADA (GetYourGuide GYGX7M7NZBNL): Parque Oishi, lago Kawaguchiko, Oshino Hakkai y la icónica Pagoda Chureito, con guía en inglés. Por la noche, paseo opcional por el Senso-ji iluminado, a un paso del hotel.",
    history:
  ...
  },
  {
    ...
    summary:
      "Día intenso: cruce de Shibuya y cultura juvenil de Harajuku, con parada en el Pokémon Center Shibuya (con su famosa estatua de Mewtwo a tamaño real). Terminamos bajo los neones de Shinjuku con sus callejones gastronómicos. Thibaut, aprovecha para cortarte el pelo, que aunque no sea tan barato como en España, igual es mejor que en Francia.",
    history:
    ...
    schedule: [
      ...
      { time: "17:30", text: "Noche en Shinjuku: paseo bajo los neones de Kabukicho.\n\n🍜 **CENA: OPCIONES DE LA ZONA.**\n• **Omoide Yokocho**: el clásico callejón de yakitori, ambiente típico de yokocho.\n• **Okinawa Paradise** (recomendación de amiga quesito de Thibaut): en la 3ª planta de un edificio en Kabukicho (poco visible desde la calle, hay que buscarlo), cocina okinawense y música en vivo de canciones tradicionales casi todas las noches sobre las 21:00. Muy poco turístico. Conviene reservar, sobre todo en fin de semana.\n\n🛍️ **COMPRAS: UNIQLO Y DON QUIJOTE (RELOJ SEIKO).** Aprovechar la zona para dos paradas rápidas: hay un Uniqlo grande cerca de la Estación de Shinjuku (ropa básica de calidad a buen precio), y el Don Quijote de Kabukicho tiene una sección de relojes en la planta de arriba (4ª planta) con Seiko, Citizen y Casio a precios rebajados -- confirmado por varias fuentes como una de las mejores del centro de Tokio para esto. Ambos abiertos hasta tarde, encajan bien con el paseo nocturno." },
      { time: "~20:15", text: "🚇 **VUELTA A SHIBUYA, PARA VERLO DE NOCHE.** Solo 2 paradas desde Shinjuku por la línea JR Yamanote (o Saikyo Line), sin transbordo -- unos 10 min de trayecto. Compensa totalmente: el cruce de Shibuya de noche, con todas las pantallas gigantes de neón encendidas sobre los edificios, es una imagen completamente distinta a la de esta mañana y uno de los mejores planes nocturnos de Tokio." },
      { time: "20:30–21:15", text: "🌃 **SHIBUYA DE NOCHE.** Volver al cruce para verlo iluminado -- es cuando de verdad se entiende por qué es tan icónico. Buen momento también para fotos desde el Starbucks del Tsutaya (2ª planta, vistas directas al cruce) o desde el mirador gratuito del Shibuya Scramble Square (planta baja, hay una zona con vistas sin pagar la entrada del Sky)." },
      { time: "~21:30", text: "🏨 **REGRESO AL HOTEL: KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (https://maps.app.goo.gl/ccK7MTfGL6HJXFf76?g_st=ic)\n\nRegreso en metro desde Shibuya a nuestra residencia en Asakusa Kappabashi para descansar (3ª noche en Tokio)." },
    ],
    money: "Aprox. 40€ (comidas)",
  },
  {
    ...
    summary:
      "Mañana con 3 opciones a elegir para la primera parada (Zoo de Ueno, Toyosu sin sushi, o mercado exterior de Tsukiji), seguido del parque de Ueno y el mercadillo de Ameyoko. Por la tarde, tren futurista sin conductor hacia Odaiba para el atardecer sobre la bahía de Tokio.",
    history:
    ...
    schedule: [
      ...
      { time: "14:30–15:15", text: "🤖 **DIVERCITY TOKYO PLAZA.** Centro comercial junto a la estación de Odaiba-Kaihinkoen. Aquí estaba la estatua del Unicorn Gundam a tamaño real -- pero ⚠️ **YA NO ESTÁ**: la web oficial anunció el final de su exhibición pública el 31 de agosto de 2026, justo antes de vuestro viaje, y a fecha de esta actualización no hay confirmación de una sustituta. Aun así merece la pena entrar a **Gundam Base Tokyo**, la tienda oficial de 3 plantas con todo el merchandising y kits Gunpla, y el resto de tiendas del centro comercial." },
      { time: "15:15–16:00", text: "🛍️ **AQUA CITY ODAIBA.** Centro comercial junto al mar, a 5 min andando de DiverCity. Buenas vistas del Rainbow Bridge desde su terraza, y una réplica a escala 1/4 de la Estatua de la Libertad justo al lado (la razón: estuvo aquí prestada por Francia entre 1998 y 1999, y la réplica se quedó como recuerdo permanente)." },
      { time: "16:00–16:45", text: "🌊 **PARQUE MARÍTIMO DE ODAIBA (ODAIBA KAIHIN KOEN).** Paseo por la playa artificial y el malecón, con las mejores vistas abiertas del Rainbow Bridge y el skyline de Tokio al fondo -- el sitio perfecto para hacer tiempo antes del atardecer sin prisa." },
      { time: "16:45–17:45", text: "🌇 **ATARDECER DESDE EL PASEO MARÍTIMO.** El sol se pone sobre las **17:45-17:50** en estas fechas (más pronto de lo que parece) -- conviene estar ya instalados en el malecón desde eso de las 17:15-17:30 para no perderse el cambio de luz. Con el Rainbow Bridge y la bahía de fondo, es de los mejores atardeceres del viaje." },
      { time: "17:45–18:00", text: "Recoger y encaminarse hacia la estación de Odaiba-Kaihinkoen." },
      { time: "~18:00–18:45", text: "🚇 **VUELTA HACIA ASAKUSA.** Yurikamome hasta Shimbashi + transbordo a la línea Ginza (o Asakusa) -- un solo cambio, unos 40-45 min en total." },
      { time: "18:45–20:00", text: "🛍️ **UNIQLO ASAKUSA STORE.** Compras hasta el cierre a las 20:00 -- más de una hora por delante.\n\nhttps://maps.app.goo.gl/uAJszQKRPMjwdudx5?g_st=ic" },
  ...
  },
  {
    ...
    cities: "Nikko",
    summary:
      "Día completo de naturaleza y templos a 2 horas de Tokio en tren directo desde Asakusa (literalmente al lado del hotel): el santuario Toshogu, mausoleo del shogun Tokugawa Ieyasu y Patrimonio de la Humanidad, el Puente Shinkyo, y si el tiempo acompaña, las cataratas Kegon y el lago Chuzenji por la carretera de montaña Irohazaka.",
    history:
      "Nikko se desarrolló en torno al santuario Toshogu, construido en 1617 como mausoleo de Tokugawa Ieyasu, fundador del shogunato que gobernó Japón durante más de 250 años. Su nieto Iemitsu lo amplió hasta convertirlo en el complejo profusamente decorado que se ve hoy, con más de 5 millones de hojas de pan de oro repartidas entre sus edificios.",
    schedule: [
      { time: "06:45", text: "Despertar y desayuno rápido en el hotel." },
      { time: "07:15", text: "Hacia la Estación de Tobu-Asakusa (misma zona que el hotel, apenas unos minutos andando)." },
      { time: "~07:30", text: "🚅 Tobu Limited Express hacia Tobu-Nikko Station.\n\n🎫 **SUICA:** ❌ NO (requiere billete expreso con plaza)\n📅 **RESERVA:** 🔴 PENDIENTE DE COMPRAR -- recomendado el **Tobu World Heritage Pass** (~¥4.160/persona ≈ 22,60€), que incluye ida y vuelta en Tobu Limited Express MÁS autobuses ilimitados por Nikko durante 2 días -- ese bus es justo el que hace falta para llegar al lago Chuzenji y las cataratas Kegon, así que sale más a cuenta que pagar tren y bus por separado.\n📅 **COMPRA:** En las máquinas o taquillas de Tobu Asakusa Station, o con antelación en la app/web de Tobu Railway. Al ser sábado (más gente que entre semana), conviene comprarlo con unos días de margen para asegurar los 5 asientos juntos.\n\nTrayecto de aproximadamente 2 horas." },
      { time: "~09:30", text: "Llegada a Tobu-Nikko Station. Recogida de folletos/mapa en el centro de turismo de la estación." },
      { time: "10:00–13:00", text: "🏯 **SANTUARIO TOSHOGU Y ALREDEDORES.** Puente Shinkyo (el puente rojo icónico sobre el río Daiya, símbolo de Nikko). Complejo de Toshogu: la puerta Yomeimon profusamente decorada, el relieve del 'mono que no ve, no oye, no habla', y el mausoleo de Tokugawa Ieyasu. Rinno-ji y Futarasan Jinja, los otros dos templos del conjunto Patrimonio de la Humanidad.\n\n🎫 Entrada combinada Toshogu + Futarasan + Taiyuin: aprox. ¥2.100/persona (≈11,40€). Solo Toshogu: aprox. ¥1.600/persona. No se puede reservar -- se paga in situ.\n\n💡 Requiere subir muchos escalones y caminar por suelo irregular -- calzado cómodo imprescindible." },
      { time: "13:00–14:00", text: "🍜 Almuerzo local: probar el yuba (piel de tofu), especialidad de Nikko desde hace siglos, en cualquiera de los restaurantes cerca de la entrada al santuario." },
      { time: "14:00–17:00", text: "🚌 **OPCIONAL SI HAY TIEMPO: LAGO CHUZENJI Y CATARATAS KEGON.** Autobús desde Tobu-Nikko Station por la carretera de montaña Irohazaka (curvas muy pronunciadas, vistas espectaculares) hasta el lago Chuzenji, a los pies del monte Nantai -- incluido en el Tobu World Heritage Pass. Las cataratas Kegon, de 97 m de caída, están a un paseo del lago; se ven bien de forma gratuita desde la plataforma superior, o se puede bajar en ascensor a la plataforma inferior para verlas de cerca (entrada aprox. ¥570 ≈ 3,10€, no reservable, se paga in situ).\n\n💡 Si el grupo prefiere no alargar tanto el día, se puede saltar este bloque y quedarse más tiempo tranquilo en la zona de Toshogu, o pasear por el centro de Nikko." },
      { time: "~17:30", text: "Regreso en autobús a Tobu-Nikko Station." },
      { time: "~18:00", text: "🚅 Tobu Limited Express de vuelta hacia Tobu-Asakusa Station (aprox. 2 horas)." },
      { time: "~20:00", text: "🍜 Cena por Nakano o Asakusa." },
      { time: "~21:30", text: "🏨 **REGRESO AL HOTEL: KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (https://maps.app.goo.gl/ccK7MTfGL6HJXFf76?g_st=ic)\n\nRegreso a la residencia para descansar y preparar el día de mañana: Ruta Nintendo, Ikebukuro y Akihabara, último día completo antes de volver (5ª noche en Tokio)." },
    ],
    money: "Aprox. 74€/persona en total (40€ comidas + 11,40€ entradas Toshogu + 22,60€ Tobu World Heritage Pass) -- 🔴 el Pase de Tobu está PENDIENTE DE COMPRAR; ascensor a Kegon opcional aparte (~3,10€/persona).",
  },
  {
    num: 14,
    date: "2026-09-20",
    ...
    summary:
      "Día de coleccionismo y videojuegos: Mega Pokémon Center de Ikebukuro (con sus estatuas de Mewtwo, Charizard y Lucario a tamaño real) y Nintendo Store Tokyo. Después, Nakano Broadway, el mejor lugar de Tokio para cartas Pokémon originales, figuras de Dragon Ball y artículos retro/frikis a precio justo, y Akihabara, el barrio otaku por excelencia -- ideal para los regalos de los amigos. Cierre del viaje por todo lo alto: subida al Tokyo Skytree para ver el atardecer, y cena de despedida del grupo, en el último día completo antes de volver a España.",
    history:
    ...
    schedule: [
      { time: "10:00", text: "Mega Pokémon Center Ikebukuro (Sunshine City, 2ª planta) y Nintendo Store Tokyo. El Mega Center es el más grande de Japón: estatuas a tamaño real de Charizard, Lucario y Mewtwo, la Pokémon Card Station, y merchandising exclusivo que no se encuentra en otras tiendas." },
      { time: "~12:00", text: "🚃 Tren a Nakano. Comida por la zona antes de empezar a visitar." },
      { time: "12:30–15:00", text: "Tarde de compras de coleccionismo en Nakano Broadway: el mejor sitio de Tokio para cartas Pokémon originales (tiendas especializadas de trading cards con vitrinas de piezas sueltas y sobres), figuras y merchandising de Dragon Ball, y artículos retro/manga en general a precio justo. Varias plantas de tiendas pequeñas independientes -- merece la pena recorrerlas todas.\n\n🛍️ **NAKANO SUN MALL** (recomendación de amiga quesito de Thibaut): la galería comercial cubierta que lleva justo desde la estación hasta la entrada de Nakano Broadway (~5 min andando) -- confirmado geográficamente, es el camino natural. Mucho menos turística que Akihabara, con restaurantes e izakayas de ambiente más local.\n\n🚃 Después, tren a Akihabara." },
      { time: "15:30–16:30", text: "🎮 **AKIHABARA**, el barrio otaku por excelencia -- distinto de Nakano Broadway, aquí es más experiencia de calle y tiendas grandes especializadas que colecciones de segunda mano.\n\n• Mandarake Complex: 8 plantas de manga, figuras y coleccionismo de todas las épocas.\n• Super Potato: videojuegos retro (NES, SNES, Game Boy...) en un ambiente que parece sacado de los 90.\n• Tiendas oficiales de Pokémon (Pokémon Center TOKYO-BAY no está aquí, pero sí varias tiendas de trading cards especializadas).\n• Arcades japoneses (Taito Station, GiGO) para partidas de UFO catcher, ritmo o lucha.\n• Calle principal (Chuo-dori), cerrada al tráfico los domingos por la tarde -- hoy es domingo, así que debería aplicar.\n\n💡 Akihabara está a un salto de Asakusa (~10-15 min) -- se cierra aquí el día de compras porque es la parada más cercana a casa, camino del Skytree y la cena." },
      { time: "~16:45", text: "🚃 Tren corto hacia Asakusa/Skytree (~10-15 min desde Akihabara)." },
      { time: "17:00–19:00", text: "**ELEGIR UNA DE ESTAS 2 OPCIONES PARA CERRAR EL VIAJE POR TOKIO:**\n\n**Opción A — 🗼 Subida al Tokyo Skytree con entradas, para ver el atardecer.** El sol se pone sobre las ~17:50 en septiembre -- con la entrada a las 17:00 hay tiempo de sobra para instalaros arriba antes de que empiece a caer. Cierre perfecto del viaje: la última tarde en Tokio, viendo la ciudad entera desde arriba.\n\n🎟️ Comprar las entradas allí mismo o con antelación por la web oficial (recomendable si hay buena previsión de tiempo, los turnos de atardecer se agotan). Tembo Deck (350 m) es el mirador estándar; Tembo Galleria (450 m) es un extra sobre el anterior si os apetece subir aún más.\n\n**Opción B — 🛍️ Últimas compras pendientes.** Si preferís aprovechar el tiempo en vez de subir a un mirador: Uniqlo Asakusa Store (por si falta algo tras la visita de ayer), y la zona de souvenirs de Kappabashi-dori (menaje de cocina, réplicas de comida de plástico, cuchillos japoneses) o Nakamise-dori junto al templo Senso-ji, clásica para regalos de última hora -- todo a poca distancia del hotel." },
      { time: "20:00", text: "🍜 **CENA DE DESPEDIDA: HIMURO HOKKAIDO RAMEN ASAKUSA.** Muy muy top y barato -- confirmado por el grupo. En el último día completo antes de volver a España.\n\nhttps://maps.google.com?q=Himuro%20Hokkaido%20Ramen%20Asakusa,%202%20Chome-1-11%20Nishiasakusa,%20Taito%20City,%20Tokyo%20111-0035,%20Jap%C3%B3n&ftid=0x60188f70d778df93:0xdcb74fed22702d18&entry=gps&shh=CAE&lucs=,94297699,94231188,94280568,47071704,94218641,94282134,100835699,94286869,100820247,100822504&g_st=ic" },
      { time: "20:30", text: "🎲 Noche de juegos de mesa -- cierre perfecto para la última noche juntos en Tokio." },
      { time: "~21:30", text: "🏨 **REGRESO AL HOTEL: KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (https://maps.app.goo.gl/ccK7MTfGL6HJXFf76?g_st=ic)\n\nÚltima noche en Tokio antes de volver a España." },
    ],
    money: "Aprox. 40€ (comidas, incluye cena de despedida) + compras + entrada al Skytree si se elige esa opción",
  },
  {
    num: 15,
    date: "2026-09-21",
    ...
    schedule: [
      { time: "09:00", text: "🏮 **VISITA DE VERDAD A ASAKUSA Y SENSŌ-JI** (no como plan B de otro día -- última mañana, con tiempo y las tiendas ya abiertas).\n\n• **Puerta Kaminarimon**: la gran linterna roja, entrada icónica al recinto del templo.\n• **Calle Nakamise**: casi 200 metros de tiendecitas tradicionales -- dulces, artesanía, souvenirs, abanicos, yukata -- hasta la puerta del templo. Ideal para las últimas compras (Kit-Kats de sabores, matcha).\n• **Templo Sensō-ji**: el templo budista más antiguo de Tokio (año 628), con el gran incensario y el salón principal.\n• Paseo tranquilo por las callejuelas tradicionales alrededor, antes de volver al hotel.\n\n🍽️ **KAPPABASHI DORI** (recomendación de amiga quesito de Thibaut): la calle dedicada por completo al mundo de la cocina, literalmente al lado de vuestro hotel (está en el propio barrio, Nishi-Asakusa). El sitio para llevaros cerámica japonesa de verdad, y también las famosas réplicas de comida de plástico (sampuru) -- una curiosidad muy típica de Japón, aunque no sea para todos los gustos. Se puede añadir sin necesidad de transporte, extendiendo el mismo paseo de esta mañana.\n\n💡 Como el hotel está a solo 10 min andando, no hace falta ningún transporte para esto -- se puede volver a por el equipaje con calma antes del traslado al aeropuerto." },
      ...
      { time: "17:25", text: "Vuelo QR809 Narita → Doha (Qatar Airways, 10h 55m · 17:25 → 22:20). Seguimiento: https://www.google.com/search?q=vuelo+QR809. Escala en Doha de 2h 50m (22:20 → 01:10), luego vuelo QR6952 Doha → Madrid (Qatar Airways / Iberia, 7h 25m · 01:10 → 07:35). Seguimiento: https://www.google.com/search?q=vuelo+IB6952. Llegada a Madrid (T4S) el mar 22 sept a las 07:35." },
    ],
    money: "Aprox. 40€ (comidas)",
  },
];
...
export const budget = {
  people: 5,
  note: "Vuelos, 4 de 5 hoteles (vía Booking) y trenes principales ya confirmados y pagados. Excursiones Fuji + estimados urbanos pendientes.",
  categories: [
    {
      ...
      details: [
        ...
        "Vuelta: QR809 NRT→DOH + QR6952 DOH→MAD (21 sept, 17:25 → 22 sept, 07:35, 21h 10m).",
    ...
    },
    {
      ...
      total: "3.212,84€",
      details: [
        "<strong>✅ 4 de 5 hoteles ya pagados por Juancar en Booking (3.033,86€ grupo · 606,77€/persona)</strong>:",
        ...
        "<strong>⚠️ Pendiente de pagar en el hotel en efectivo</strong>:",
    ...
    },
    {
      ...
      total: "~225€ – 275€",
      details: [
        "<strong>GetYourGuide Monte Fuji (Día 10, 16 sept., confirmado):</strong> 42€/persona · 210€ grupo (Kawaguchiko, Parque Oishi, Oshino Hakkai, Pagoda Chureito). Ya pagado, sin necesidad de cancelar nada.",
        "<strong>Excursión a Nikko (Día 14, 20 sept.):</strong> Tobu Limited Express ida y vuelta, aprox. ¥2.700 (~17€) por persona cada trayecto, más entradas a Toshogu (~¥1.600–2.100/persona). Total aprox. 45€/persona.",
      ],
    },
    {
