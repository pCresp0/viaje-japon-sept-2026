...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "17:00–19:00", text: "🗼 **SUBIDA AL TOKYO SKYTREE CON ENTRADAS, PARA VER EL ATARDECER.** El sol se pone sobre las ~17:50 en septiembre -- con la entrada a las 17:00 hay tiempo de sobra para instalaros arriba antes de que empiece a caer. Cierre perfecto del viaje: la última tarde en Tokio, viendo la ciudad entera desde arriba.\n\n🎟️ Comprar las entradas allí mismo o con antelación por la web oficial (recomendable si hay buena previsión de tiempo, los turnos de atardecer se agotan). Tembo Deck (350 m) es el mirador estándar; Tembo Galleria (450 m) es un extra sobre el anterior si os apetece subir aún más." },
    ...
    money: "Aprox. 40€ (comidas, incluye cena de despedida) + compras + entrada al Skytree",
  },
  {
    num: 15,
    date: "2026-09-21",
