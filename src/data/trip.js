...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "12:45–13:30", text: "🤖 **DIVERCITY TOKYO PLAZA.** Centro comercial junto a la estación de Odaiba-Kaihinkoen. Aquí estaba la estatua del Unicorn Gundam a tamaño real -- pero ⚠️ **YA NO ESTÁ**: la web oficial anunció el final de su exhibición pública el 31 de agosto de 2026, justo antes de vuestro viaje, y a fecha de esta actualización no hay confirmación de una sustituta. Aun así merece la pena entrar a **Gundam Base Tokyo**, la tienda oficial de 3 plantas con todo el merchandising y kits Gunpla, y el resto de tiendas del centro comercial.\n\n🍜 Aprovechar también para comer algo por la zona (foodcourt de DiverCity o Aqua City)." },
      { time: "13:30–14:15", text: "🛍️ **AQUA CITY ODAIBA.** Centro comercial junto al mar, a 5 min andando de DiverCity. Buenas vistas del Rainbow Bridge desde su terraza, y una réplica a escala 1/4 de la Estatua de la Libertad justo al lado (la razón: estuvo aquí prestada por Francia entre 1998 y 1999, y la réplica se quedó como recuerdo permanente)." },
      { time: "14:15–15:00", text: "🔮 **FUJI TV BUILDING.** El edificio con la esfera plateada gigante que se ve desde toda la bahía, sede de la cadena Fuji TV -- diseño futurista del arquitecto Kenzo Tange (el mismo del Tocho de Shinjuku). Mirador de pago dentro de la esfera (~¥1.000, sin reserva, no depende del tiempo que haga) con vistas de 360° sobre Odaiba y la bahía; también hay zonas gratuitas con decorados de programas de la cadena." },
      { time: "15:00–15:45", text: "🌊 **PARQUE MARÍTIMO DE ODAIBA (ODAIBA KAIHIN KOEN).** Paseo por la playa artificial y el malecón, con las mejores vistas abiertas del Rainbow Bridge y el skyline de Tokio al fondo." },
      { time: "15:45–17:45", text: "🌇 **TIEMPO LIBRE -- DECIDIR SEGÚN EL TIEMPO QUE HAGA.** El sol se pone sobre las **17:45-17:50** en estas fechas.\n\n☀️ **Si está despejado:** merece la pena quedarse por la zona (más tiempo en Aqua City/DiverCity, o repetir en el malecón) y estar ya instalados junto al mar sobre las 17:15-17:30 para el atardecer -- con el Rainbow Bridge de fondo es de los mejores del viaje.\n\n☁️ **Si está nublado:** no hace falta esperar aquí sin necesidad -- no se va a ver gran cosa. Mejor volver antes hacia Asakusa y aprovechar la tarde-noche allí: más tiempo tranquilo en el Uniqlo (en vez de correr hasta las 20:00), un paseo por Senso-ji y Nakamise-dori con luz de día en vez de por la noche, o la zona de Kappabashi para souvenirs de cocina." },
      { time: "~17:45–18:00", text: "Recoger y encaminarse hacia la estación de Odaiba-Kaihinkoen (o antes, sobre las 16:00, si el cielo está nublado y se prefiere adelantar la vuelta)." },
      ...
      { time: "18:45–20:00", text: "🛍️ **UNIQLO ASAKUSA STORE.** Compras hasta el cierre a las 20:00 -- con margen de sobra, y mucho más si se ha vuelto antes por el tiempo nublado.\n\nhttps://maps.app.goo.gl/uAJszQKRPMjwdudx5?g_st=ic" },
