...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "Transporte", text: "🚌 Desde JR Nara Station → Tōdai-ji: Bus local de Nara Kotsu hasta la zona de Tōdai-ji Daibutsuden/Kasuga Taisha-mae y después unos minutos andando. Alternativa: taxi desde JR Nara Station si vamos justos de tiempo. También es posible ir andando, pero requiere más tiempo. No reservar por adelantado." },
      ...
      { time: "🎫", text: "RESERVAS: no es necesario reservar por adelantado ninguno de los trenes de este día. Todos los trayectos ferroviarios del día son servicios regionales/locales. Se pueden pagar sobre la marcha con IC card o mediante billete sencillo comprado en las máquinas de la estación. No tenemos Japan Rail Pass y no es necesario para este día." }
    ],
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "08:00–08:30", text: "🚌 Salida hacia Ginkaku-ji. Desde el Hotel Keihan Kyoto Hachijoguchi caminar hasta Kyoto Station. Tomar el Kyoto City Bus nº 5 o nº 7 con destino hacia Ginkaku-ji y bajar en Ginkakuji-michi. Duración aproximada: 35–45 min puerta a puerta, dependiendo del tráfico. Alternativa si el tráfico es malo: usar metro + bus según Google Maps/Navitime en ese momento. Pago: No reservar. Usar IC card. También se puede comprar billete sencillo." },
      ...
      { time: "11:00–13:15", text: "⛩️ Eikando + Nanzen-ji. Primero Eikando y después Nanzen-ji. Eikando: Entrada aproximadamente ¥1.000. En temporada normal abre 09:00–17:00. No requiere reserva. Llevar una bolsa para los zapatos. Nanzen-ji: En septiembre abre 08:40–17:00. No requiere reserva. Si se quiere entrar en el Hojo Garden o subir a la Sanmon, pagar entrada allí. IMPORTANTE: Nanzen-ji y Eikando están muy cerca y este orden mantiene el recorrido lógico hacia el sur." },
      { time: "13:15–13:45", text: "🚇 Nanzen-ji → centro de Kyoto. Caminar aproximadamente 10 min hasta Keage Station. Tomar Kyoto Subway Tozai Line: Keage → Karasuma Oike. Desde Karasuma Oike: caminar hacia Nishiki Market, aproximadamente 15 min; o continuar con la combinación de metro que resulte más conveniente. No reservar. Pagar con IC card." },
      { time: "13:45–16:00", text: "🍣 Mercado de Nishiki. Comida y recorrido por el mercado. Consejo: No intentar recorrer absolutamente todos los puestos. Elegir algunos productos/comidas y comer delante del propio establecimiento. IMPORTANTE: No hacer \\\"tabearuki\\\" (comer mientras se camina). El propio mercado pide evitarlo. Nishiki no tiene una hora única de cierre: cada tienda tiene su propio horario. Muchas tiendas funcionan aproximadamente entre 09:00/10:00 y 17:00/18:00. 🍣 Comer aquí principalmente picando diferentes especialidades, no necesariamente haciendo una comida formal. Qué buscar: dashimaki tamago; yuba; tofu; tsukemono; fu; matcha; pescado/marisco preparado. NO comer caminando. Comprar → apartarse → comer delante del puesto o dentro del establecimiento. ⚠️ IMPORTANTE: Hoy es miércoles 9 de septiembre. Nishiki Market NO cierra como mercado completo, pero muchos comercios individuales descansan los miércoles. Por ello, no depender exclusivamente de Nishiki para comer. Si hay demasiados puestos cerrados, buscar comida en Shijo/Teramachi/Kawaramachi, manteniendo el mismo recorrido general." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "08:00–09:00", text: "🚇 Hotel → Kinkaku-ji. Desde el hotel caminar hasta Kyoto Station. Tomar Kyoto Subway Karasuma Line: Kyoto → Kitaoji. En Kitaoji: seguir las indicaciones hacia Kitaoji Bus Terminal; utilizar la zona azul; tomar bus nº 204 o 205 hacia Kinkaku-ji; bajar en Kinkakuji-michi. Desde Kinkakuji-michi: aprox. 5 min andando hasta la entrada. Esta combinación es preferible al bus 205 directo desde Kyoto Station porque evita parte del tráfico y las aglomeraciones. No reservar. Usar IC card." },
      { time: "09:00–10:15", text: "🏯 Kinkaku-ji (Pabellón Dorado). IMPORTANTE: La hora anterior de 08:30 era incorrecta. Kinkaku-ji abre a las 09:00. Entrada: aprox. ¥500. No requiere reserva. Consejo: Intentar llegar justo a la apertura para disfrutar del recinto con menos gente." },
      { time: "10:15–12:15", text: "🚶 Sendero Kinukake no Michi. Recorrer en este orden: 1. Kinkaku-ji 2. Ryoan-ji 3. Ninna-ji" },
      { time: "10:15–11:00", text: "🏯 Ryoan-ji. Desde Kinkaku-ji caminar por Kinukake no Michi. Distancia aproximada: 1,5 km / 20 min. Ryoan-ji abre en septiembre 08:00–17:00. Entrada: aprox. ¥600. No requiere reserva. Visitar especialmente: jardín de piedras; Hojo; jardín." },
      ...
      { time: "12:15–12:40", text: "🚋 Ninna-ji → Arashiyama. Caminar hasta Omuro-Ninnaji Station. Tomar Randen Kitano Line hacia Katabiranotsuji. En Katabiranotsuji hacer transbordo a la Randen Arashiyama Line hacia Arashiyama. Bajar en Arashiyama Station. Duración aproximada total: 20–25 min. IMPORTANTE: Randen NO es un tren JR. No necesita Japan Rail Pass. Tarifa actual de Randen: ¥250 por adulto por trayecto. Se puede pagar con IC card. Al subir NO hay que tocar la IC card. Se paga al bajar/en la estación según corresponda. No reservar." },
      { time: "12:40–13:20", text: "🍜 Comida rápida en Arashiyama. Mantener comida rápida para no comprometer la parte de Otagi. 🍜 Comida rápida en Arashiyama. Mantener comida rápida para no comprometer la parte de Otagi. ⚠️ No retrasar demasiado la comida. En Arashiyama muchos restaurantes tienen último pedido alrededor de las 14:00 y algunos cierran la cocina por la tarde. Qué comer: udon; soba; tempura; donburi; curry; onigiri/bento si vamos con prisa. Si vemos que vamos justos de tiempo, comprar onigiri/sandwich/bento en la zona de Arashiyama y continuar. Es preferible esto a perder tiempo esperando mesa." },
      { time: "13:20–13:50", text: "🚌 Arashiyama → Otagi Nenbutsu-ji. IMPORTANTE: NO hacer toda la subida andando desde Arashiyama. La propia web de Otagi recomienda llegar en taxi o bus y realizar después el recorrido cuesta abajo. Opción recomendada: Kyoto Bus nº 94 hacia Kiyotaki. Subir en una parada de la zona de Arashiyama y bajar en Otagidera-mae. Duración aproximada: 20–25 min. Alternativa: Taxi desde la zona de Arashiyama. El taxi es más caro pero puede ahorrar tiempo si vamos justos. No reservar el bus." },
      { time: "13:50–14:45", text: "🏯 Otagi Nenbutsu-ji. IMPORTANTE: Ahora se visita el jueves 10 de septiembre. Horario: 09:00–16:00. Está cerrado los miércoles y sábados, por lo que el cambio de día soluciona el problema. Entrada: ¥1.000. No requiere reserva. Visitar especialmente las aproximadamente 1.200 estatuas de rakan." },
      { time: "14:45–15:30", text: "🚶 Saga-Toriimoto. Desde Otagi comenzar el descenso andando. Recorrer la zona histórica de Saga-Toriimoto. IMPORTANTE: Este sentido del recorrido es deliberado: Otagi → Saga-Toriimoto → bosque de bambú → centro de Arashiyama. Es el sentido recomendado por el propio templo." },
      ...
      { time: "17:00", text: "🚆 Regreso a Kyoto. Caminar hasta JR Saga-Arashiyama Station. Tomar JR Sagano/San-in Line: Saga-Arashiyama → Kyoto. Trayecto directo, aproximadamente 15–20 min. No reservar. Usar IC card o billete sencillo. IMPORTANTE: Este tren sí es JR, pero NO requiere Japan Rail Pass. Se puede pagar normalmente con IC card. Esta noche puede ser buena para una cena tranquila cerca de Kyoto Station o Pontocho, según energía." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "08:00–08:30", text: "🚍 HOTEL → KIYOMIZU-DERA. Desde el Hotel Keihan Kyoto Hachijoguchi caminar hasta Kyoto Station. Opción principal: Kyoto City Bus 100 o 206 desde Kyoto Station. Bajar en Gojozaka. Caminar aproximadamente 10 min hasta Kiyomizu-dera. Alternativa: Utilizar el nuevo Kiyomizu-dera Line de Okoshi Bus, disponible los días laborables desde julio de 2026, si el horario del momento resulta conveniente. No reservar. Pagar con IC card o billete correspondiente. Los buses de Higashiyama pueden sufrir congestión. Salir con margen." },
      ...
      { time: "13:30–14:15", text: "🍜 COMIDA EN KYOTO. IMPORTANTE: Intentar terminar aproximadamente sobre las 14:15 para conservar margen para el tren a Osaka. 🍜 COMIDA EN KYOTO. IMPORTANTE: Intentar terminar aproximadamente sobre las 14:15 para conservar margen para el tren a Osaka. ⚠️ Esta comida debe ser rápida. Tenemos el tren hacia Osaka a las 14:30. Recomendación: comer cerca del camino hacia Kyoto Station; ramen; udon/soba; curry; donburi; teishoku rápido. No reservar restaurante para esta comida. Alternativa: Comprar bento/ekiben en Kyoto Station si vamos justos." },
      ...
      { time: "15:30–18:00", text: "🏯 OSAKA CASTLE. IMPORTANTE: El Museo del Castillo de Osaka abre 09:00–18:00, última entrada 17:30. ENTRAR AL INTERIOR DEL CASTILLO: Mantener como visita principal el museo de la torre y el mirador. Entrada: ¥1.200 adulto. No es necesario reservar anticipadamente para este día. Comprar la entrada en el propio castillo. Se puede pagar con efectivo, tarjeta e IC card. 💡 Tip: En Osaka Castle, reservar aproximadamente 1,5–2 h para museo + mirador + exteriores." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "11:45–12:30", text: "🍜 COMIDA EN SHIRAKAWA-GO. No retrasar demasiado la comida porque el bus a Takayama sale a las 13:15 y debemos estar de vuelta en la terminal con margen. Qué probar: Hida beef, hoba miso, soba, udon, tofu de Shirakawa-go, verduras locales. Opciones: 1. YOUCYA UDON (opción rápida); 2. Hiiragi (Hida beef A4/A5); 3. Magoemon (opción tradicional pequeña, valorar reserva). No hacer reserva obligatoria. 💡 Tip: Muchos restaurantes son pequeños y con horarios variables. Si encontramos una opción adecuada abierta y con poca espera, aprovecharla." },
      ...
      { time: "14:05", text: "Llegada a Takayama. Desde Takayama Bus Terminal hasta Hotel Wood Takayama: aproximadamente 12 minutos andando. El hotel está prácticamente junto al casco histórico, por lo que NO necesitamos taxi ni transporte urbano. El check-in oficial es a las 15:00. Podemos dejar el equipaje en recepción si la habitación todavía no está disponible." },
      { time: "14:20–17:30", text: "CASCO ANTIGUO DE TAKAYAMA. Recorrer: Sanmachi Suji, calles tradicionales, pequeñas tiendas, sake breweries, edificios históricos, Nakabashi y alrededores. IMPORTANTE: Muchas tiendas y atracciones del casco antiguo cierran alrededor de las 17:00. Aprovechar esta franja para compras y visitas interiores. Después de las 17:00: Quedarse por la zona, descansar en el hotel o dar un paseo tranquilo por las calles cuando haya menos gente. 🍡 SNACK OPCIONAL: Probar alguna especialidad callejera de Hida (Hida beef sushi, croquette, mitarashi dango, pudding, sake local). No llenar demasiado el estómago si queremos cenar Hida beef." },
      ...
      { time: "🎫 RESERVAS", text: "YA RESERVADO: Kanazawa → Shirakawa-go (08:40, 5 plazas) y Shirakawa-go → Takayama (13:15, 5 plazas). NO necesitamos Japan Rail Pass, trenes, ni IC card para estos buses. PENDIENTE / RECOMENDADO: reservar cena de Hida beef para 5 personas a las 19:00." },
      { time: "🚍 RESUMEN DE TRANSPORTE", text: "Kanazawa → Shirakawa-go: Nohi Bus reservado, 08:40 → 10:05. Shirakawa-go: Todo a pie. Shirakawa-go → Takayama: Nohi Bus reservado, 13:15 → 14:05. Takayama Bus Terminal → Hotel Wood: aprox. 12 min andando. Hotel → Sanmachi: al lado. No necesitamos Japan Rail Pass ni trenes hoy." },
      { time: "🍽️ CONSEJOS DE COMIDA", text: "⚠️ En Shirakawa-go no esperar hasta las 13:00 para comer. Establecimientos con horarios limitados y debemos estar de vuelta en la terminal antes de las 13:15. ⚠️ En Takayama muchas tiendas cierran sobre las 17:00, pero los restaurantes de cena abren más tarde. La cena a las 19:00 es viable. 🥩 Takayama es ideal para probar Hida beef. Tip de viajeros: reservar restaurantes populares o acudir temprano ya que se llenan." }
    ],
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "08:00", text: "🚌 Nohi Bus directo Takayama → Magome. Salida: Takayama Nohi Bus Center (08:00). Llegada: Magome (10:45). Duración: aprox. 2 h 45 min. Precio orientativo: ¥5.000/persona. IMPORTANTE: Este servicio requiere reserva previa. No utiliza Japan Rail Pass. No es un tren. No necesitamos IC card. Reservar online a través de Japan Bus Online / Nohi Bus. Reservar para 5 personas. ⚠️ RESERVAR POR ADELANTADO: Este autobús evita Takayama → Nagoya → Nakatsugawa → Magome. Es mucho más sencillo y deja la mañana perfectamente encajada para la ruta Nakasendo. Confirmar reserva para el 14/09/2026." },
      ...
      { time: "10:45–11:15", text: "🧳 ENVIAR EQUIPAJE A TSUMAGO. El servicio permite dejar maletas en la oficina de turismo de Magome entre 08:30 y 11:30 (¥500/pieza). Recogeremos las maletas en Tsumago después de las 13:00. IMPORTANTE: Llegamos a las 10:45, hay tiempo para dejarlo antes de las 11:30. Llevar durante la caminata únicamente una mochila pequeña con agua, documentación, móvil, batería y dinero. NO llevar maletas grandes durante la ruta (el sendero tiene piedras y desnivel)." },
      ...
      { time: "14:15–14:22", text: "🧳 Recoger maletas en Tsumago y BUS TSUMAGO → MAGOME. Recoger equipaje en la oficina de turismo (horario 08:30–17:00). 🚍 14:22 — BUS local Magome Line. Salida Tsumago: 14:22. Llegada Magome: 14:50. Duración: 28 min. Precio: ¥1.000/persona. No requiere JR Pass. No hace falta reservar. Pago en efectivo al conductor o en la oficina de Tsumago. IMPORTANTE: Este bus es imprescindible para volver a Magome a dormir." },
      { time: "14:50", text: "📍 Regreso a Magome. Ya tenemos el equipaje con nosotros." },
      { time: "15:00–17:30", text: "Pasear tranquilamente por Magome-juku, sus casas tradicionales y calles históricas. Esta franja sirve para: check-in, dejar equipaje, descansar, ducharse y disfrutar del pueblo. IMPORTANTE: Muchas tiendas y restaurantes cierran temprano. No dejar compras ni comida para última hora." },
      { time: "18:00", text: "🍱 CENA EN MAGOME CHAYA. La cena se sirve EXACTAMENTE a las 18:00 y termina aprox. a las 19:00. Precio: ¥3.630/persona (¥18.150 para 5). La cena debe estar confirmada previamente. IMPORTANTE: No llegar tarde. El restaurante está justo enfrente del alojamiento. ⚠️ NO HAY DESAYUNO para la mañana siguiente: Magome Chaya no ofrece desayuno. Comprar con antelación, el pueblo no tiene comercios abiertos a primera hora." },
      { time: "🎫 RESERVAS NECESARIAS", text: "YA RESERVADO: Hotel Wood Takayama, Magome Chaya. RESERVAR: 🚌 Nohi Bus Takayama → Magome (14/09/2026, 08:00, 5 pax). NO RESERVAR: 🚍 Tsumago → Magome (bus local 14:22). EQUIPAJE: 🧳 Magome → Tsumago (dejar 08:30-11:30, recoger tras 13:00, ¥500/pieza)." },
      { time: "🚍 RESUMEN DE TRANSPORTE", text: "🏨 Hotel Wood Takayama ↓ 10–15 min andando ↓ 🚌 Takayama Nohi Bus Center ↓ 08:00–10:45 🚌 Nohi Bus directo ↓ 📍 Magome ↓ dejar equipaje ↓ 🥾 8 km / ~3 h ↓ 📍 Tsumago ↓ recoger equipaje ↓ 🚌 14:22–14:50 ↓ 📍 Magome ↓ 🏨 Magome Chaya ↓ 🍱 Cena 18:00." },
