...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:00–13:45", text: "🍜 **COMIDA: KATSUEMON** (DiverCity Tokyo Plaza).\n\nhttps://maps.app.goo.gl/LFswXe7ofaSSnbKY8?g_st=ic" },
      { time: "13:45–14:15", text: "🚇 **HACIA LA TORRE DE TOKIO.** Yurikamome hasta Shimbashi + transbordo a la línea Toei Oedo hasta Akabanebashi (o Hibiya hasta Kamiyacho) -- un solo cambio, unos 25-30 min en total." },
      { time: "14:15–17:45", text: "🗼 **TORRE DE TOKIO, CON ATARDECER INCLUIDO.** Inaugurada en 1958, con 333 m es unos 20 m más alta que la Torre Eiffel en la que se inspiró -- pintada de blanco y naranja internacional por normativa de seguridad aérea, no por elección estética.\n\n🎟️ **Main Deck** (150 m, ~¥1.200, entrada normal sin reserva): el mirador estándar. **Top Deck** (150-250 m, ~¥3.000, con tramos de suelo de cristal): más caro y requiere reserva de franja horaria -- comprobar disponibilidad de última hora antes de contar con él.\n\n🌇 El sol se pone sobre las **17:45-17:50** en estas fechas -- con margen de sobra desde las 14:15 para visitar con calma y quedaros arriba para verlo caer sobre la ciudad." },
