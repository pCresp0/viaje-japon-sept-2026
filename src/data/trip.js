...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:00–13:15", text: "🚶 Caminar hacia el restaurante **Gyumabushi Miyama 牛まぶし三山** (11 Kasuganocho, Nara), en la propia zona de Tōdai-ji/Nara Park — por eso tiene sentido comer justo después del Gran Buda." },
      ...
      { time: "18:30–21:30", text: "🍜 **PONTOCHO + GION + CENA**\n\nPaseo por Pontocho, después hacia la zona de Gion/Shirakawa, y cena en la zona (callejones tradicionales junto al río Kamo). Pontocho y Gion no son dos visitas independientes con horarios rígidos: forman parte de la misma experiencia de tarde/noche. Opciones de cena: yakitori, ramen, izakaya, okonomiyaki o gyukatsu (ej. GYUKATSU Kyoto Katsugyu Pontocho Honten, abierto hasta las 22:30, aprox. ¥2.000–6.000 (~12–37€) — una opción más, no la cena obligatoria). Después de cenar, paseo nocturno tranquilo si apetece." },
