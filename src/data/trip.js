...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "07:45–08:00", text: "🚆 JR Nara Line: Kyoto Station → Inari Station (~5 min).\n\n🎫 **SUICA/IC:** ✅ SÍ\n📅 **RESERVA:** ❌ NO\n🛒 **COMPRA:** Pasar la tarjeta directamente por los tornos.\n\nSin reserva. Utilizar IC card o comprar billete sencillo en la estación. Inari Station está justo al lado de Fushimi Inari." },
      ...
      { time: "15:45–16:15", text: "🚆 JR Nara → Kyoto.\n\n🎫 **SUICA/IC:** ✅ SÍ\n📅 **RESERVA:** ❌ NO\n🛒 **COMPRA:** Pasar la tarjeta directamente por los tornos.\n\nCoger el siguiente servicio conveniente hacia Kyoto. No requiere reserva. Utilizar IC card o comprar billete sencillo. Si hay un Miyakoji Rapid conveniente, puede utilizarse para reducir el tiempo de viaje." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:15", text: "🚌 Nohi Bus Shirakawa-go → Takayama.\\n\\n🎫 **SUICA/IC:** ❌ NO\\n📅 **RESERVA:** ✅ YA COMPRADA\\n🛒 **COMPRA:** Utilizar la reserva confirmada de 12GO / Nohi Bus.\\n\\nSalida: 13:15. Reserva: 12GO31992254. 5 asientos confirmados. Duración aproximada: 50 min. Llegada prevista a Takayama Bus Terminal: 14:05. Reserva obligatoria. No es JR. No requiere Japan Rail Pass. No utilizar IC card: utilizar la reserva/billete del autobús." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:00", text: "Narita Express (N'EX) al aeropuerto (1h exacta).\\n\\n🎫 **SUICA/IC:** ❌ NO\\n📅 **RESERVA:** 🔴 NECESARIA\\n🛒 **COMPRA:** Taquillas o máquinas JR. (Comprar el día anterior para mayor seguridad)." },
