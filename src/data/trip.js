...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "19:30–21:00", text: "🍣 **CENA: KAITEN-SUSHI UOGASHI**\n\nRestaurante recomendado en **AEON MALL KYOTO** — Sakura Building, 4F. A unos 5 min andando desde Kyoto Station Hachijo Exit (muy cómodo tras llegar en Shinkansen).\n\n**Kaiten-zushi** (sushi en cinta transportadora). Precio orientativo: **¥2.000–3.000/persona**.\n\nHorario: 11:00–22:00 (último pedido aprox 21:30). No es necesario reservar.\n\n**Qué probar:** sushi variado; piezas de pescado fresco; nigiri; platos especiales del día; algún acompañamiento caliente.\n\n💡 *Tip: La hora real de la cena dependerá de la llegada a Kyoto y del traslado al hotel.*" },
      { time: "🍙 PREPARACIÓN DESAYUNO", text: "⚠️ **Comprar esta noche el desayuno del Día 2 en un konbini** porque la salida es demasiado temprana para desayunar tranquilamente en el hotel.\n\n**Recomendación:**\n- 1–2 onigiri por persona\n- Sandwich de huevo\n- Banana/fruta\n- Café o bebida\n- Yogur opcional" },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "🎫", text: "RESERVAS:\n\nno es necesario reservar por adelantado ninguno de los trenes de este día. Todos los trayectos ferroviarios del día son servicios regionales/locales. Se pueden pagar sobre la marcha con Suica o mediante billete sencillo comprado en las máquinas de la estación. No tenemos Japan Rail Pass y no es necesario para este día." }
    ],
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "17:00", text: "🚆 Regreso a Kyoto. Caminar hasta JR Saga-Arashiyama Station. Tomar JR Sagano/San-in Line: Saga-Arashiyama → Kyoto. Trayecto directo, aproximadamente 15–20 min. No reservar. Usar Suica o billete sencillo. \n\n⚠️ **IMPORTANTE:**\nEste tren sí es JR, pero NO requiere Japan Rail Pass. Se puede pagar normalmente con Suica. Esta noche puede ser buena para una cena tranquila cerca de Kyoto Station o Pontocho, según energía." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "15:30–18:00", text: "🏯 OSAKA CASTLE. \n\n⚠️ **IMPORTANTE:**\nEl Museo del Castillo de Osaka abre 09:00–18:00, última entrada 17:30. ENTRAR AL INTERIOR DEL CASTILLO: Mantener como visita principal el museo de la torre y el mirador. Entrada: ¥1.200 adulto. No es necesario reservar anticipadamente para este día. Comprar la entrada en el propio castillo. Se puede pagar con efectivo, tarjeta e Suica. 💡 Tip: En Osaka Castle, reservar aproximadamente 1,5–2 h para museo + mirador + exteriores." },
      { time: "18:00–18:30", text: "🚇 OSAKA CASTLE → DOTONBORI.\n\n🎫 **SUICA:** ✅ SÍ\n📅 **RESERVA:** ❌ NO\n🛒 **COMPRA:** Pasar tarjeta en los tornos de la estación.\n\nDesde Morinomiya utilizar Osaka Metro hacia la zona de Namba/Dotonbori." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "08:10 aprox.", text: "🚆 KYOTO → TSURUGA → KANAZAWA. Hotel Keihan Kyoto Hachijoguchi → Kyoto Station: aproximadamente 5 minutos andando hasta Hachijo East Exit. Salir con margen suficiente para estar en el andén unos 10–15 minutos antes. 1. Limited Express THUNDERBIRD: Kyoto Station → Tsuruga Station.\\n\\n🎫 **SUICA:** ❌ NO (para trayectos exprés)\\n📅 **RESERVA:** 🔴 NECESARIA (Todos los asientos son reservados)\\n🛒 **COMPRA:** COMPRAR POR ADELANTADO en taquillas/máquinas JR el trayecto completo (Thunderbird + Shinkansen) desde Kyoto hasta Kanazawa.\\n\\nAproximadamente 50–55 min. Asiento reservado obligatorio. No hay vagones de asiento no reservado.\\n\\n2. En Tsuruga: Hacer transbordo al Hokuriku Shinkansen. Seguir las señales de conexión Thunderbird → Shinkansen. No salir de la estación innecesariamente.\\n\\n3. Hokuriku Shinkansen Tsurugi: Tsuruga → Kanazawa.\\n\\n🎫 **SUICA:** ❌ NO\\n📅 **RESERVA:** 🔴 NECESARIA (Debe comprarse junto con el Thunderbird)\\n🛒 **COMPRA:** Billete conjunto con el Thunderbird.\\n\\nAproximadamente 40 min. Duración total aproximada: 1h40–2h." },
      ...
      { time: "🚌 TRANSPORTE", text: "Cómo moverse por Kanazawa: Los principales puntos turísticos están muy cerca entre sí, pero el Loop Bus resulta muy práctico. Kanazawa Loop Bus: ¥220 por trayecto. Acepta Suicas nacionales y pago contactless. También existe ONE DAY PASS por ¥800. ONE DAY PASS solo merece especialmente la pena si vamos a utilizar el bus 4 veces o más. Importante: El ONE DAY PASS no se compra a bordo del bus. Se puede comprar en el Centro de Información Turística de la estación, centros Hokutetsu, algunos hoteles o digitalmente." },
      { time: "🎫 RESERVAS DEL DÍA", text: "⚠️ ESTE TREN SÍ HAY QUE RESERVARLO POR ADELANTADO. Reservar Kyoto → Kanazawa completo (Thunderbird + Hokuriku Shinkansen). Reservar asiento ordinario. No necesitamos Japan Rail Pass. No utilizar Suica para pagar este trayecto. Precio orientativo: ¥7.720 por persona, asiento ordinario reservado. Reservar en JR-WEST ONLINE TRAIN RESERVATION desde un mes antes de la fecha de viaje. Como viajamos 5 personas, reservar todos los asientos juntos si el sistema lo permite." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "08:00", text: "🚌 Nohi Bus directo Takayama → Magome.\\n\\n🎫 **SUICA:** ❌ NO\\n📅 **RESERVA:** 🔴 NECESARIA\\n🛒 **COMPRA:** Reservar en web Nohi Bus (aprox. 1 mes antes) o en taquilla Nohi Bus Center.\\n\\nSalida: Takayama Nohi Bus Center (08:00). Llegada: Magome (10:45). Duración: aprox. 2 h 45 min. Precio orientativo: ¥5.000/persona. \\n\\n**\\n**IMPORTANTE:**\\n**\\nEste servicio requiere reserva previa. No utiliza Japan Rail Pass. No es un tren. No necesitamos Suica. Reservar online a través de Japan Bus Online / Nohi Bus. Reservar para 5 personas.\\n⚠️ RESERVAR POR ADELANTADO: Este autobús evita Takayama → Nagoya → Nakatsugawa → Magome. Es mucho más sencillo y deja la mañana perfectamente encajada para la ruta Nakasendo. Confirmar reserva para el 14/09/2026." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "13:00", text: "Narita Express (N'EX) al aeropuerto (1h exacta).\\n\\n🎫 **SUICA:** ❌ NO\\n📅 **RESERVA:** 🔴 NECESARIA\\n🛒 **COMPRA:** COMPRAR POR ADELANTADO (al menos el día anterior) en taquillas o máquinas JR." },
...
export const transports = [
  { day: 1, date: "2026-09-07", name: "Narita Express (N'EX)", from: "Aeropuerto de Narita", to: "Estación de Shinagawa", type: "Línea JR", real: 19, jpy: 3330, coverage: "jr", suica: false, purchased: false, advance: false },
  { day: 1, date: "2026-09-07", name: "Shinkansen Nozomi 53", from: "Estación de Shinagawa", to: "Kioto", type: "Línea JR (Tren Bala)", real: 90, jpy: 14170, coverage: "jr", suica: false, note: "✓ Reservado (Ref: 2000) · Salida 17:19 → Llegada 19:23 · Coche 13 · Asientos: 13-C, 13-D, 13-E, 14-D, 14-E", purchased: true, advance: true },
  { day: 2, date: "2026-09-08", name: "Tren Línea JR Nara", from: "Kioto", to: "Inari Station", type: "Línea JR Local", real: 1, jpy: 200, coverage: "jr", suica: true, purchased: false, advance: false },
  { day: 2, date: "2026-09-08", name: "Tren Línea JR Nara", from: "Inari Station", to: "Nara", type: "Línea JR Local", real: 4.2, jpy: 680, coverage: "jr", suica: true, purchased: false, advance: false },
  { day: 2, date: "2026-09-08", name: "Tren Línea JR Nara", from: "Nara", to: "Kioto", type: "Línea JR Local", real: 4.5, jpy: 720, coverage: "jr", suica: true, purchased: false, advance: false },
  { day: 3, date: "2026-09-09", name: "Bus y Metro", from: "Kioto", to: "Mercado Nishiki / Gion", type: "Operador Privado / Local", real: 4, jpy: 600, coverage: "no-jr", suica: true, purchased: false, advance: false },
  { day: 4, date: "2026-09-10", name: "Metro y Bus 205", from: "Kioto", to: "Kinkakuji", type: "Operador Privado / Local", real: 3, jpy: 500, coverage: "no-jr", suica: true, purchased: false, advance: false },
  { day: 4, date: "2026-09-10", name: "Tranvía Randen", from: "Ninna-ji", to: "Arashiyama", type: "Operador Privado", real: 1.5, jpy: 250, coverage: "no-jr", suica: true, purchased: false, advance: false },
  { day: 4, date: "2026-09-10", name: "Tren JR Línea San-In", from: "Arashiyama", to: "Kioto", type: "Línea JR Local", real: 1.5, jpy: 240, coverage: "jr", suica: true, purchased: false, advance: false },
  { day: 5, date: "2026-09-11", name: "Tren rápido JR (ida y vuelta)", from: "Kioto", to: "Osaka", type: "Línea JR Local", real: 7, jpy: 1160, coverage: "jr", suica: true, purchased: false, advance: false },
  { day: 6, date: "2026-09-12", name: "Thunderbird + Hokuriku Shinkansen", from: "Kioto", to: "Kanazawa", type: "Línea JR Exprés", real: 43.5, jpy: 7720, coverage: "jr", suica: false, purchased: false, advance: true },
  { day: 7, date: "2026-09-13", name: "Nohi Bus Kanazawa → Shirakawa-go", from: "Kanazawa Sta.", to: "Shirakawa-go Bus Terminal", type: "Operador Privado (Bus)", real: 19.12, jpy: 3100, coverage: "no-jr", suica: false, note: "✓ Reservado · Booking 12GO31991741 · Salida 08:40 · 5 asientos confirmados", purchased: true, advance: true },
  { day: 7, date: "2026-09-13", name: "Nohi Bus Shirakawa-go → Takayama", from: "Shirakawa-go Bus Terminal", to: "Takayama Nohi Bus Center", type: "Operador Privado (Bus)", real: 20.03, jpy: 3250, coverage: "no-jr", suica: false, note: "✓ Reservado · Booking 12GO31992254 · Salida 13:15 · 5 asientos confirmados", purchased: true, advance: true },
  { day: 8, date: "2026-09-14", name: "Nohi Bus directo Takayama → Magome", from: "Takayama Nohi Bus Center", to: "Magome", type: "Operador Privado (Bus)", real: 25, jpy: 4000, coverage: "no-jr", suica: false, note: "Reservar 5 plazas · 08:00–10:45 · ¥5.000/persona", purchased: false, advance: true },
  { day: 9, date: "2026-09-15", name: "Bus local Magome → Nakatsugawa", from: "Magome", to: "Nakatsugawa", type: "Operador Privado (Bus)", real: 3, jpy: 500, coverage: "no-jr", suica: false, note: "Salida 08:15 → Llegada 08:40 · ¥800/persona · Sin reserva (solo efectivo)", purchased: false, advance: false },
  { day: 9, date: "2026-09-15", name: "JR Limited Express Shinano 4", from: "Nakatsugawa", to: "Nagoya", type: "Línea JR Exprés", real: 15, jpy: 3070, coverage: "jr", suica: false, note: "09:57 → 10:53 · Reservar asiento para 5 personas", purchased: false, advance: true },
  { day: 9, date: "2026-09-15", name: "Shinkansen Nozomi", from: "Nagoya", to: "Tokio", type: "Línea JR (Tren Bala)", real: 50, jpy: 11300, coverage: "jr", suica: false, note: "~11:15–11:30 → ~13:00 · Billete reservado requerido", purchased: false, advance: true },
  { day: 10, date: "2026-09-16", name: "Tren elevado Yurikamome", from: "Tokio", to: "Isla de Odaiba", type: "Operador Privado", real: 2, jpy: 330, coverage: "no-jr", suica: true, purchased: false, advance: false },
  { day: "10-14", date: "16-20 sept", name: "Metro y trenes locales (5 días)", from: "Tokio", to: "Tokio (varios)", type: "Operador Privado / Local", real: 25, jpy: 4000, coverage: "no-jr", suica: true, purchased: false, advance: false },
  { day: 14, date: "2026-09-20", name: "Shinkansen ida y vuelta (Excursión Fuji)", from: "Tokio", to: "Mishima / Shin-Fuji", type: "Línea JR (Tren Bala)", real: 62, jpy: 9000, coverage: "jr", suica: false, note: "Tokio→Mishima (Kodama 805) y regreso Shin-Fuji→Tokio", purchased: false, advance: true },
  { day: 15, date: "2026-09-21", name: "Narita Express (N'EX)", from: "Estación de Tokio", to: "Aeropuerto de Narita", type: "Línea JR", real: 19, jpy: 3330, coverage: "jr", suica: false, purchased: false, advance: true },
];
