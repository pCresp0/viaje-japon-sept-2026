...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "21:30–22:00", text: "🍙 **COMPRA DE DESAYUNO Y DESCANSO EN HOTEL KEIHAN KYOTO HACHIJOGUCHI** (📍 Maps: https://www.google.com/maps/search/?api=1&query=Hotel+Keihan+Kyoto+Hachijoguchi)\n\n⚠️ Comprar esta noche el desayuno del Día 2 en un konbini cercano al hotel (1ª noche en Kioto en Hotel Keihan Kyoto Hachijoguchi)." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "~21:30", text: "🏨 **REGRESO AL HOTEL: HOTEL RESOL TRINITY KANAZAWA** (📍 Maps: https://www.google.com/maps/search/?api=1&query=Hotel+Resol+Trinity+Kanazawa)\n\nRegreso al hotel tras la cena para descansar (1ª y única noche en Kanazawa en Hotel Resol Trinity Kanazawa)." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "~21:30", text: "🏨 **REGRESO AL HOTEL: HOTEL WOOD TAKAYAMA** (📍 Maps: https://www.google.com/maps/search/?api=1&query=Hotel+Wood+Takayama)\n\nPaseo nocturno por el casco antiguo hasta el hotel para descansar (1ª y única noche en Takayama en Hotel Wood Takayama)." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "~20:00", text: "🏨 **DESCANSO EN MAGOME CHAYA (MINSHUKU)** (📍 Maps: https://www.google.com/maps/search/?api=1&query=Magome+Chaya+Gifu)\n\nTras la cena, paseo tranquilo por las históricas calles empedradas de Magome iluminadas con faroles tradicionales y descanso en la posada rural (1ª y única noche en Magome Chaya)." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "~21:30", text: "🏨 **REGRESO AL HOTEL: KOKO HOTEL RESIDENCE ASAKUSA KAPPABASHI** (📍 Maps: https://www.google.com/maps/search/?api=1&query=KOKO+HOTEL+Residence+Asakusa+Kappabashi)\n\nRegreso a nuestra residencia en Tokio para descansar y reencontrarnos con las maletas grandes enviadas desde Kioto (1ª noche en Tokio)." },
