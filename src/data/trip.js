...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "19:00–21:00", text: "🍜 CENA EN KANAZAWA. Recomendar quedarse en el centro de Kanazawa, preferentemente cerca de: Korinbo; Katamachi; Musashigatsuji/Omicho; Kanazawa Station. Qué probar: oden de Kanazawa; sushi; pescado del Mar de Japón; nodoguro; Kaga cuisine; wagyu/Noto beef si apetece gastar más. Presupuesto: informal: ¥1.000–2.500 (~6–15€); restaurante local medio: ¥2.500–5.000 (~15–31€); cena especial: ¥8.000+ (~50€+). Para una cena especial o restaurante pequeño muy popular, reservar. Para izakaya/restaurante informal, mantener flexibilidad." },
