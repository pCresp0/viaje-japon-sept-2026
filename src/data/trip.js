...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "17:30–19:00", text: "🏮 Gion. Recorrido: Hanamikoji, zona de Ichiriki, Shirakawa, Tatsumi Jinja. Mantener el recorrido a pie. Consejo: Respetar la privacidad de las geishas/maiko y no bloquear calles ni perseguirlas para hacer fotografías." },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "18:30–21:15", text: "🌃 DOTONBORI + SHINSEKAI. Paseo nocturno y comida callejera. Priorizar: Dotonbori, Glico, Ebisu Bridge, Hozenji Yokocho. Si queda tiempo y energía, continuar hacia Shinsekai. 💡 Tips: En Dotonbori no hace falta reservar para probar comida callejera; elegir puestos/restaurantes sobre la marcha. Dotonbori es especialmente interesante después de anochecer, por lo que mantener la llegada sobre las 18:30 es buena idea." },
