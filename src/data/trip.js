...
export const days = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "15:00–19:00", text: "Tarde tranquila para instalarnos: deshacer un poco el equipaje, ducharse y descansar del día entero de trenes (bus + Shinano + Shinkansen desde primera hora). Paseo sin prisa por el barrio de Asakusa, alrededor del hotel -- sin necesidad de plan cerrado, solo para haceros una idea de la zona antes de la visita de verdad al Sensō-ji que tenéis reservada para la última mañana en Tokio." },
