...
export const guides = {
  ...
  "nagamachi": {
    ...
    wiki: "Nagamachi",
    tagline: "El barrio donde vivían los samuráis del clan Maeda, con una de sus casas abierta al público.",
    sections: [
      {
        title: "Qué ver",
        body: "Nagamachi conserva las calles, canales y muros de tierra originales de la era Edo -- la zona residencial de los samuráis al servicio directo de los Maeda, señores del dominio de Kaga.\n\n• Los muros de tierra (dorobei), con sus tejadillos de paja de invierno\n• La casa samurái Nomura-ke: la sala Jyōdan-no-ma, con puertas correderas pintadas por Sasaki Senkei (escuela Kanō)\n• El jardín de Nomura-ke, estilo Kobori Enshū, con un árbol de mirica de más de 400 años\n• Los canales estrechos que recorren todo el barrio",
      },
    ],
    curiosities: [
      "El sitio lo gestiona hoy 'A Society for the Preservation of Nomura Family', dedicada solo a conservar esta propiedad.",
    ],
    tip: "Nomura-ke es la casa samurái más recomendable del barrio -- muchas otras son solo fachada.",
  },
  ...
  "higashi-chaya": {
    ...
    sections: [
      {
        title: "Qué ver",
        body: "Higashi Chaya es el barrio de las geishas (geiko) de Kanazawa: una calle empedrada de casas de té con fachadas de celosía de madera, establecida en 1820.\n\n• La calle principal, flanqueada por ochaya de dos plantas del siglo XIX\n• Shima: antigua casa de té convertida en museo, con su distribución original\n• Kaikaro: ochaya en activo con un salón decorado en pan de oro\n• Tiendas de pan de oro y artesanía (Kanazawa produce el 99% del oro en pan de Japón)\n• De día para comprar y visitar; al atardecer para el ambiente más auténtico",
      },
    ],
    curiosities: [
      "Según las guías locales, hoy trabajan unas cinco geiko en todo el barrio.",
    ],
    tip: "Si el tiempo apremia, entra en una sola casa de té (Shima o Kaikaro, no ambas).",
  },
