  ...
  "osaka": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "El mirador de la planta 8 rodea toda la torre y permite una vuelta completa de 360°, a unos 50 m de altura. Como el castillo está en el extremo norte de la meseta de Uemachi (la única elevación natural de Osaka), mirando hacia el sur el desnivel se nota menos porque el suelo ya está alto de por sí; mirando hacia el resto de direcciones, en cambio, se percibe mucho mejor la altura real, porque el terreno de alrededor cae hacia zonas más bajas.\n\n🧭 **Sur**: la vista más famosa y la que suele fotografiarse — se ve, a lo lejos, la altísima Abeno Harukas (300 m, el edificio más alto de Japón, en el distrito de Tennoji), y si se hace zoom, también la torre Tsūtenkaku de Shinsekai. Más cerca, los tejados de las torretas Sengan-yagura y Tamon-yagura, la sede de la Policía de la Prefectura de Osaka, el edificio de NHK Osaka, el Museo de Historia de Osaka, el foso interior con sus muros de piedra y el jardín Nishinomaru.\n\n🧭 **Norte / Noreste**: la zona de Tenmabashi y el río Ōkawa con sus puentes; más allá, el conjunto de rascacielos del Osaka Business Park (OBP). Es la dirección hacia la que salisteis hoy en tren desde Sanjo (Temmabashi está justo aquí).\n\n🧭 **Este**: en días despejados, se distingue el monte Ikoma (生駒山, 642 m) en el horizonte, la frontera natural entre las prefecturas de Osaka y Nara.\n\n🧭 **Oeste**: la zona de Umeda, con su propio skyline de rascacielos (donde está Osaka Station), aunque queda más lejos y se aprecia mejor con buena visibilidad.\n\nHay prismáticos de monedas (100 ¥) en el mirador si se quiere ver con más detalle el monte Ikoma o los rascacielos más lejanos. El mejor momento del día para las fotos, según coinciden varias reseñas, es el atardecer.",
      },
      {
