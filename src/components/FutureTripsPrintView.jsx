...
export default function FutureTripsPrintView({ days, lang }) {
  ...
  const labels = {
    es: {
      ...
      mainDesc: "Guía detallada con los 11 destinos seleccionados para futuros viajes a Japón: 3 días en Tokio (lo imprescindible, Nikko y Kamakura), 2 días en Osaka y sus templos sagrados, ascensión al Monte Fuji, Hiroshima, Miyajima, Hokkaido, Okinawa e Iriomote.",
    ...
    en: {
      ...
      mainDesc: "Detailed guide covering 11 hand-picked destinations for future journeys in Japan: 3 days in Tokyo (highlights, Nikko, and Kamakura), 2 days in Osaka and its historic temples, Mount Fuji climbing, Hiroshima, Miyajima, Hokkaido, Okinawa, and Iriomote.",
    ...
    fr: {
      ...
      mainDesc: "Guide exhaustif présentant 11 destinations pour de futurs séjours au Japon : 3 jours à Tokyo (incontournables, Nikko et Kamakura), 2 jours à Osaka et ses temples, le mont Fuji, Hiroshima, Miyajima, Hokkaido, Okinawa et Iriomote.",
    ...
    tl: {
      ...
      mainDesc: "Detalyadong gabay para sa 11 napiling destinasyon para sa susunod na paglalakbay sa Japan: 3 araw sa Tokyo (highlights, Nikko at Kamakura), 2 araw sa Osaka at mga templo nito, Mount Fuji, Hiroshima, Miyajima, Hokkaido, Okinawa, at Iriomote.",
  ...
  const comparisonData = [
    ...
    },
    {
      ...
      access: "Metro de Osaka (líneas Midosuji y Tanimachi)",
    },
    {
